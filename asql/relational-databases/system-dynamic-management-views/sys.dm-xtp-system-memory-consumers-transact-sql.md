...
[!INCLUDE[tsql-appliesto-ss2014-xxxx-xxxx-xxx_md](../../integration-services/includes/tsql-appliesto-ss2014-xxxx-xxxx-xxx-md.md)]
  ...
  Reports system level memory consumers for [!INCLUDE[hek_2](../../relational-databases/in-memory-oltp/includes/hek-2-md.md)]. The memory for these consumers come either from the default pool (when the allocation is in the context of a user thread) or from internal pool (if the allocation is in the context of a system thread).  
