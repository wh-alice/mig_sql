...
3.  In Query Editor, type and execute a [!INCLUDE[tsql](../../a9notintoc/includes/tsql-md.md)] statement, such as the following:  
...
1.  In [!INCLUDE[ssManStudio](../../a9notintoc/includes/ssmanstudio-md.md)], on the **Tools** menu, click **Options**.  
