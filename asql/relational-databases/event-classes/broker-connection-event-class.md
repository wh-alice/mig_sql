...
---
# Broker:Connection Event Class
  [!INCLUDE[ssNoVersion](../../a9notintoc/includes/ssnoversion-md.md)] generates a **Broker:Connection** event to report the status of a transport connection managed by Service Broker.  
