 ...
 **5** = Both in-process and local OLE server allowed  
 ...
 When you specify a context value of **4**, a local OLE server does not have access to any [!INCLUDE[ssNoVersion](../../../advanced-analytics/r-services/includes/ssnoversion-md.md)] resources, and it cannot damage [!INCLUDE[ssNoVersion](../../../advanced-analytics/r-services/includes/ssnoversion-md.md)] memory or resources.  
...
## Remarks  
 ...
 The created OLE object is automatically destroyed at the end of the [!INCLUDE[tsql](../../../advanced-analytics/r-services/includes/tsql-md.md)] statement batch.  
