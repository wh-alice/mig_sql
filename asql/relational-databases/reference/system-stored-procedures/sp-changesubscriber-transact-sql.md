...
## Arguments  
 ...
 [ **@login=**] **'***login***'**  
 Is the [!INCLUDE[ssNoVersion](../../../a9notintoc/includes/ssnoversion-md.md)] Authentication login ID. *login* is **sysname**, with a default of NULL.  
  
 [ **@password=**] **'***password***'**  
 Is the [!INCLUDE[ssNoVersion](../../../a9notintoc/includes/ssnoversion-md.md)] Authentication password. *password* is **sysname**, with a default of **%**. **%** indicates there is no change to the password property.  
