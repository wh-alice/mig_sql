...
|**phase_number**|**int**|Number indicating the phase the session was in at the time the error occurred. For a description of each phase, see [sys.dm_cdc_log_scan_sessions &#40;Transact-SQL&#41;](../Topic/sys.dm_cdc_log_scan_sessions%20\(Transact-SQL\).md).|  
...
## See Also  
 [sys.dm_cdc_log_scan_sessions &#40;Transact-SQL&#41;](../Topic/sys.dm_cdc_log_scan_sessions%20\(Transact-SQL\).md)   
