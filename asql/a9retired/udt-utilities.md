...
-   The [!INCLUDE[ssSampleDBnormal](../a9notintoc/includes/sssampledbnormal-md.md)] database that is available at the Codeplex [Web site](http://go.microsoft.com/fwlink/?linkid=62796)  
...
-   The [!INCLUDE[ssSampleDBnormal](../a9notintoc/includes/sssampledbnormal-md.md)] database must be installed on the [!INCLUDE[ssNoVersion](../a9notintoc/includes/ssnoversion-md.md)] instance you are using.  
...
```  
 ...
 This is the [!INCLUDE[tsql](../a9notintoc/includes/tsql-md.md)] installation script (`Install.sql`), which deploys the assembly and creates the functions in the database.  
