...
|**schema_option**|**binary(8)**|Bitmap of the schema generation option for the given article. For a complete list of **schema_option** values, see [sp_addarticle &#40;Transact-SQL&#41;](../../../relational-databases/reference/system-stored-procedures/sp-addarticle-transact-sql.md).|  
...
## Example  
 [!code-sql[HowTo#sp_helptranarticle](../../../relational-databases/reference/system-stored-procedures/codesnippet/tsql/sp-helparticle-transact-_1.sql)]  
