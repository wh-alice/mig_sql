...
|**compensate_for_errors**|**true**|Compensating actions are performed when errors occur during synchronization. For more information, see [sp_addmergearticle](../../../relational-databases/reference/system-stored-procedures/sp-addmergearticle-transact-sql.md).|  
||**false**|Compensating actions are not performed, which is the default behavior. For more information, see [sp_addmergearticle](../../../relational-databases/reference/system-stored-procedures/sp-addmergearticle-transact-sql.md).<br /><br /> **\*\* Important \*\*** Although data in the affected rows might appear to be out of convergence, as soon as you address any errors, changes can be applied and data will converge. If the source table for an article is already published in another publication, then the value of *compensate_for_errors* must be the same for both articles.|  
...
||**0x200000000**|Converts date and time data types (**date**, **time**, **datetimeoffset**, and **datetime2**) that are introduced in [!INCLUDE[ssKatmai](../../../a9notintoc/includes/sskatmai-md.md)] to data types that are supported on earlier versions of [!INCLUDE[ssNoVersion](../../../a9notintoc/includes/ssnoversion-md.md)].|  
...
## Example  
 [!code-sql[HowTo#sp_changemergearticle](../../../a9retired/codesnippet/tsql/sp-changemergearticle-tr_1.sql)]  
