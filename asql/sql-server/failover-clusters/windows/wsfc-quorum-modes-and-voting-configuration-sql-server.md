...
> [!TIP]  
>  When using an asymmetric storage configuration for [!INCLUDE[ssHADR](../../../a9notintoc/includes/sshadr-md.md)], you should generally use the Node Majority quorum mode when you have an odd number of voting nodes, or the Node and File Share Majority quorum mode when you have an even number of voting nodes.  
...
> [!TIP]  
>  [!INCLUDE[ssNoVersion](../../../a9notintoc/includes/ssnoversion-md.md)] exposes several system dynamic management views (DMVs) that can help you manage settings related WSFC cluster configuration and node quorum voting.  
>   
