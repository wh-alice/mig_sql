...
|**IsHidden**|Is column value generated by the system. Corresponds to **sys.columns.is_hidden**|**Applies to**: [!INCLUDE[ssCurrentLong](../../relational-databases/system-catalog-views/includes/sscurrentlong-md.md)] through [!INCLUDE[ssCurrent](../../advanced-analytics/r-services/includes/sscurrent-md.md)].<br /><br /> 0 = Not hidden<br /><br /> 1 = Hidden|  
