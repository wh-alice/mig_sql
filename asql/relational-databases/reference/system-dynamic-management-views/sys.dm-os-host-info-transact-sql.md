...
|**host_release**|**nvarchar(256)**|[!INCLUDE[msCoName](../../../a9notintoc/includes/msconame-md.md)] Windows operating system release (version number). For a list of values and descriptions, see [Operating System Version (Windows)](http://msdn.microsoft.com/library/ms724832\(VS.85\).aspx). <br> For Linux, returns an empty string. |  
...
## Remarks  
This view is similar to [sys.dm_os_windows_info](../../../relational-databases/reference/system-dynamic-management-views/sys.dm-os-windows-info-transact-sql.md), adding columns to differentiate Windows and Linux.
