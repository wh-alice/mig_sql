...
## Remarks  
 STBuffer() calculates a buffer in the same manner as [BufferWithTolerance](../../t-sql/data-types/bufferwithtolerance-geography-data-type.md), specifying *tolerance* = abs(distance) \* .001 and *relative* = **false**.  
