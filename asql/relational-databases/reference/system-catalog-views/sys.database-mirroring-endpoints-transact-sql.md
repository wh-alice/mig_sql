...
[!INCLUDE[tsql-appliesto-ss2008-xxxx-xxxx-xxx_md](../../../database-engine/configure/windows/includes/tsql-appliesto-ss2008-xxxx-xxxx-xxx-md.md)]
  ...
  Contains one row for the database mirroring endpoint of an instance of [!INCLUDE[ssNoVersion](../../../advanced-analytics/r-services/includes/ssnoversion-md.md)].  
...
|-----------------|---------------|-----------------|  
|**\<inherited columns>**|—|Inherits columns from **sys.endpoints** (for more information, see [sys.endpoints &#40;Transact-SQL&#41;](../../../relational-databases/reference/system-catalog-views/sys.endpoints-transact-sql.md)).|  
