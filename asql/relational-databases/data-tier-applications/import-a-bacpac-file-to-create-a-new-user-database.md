...
# Import a BACPAC File to Create a New User Database
  Import a data-tier application (DAC) file – a .bacpac file – to create a copy of the original database, with the data, on a new instance of the [!INCLUDE[ssDE](../../a9notintoc/includes/ssde-md.md)], or to [!INCLUDE[ssSDSFull](../../a9retired/includes/sssdsfull-md.md)]. Export-import operations can be combined to migrate a DAC or database between instances, or to create a logical backup, such as creating an on-premise copy of a database deployed in [!INCLUDE[ssSDS](../../a9retired/includes/sssds-md.md)].  
