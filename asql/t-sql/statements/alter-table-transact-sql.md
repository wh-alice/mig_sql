...
-   The locking strategy during an alter column online operation follows the same locking pattern used for online index build.  
 ...
 ||  
|-|  
|**Applies to**:  [!INCLUDE[ssCurrentLong](../../relational-databases/reference/system-catalog-views/includes/sscurrentlong-md.md)] through [!INCLUDE[ssCurrent](../../advanced-analytics/r-services/includes/sscurrent-md.md)]  and [!INCLUDE[ssSDSfull](../../analysis-services/multidimensional-models/includes/sssdsfull-md.md)].|  
...
|**Applies to**: [!INCLUDE[ssCurrent](../../advanced-analytics/r-services/includes/sscurrent-md.md)].|  
 ...
 Enables or disables Stretch Database for a table. For more info, see [Stretch Database](../../sql-server/stretch-database/stretch-database.md).  
