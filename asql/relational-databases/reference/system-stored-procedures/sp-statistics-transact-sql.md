...
|**INDEX_QUALIFIER**|**sysname**|Index owner name. Some DBMS products allow for users other than the table owner to create indexes. In [!INCLUDE[ssNoVersion](../../../a9notintoc/includes/ssnoversion-md.md)], this column is always the same as **TABLE_NAME**.|  
...
|**FILTER_CONDITION**|**varchar(128)**|[!INCLUDE[ssNoVersion](../../../a9notintoc/includes/ssnoversion-md.md)] does not return a value.|  
...
## Remarks  
 ...
 The index type clustered refers to an index in which table data is stored in the order of the index. This corresponds to [!INCLUDE[ssNoVersion](../../../a9notintoc/includes/ssnoversion-md.md)] clustered indexes.  
...
## Example: [!INCLUDE[ssSDWfull](../../../a9notintoc/includes/sssdwfull-md.md)] and [!INCLUDE[ssPDW](../../../a9notintoc/includes/sspdw-md.md)]  
