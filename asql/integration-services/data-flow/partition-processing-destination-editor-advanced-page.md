...
# Partition Processing Destination Editor (Advanced Page)
 ...
 To learn more about the Partition Processing destination, see [Partition Processing Destination](../../integration-services/data-flow/partition-processing-destination.md).  
 ...
 **Use default error configuration.**  
 Specify whether to use the default [!INCLUDE[ssASnoversion](../../a9notintoc/includes/ssasnoversion-md.md)] error handling. By default, this value is **True**.  
