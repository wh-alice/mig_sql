...
ms.topic: "reference"
f1_keywords: 
  - "sql13.dm.miningmodeleditor.clustering.discrimination.f1"
 ...
 **Viewer**  
 Choose a viewer to use to explore the selected mining model. You can use the custom viewer for clustering models, or the [!INCLUDE[msCoName](../a9notintoc/includes/msconame-md.md)] Mining Content Viewer. You can also use plug-in viewers if available.  
