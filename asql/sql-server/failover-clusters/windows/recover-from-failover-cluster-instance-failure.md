...
1.  After Node 1 fails, the [!INCLUDE[ssNoVersion](../../../a9notintoc/includes/ssnoversion-md.md)] FCI fails over to Node 2.  
...
7.  Run [!INCLUDE[ssNoVersion](../../../a9notintoc/includes/ssnoversion-md.md)] Setup to add Node 1 to the FCI. For more information, see [Add or Remove Nodes in a SQL Server Failover Cluster &#40;Setup&#41;](../../../sql-server/failover-clusters/install/add-or-remove-nodes-in-a-sql-server-failover-cluster-setup.md).  
...
4.  Fail over [!INCLUDE[ssNoVersion](../../../a9notintoc/includes/ssnoversion-md.md)] to the recovered node.  
