...
## Example  
 Execute the first ([!INCLUDE[tsql](../../../a9notintoc/includes/tsql-md.md)]) code listing to create the stored procedure used by the application.  
 ...
 Execute the third ([!INCLUDE[tsql](../../../a9notintoc/includes/tsql-md.md)]) code listing to delete the stored procedure used by the application.  
