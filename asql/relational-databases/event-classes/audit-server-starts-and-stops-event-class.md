...
---
# Audit Server Starts and Stops Event Class
  The **Audit Server Starts and Stops** event class occurs when the [!INCLUDE[msCoName](../../a9notintoc/includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../a9notintoc/includes/ssnoversion-md.md)] service state is modified.  
