...
> [!NOTE]  
>  Lightweight pooling is not supported for [!INCLUDE[msCoName](../../../a9notintoc/includes/msconame-md.md)] Windows 2000 and [!INCLUDE[msCoName](../../../a9notintoc/includes/msconame-md.md)] Windows XP. [!INCLUDE[winxpsvr](../../../database-engine/configure/windows/includes/winxpsvr-md.md)] provides full support for lightweight pooling.  
