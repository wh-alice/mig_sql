...
|SubmitTime|**datetime**|The time when the event was submitted to [!INCLUDE[ssNoVersion](../../a9notintoc/includes/ssnoversion-md.md)].|6|  
...
|LoginName|**nvarchar**|The user login name. This can be either a [!INCLUDE[ssNoVersion](../../a9notintoc/includes/ssnoversion-md.md)] security login or the Microsoft Windows login credentials, in the format *domain_name*\\*user_name*.|14|  
...
|ApplicationName|**nvarchar**|The name of the client application that created the [!INCLUDE[ssNoVersion](../../a9notintoc/includes/ssnoversion-md.md)] connection during capture.|17|  
