...
> [!NOTE]  
>  *publisher* should not be specified when requesting publication information from a [!INCLUDE[ssNoVersion](../../../a9notintoc/includes/ssnoversion-md.md)] Publisher.  
...
|compress_snapshot|**bit**|Specifies that the snapshot that is written to the *alt_snapshot_folder* location is to be compressed into the [!INCLUDE[msCoName](../../../a9notintoc/includes/msconame-md.md)] CAB format. **0** specifies that the snapshot will not be compressed.|  
...
|queue_type||Specifies which type of queue is used. Can be one of these values:<br /><br /> **msmq** = Use [!INCLUDE[msCoName](../../../a9notintoc/includes/msconame-md.md)] Message Queuing to store transactions.<br /><br /> **sql** = Use [!INCLUDE[ssNoVersion](../../../a9notintoc/includes/ssnoversion-md.md)] to store transactions.<br /><br /> Note: Support for Message Queuing has been discontinued.|  
|backward_comp_level||Database compatibility level, and can be one of the following:<br /><br /> **90** = [!INCLUDE[msCoName](../../../a9notintoc/includes/msconame-md.md)] [!INCLUDE[ssVersion2005](../../../a9notintoc/includes/ssversion2005-md.md)]<br /><br /> **100** = [!INCLUDE[msCoName](../../../a9notintoc/includes/msconame-md.md)] [!INCLUDE[ssKatmai](../../../a9notintoc/includes/sskatmai-md.md)]|  
|publish_to_AD|**bit**|Specifies whether the publication is published in the [!INCLUDE[msCoName](../../../a9notintoc/includes/msconame-md.md)] Active Directory™. A value of **1** indicates that it is published, and a value of **0** indicates that it is not published.|  
...
## Example  
 [!code-sql[HowTo#sp_helppublication](../../../a9retired/codesnippet/tsql/sp-helppublication-trans_1.sql)]  
...
## Permissions  
 ...
 For a non-[!INCLUDE[ssNoVersion](../../../a9notintoc/includes/ssnoversion-md.md)] Publisher, only members of the sysadmin fixed server role at the Distributor or members of the db_owner fixed database role on the distribution database or users in the PAL can execute sp_helppublication.  
