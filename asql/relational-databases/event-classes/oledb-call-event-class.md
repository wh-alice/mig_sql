...
---
# OLEDB Call Event Class
  The **OLEDB Call** event class occurs when [!INCLUDE[ssNoVersion](../../a9notintoc/includes/ssnoversion-md.md)] calls an OLE DB provider for distributed queries and remote stored procedures.  
