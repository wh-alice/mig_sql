...
## Example  
 ...
 Execute the first ([!INCLUDE[tsql](../../../advanced-analytics/r-services/includes/tsql-md.md)]) code listing to create the table that the sample will use.  
 ...
 Execute the fifth ([!INCLUDE[tsql](../../../advanced-analytics/r-services/includes/tsql-md.md)]) code listing to delete the table that the sample used.  
