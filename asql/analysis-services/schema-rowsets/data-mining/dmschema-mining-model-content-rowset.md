...
|-----------------|--------------------|------------|-----------------|  
|**MODEL_CATALOG**|**DBTYPE_WSTR**||The catalog name. [!INCLUDE[msCoName](../../../a9notintoc/includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../../a9notintoc/includes/ssnoversion-md.md)] [!INCLUDE[ssASnoversion](../../../a9notintoc/includes/ssasnoversion-md.md)] populates this column with the name of the database of which the model is a member.|  
|**MODEL_SCHEMA**|**DBTYPE_WSTR**||The unqualified schema name. This column is not supported by [!INCLUDE[ssASnoversion](../../../a9notintoc/includes/ssasnoversion-md.md)]; it always contains **VT_NULL**.|  
...
|**NODE_GUID**|**DBTYPE_GUID**||The node GUID. This column is not supported by [!INCLUDE[ssASnoversion](../../../a9notintoc/includes/ssasnoversion-md.md)]; it always contains **NULL**.|  
