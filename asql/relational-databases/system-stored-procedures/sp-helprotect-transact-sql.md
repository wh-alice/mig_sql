...
> [!IMPORTANT]  
>  **sp_helprotect** does not return information about securables that were introduced in [!INCLUDE[ssVersion2005](../../analysis-services/data-mining/includes/ssversion2005-md.md)]. Use [sys.database_permissions](../../relational-databases/system-catalog-views/sys.database-permissions-transact-sql.md) and [fn_builtin_permissions](../../relational-databases/system-functions/sys.fn-builtin-permissions-transact-sql.md) instead.  
