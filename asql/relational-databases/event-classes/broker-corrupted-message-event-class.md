...
---
# Broker:Corrupted Message Event Class
  [!INCLUDE[ssNoVersion](../../a9notintoc/includes/ssnoversion-md.md)] creates a **Broker:Corrupted Message** event when Service Broker receives a corrupted message.  
...
|**Severity**|**int**|If an error caused [!INCLUDE[ssNoVersion](../../a9notintoc/includes/ssnoversion-md.md)] to drop the message, the severity of the error.|29|No|  
