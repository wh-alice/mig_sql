...
# Bulk Import and Export of Data (SQL Server)
  [!INCLUDE[ssNoVersion](../../a9notintoc/includes/ssnoversion-md.md)] supports exporting data in bulk (*bulk data*) from a [!INCLUDE[ssNoVersion](../../a9notintoc/includes/ssnoversion-md.md)] table and importing bulk data into a [!INCLUDE[ssNoVersion](../../a9notintoc/includes/ssnoversion-md.md)] table or nonpartitioned view. 
  
 *Bulk exporting* refers to copying data from a [!INCLUDE[ssNoVersion](../../a9notintoc/includes/ssnoversion-md.md)] table to a data file. 
 *Bulk importing* refers to loading data from a data file into a [!INCLUDE[ssNoVersion](../../a9notintoc/includes/ssnoversion-md.md)] table. For example, you can export data from a [!INCLUDE[msCoName](../../a9notintoc/includes/msconame-md.md)] Excel application to a data file and then bulk import that data into a [!INCLUDE[ssNoVersion](../../a9notintoc/includes/ssnoversion-md.md)] table.  
...
|[BULK INSERT statement](../../relational-databases/import-export/import-bulk-data-by-using-bulk-insert-or-openrowset-bulk...-sql-server.md)|A [!INCLUDE[tsql](../../a9notintoc/includes/tsql-md.md)] statement that imports data directly from a data file into a database table or nonpartitioned view.|Yes|No|  
...
##  <a name="FFs"></a> Format files  
 ...
 [!INCLUDE[ssNoVersion](../../a9notintoc/includes/ssnoversion-md.md)] supports two kinds of format files: XML format files and non-XML format files.  
