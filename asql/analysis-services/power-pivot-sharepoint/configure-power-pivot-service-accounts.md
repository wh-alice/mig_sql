...
1.  Point to Start, click **Administrative Tools**, and then click **Services**. Double-click **SQL Server Analysis Services ([!INCLUDE[ssGemini](../../a9notintoc/includes/ssgemini-md.md)])**. Click **Log On**, and then enter the new password for the account.  
...
2.  Select, but do not click, the [!INCLUDE[ssGemini](../../a9notintoc/includes/ssgemini-md.md)] service application. Clicking on the application name opens the [!INCLUDE[ssGemini](../../a9notintoc/includes/ssgemini-md.md)] Management Dashboard, which does not provide a link to the properties page that specifies the application pool.  You can click the empty white space in the row, or click on type name, to select the [!INCLUDE[ssGemini](../../a9notintoc/includes/ssgemini-md.md)] service application.  
...
##  <a name="requirements"></a> Account Requirements and Permissions  
 When planning a [!INCLUDE[ssGemini](../../a9notintoc/includes/ssgemini-md.md)] for SharePoint deployment, you must plan for the following service accounts.  
  
-   Analysis Services service account. Analysis Services processes [!INCLUDE[ssGemini](../../a9notintoc/includes/ssgemini-md.md)] queries and data refresh jobs in the farm. This account is always specified during SQL Server Setup when you install [!INCLUDE[ssGemini](../../a9notintoc/includes/ssgemini-md.md)] for SharePoint.  
  
-   [!INCLUDE[ssGemini](../../a9notintoc/includes/ssgemini-md.md)] Service Application Pool. A [!INCLUDE[ssGemini](../../a9notintoc/includes/ssgemini-md.md)] service application is associated with a [!INCLUDE[ssGemini](../../a9notintoc/includes/ssgemini-md.md)] System Service that provides SharePoint integration and infrastructure for [!INCLUDE[ssGemini](../../a9notintoc/includes/ssgemini-md.md)] query processing in a farm. The application pool that you specify for a [!INCLUDE[ssGemini](../../a9notintoc/includes/ssgemini-md.md)] service application is the service identity of the [!INCLUDE[ssGemini](../../a9notintoc/includes/ssgemini-md.md)] System Service. You can have multiple [!INCLUDE[ssGemini](../../a9notintoc/includes/ssgemini-md.md)] service applications in a farm. Each one that you create should run in its own application pool.  
...
5.  Type the name of the account that is used for [!INCLUDE[ssGemini](../../a9notintoc/includes/ssgemini-md.md)] service application pool, and then click **OK**.  
...
11. Type the name of the account that is used for [!INCLUDE[ssGemini](../../a9notintoc/includes/ssgemini-md.md)] service application pool, and then click **OK**.  
