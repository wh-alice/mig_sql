...
7.  Optionally, click the **Advanced Replay Options**tab to specify the following options:  
    ...
    -   To control how [!INCLUDE[ssNoVersion](../../a9notintoc/includes/ssnoversion-md.md)] manages processes during replay, configure **Health Monitor Options**.  
