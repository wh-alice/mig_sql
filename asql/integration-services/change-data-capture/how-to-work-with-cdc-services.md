...
# How to Work with CDC Services
  This procedure describes how to use the CDC Service Configuration Console to prepare a [!INCLUDE[ssNoVersion](../../advanced-analytics/r-services/includes/ssnoversion-md.md)] instance to work with Oracle CDC Services and to create a new CDC service.  
...
3.  You carry out the one or both of the following tasks:  
    ...
    -   **Prepare SQL Server**  
         ...
         The Preparing [!INCLUDE[ssNoVersion](../../advanced-analytics/r-services/includes/ssnoversion-md.md)] Instance for Oracle CDC dialog box opens.  
