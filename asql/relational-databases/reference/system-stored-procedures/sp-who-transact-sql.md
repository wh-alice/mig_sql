...
[!INCLUDE[tsql-appliesto-ss2008-xxxx-xxxx-xxx_md](../../../a9retired/includes/tsql-appliesto-ss2008-xxxx-xxxx-xxx-md.md)]
  ...
  Provides information about current users, sessions, and processes in an instance of the [!INCLUDE[msCoName](../../../a9notintoc/includes/msconame-md.md)] [!INCLUDE[ssDEnoversion](../../../a9notintoc/includes/ssdenoversion-md.md)]. The information can be filtered to return only those processes that are not idle, that belong to a specific user, or that belong to a specific session.  
 ...
 *session ID* is a session identification number belonging to the [!INCLUDE[ssNoVersion](../../../a9notintoc/includes/ssnoversion-md.md)] instance. *session ID* is **smallint**.  
...
|**cmd**|**nchar(16)**|[!INCLUDE[ssDE](../../../a9notintoc/includes/ssde-md.md)] command ([!INCLUDE[tsql](../../../a9notintoc/includes/tsql-md.md)] statement, internal [!INCLUDE[ssDE](../../../a9notintoc/includes/ssde-md.md)] process, and so on) executing for the process.|  
...
## Permissions  
 Requires VIEW SERVER STATE permission on the server to see all executing sessions on the instance of [!INCLUDE[ssNoVersion](../../../a9notintoc/includes/ssnoversion-md.md)]. Otherwise, the user sees only the current session.  
