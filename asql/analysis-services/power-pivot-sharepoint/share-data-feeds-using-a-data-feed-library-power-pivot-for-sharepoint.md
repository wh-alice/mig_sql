...
> [!NOTE]  
>  Although data feeds are used to add Web data to a [!INCLUDE[ssGemini](../../analysis-services/includes/ssgemini-md.md)] data source that you create in a [!INCLUDE[ssGeminiClient](../../analysis-services/includes/ssgeminiclient-md.md)], any client application that can read an Atom feed can process a data service document.  
  
##  <a name="prereq"></a> Prerequisites  
 You must have a deployment of [!INCLUDE[ssKilimanjaro](../../analysis-services/instances/install/windows/includes/sskilimanjaro-md.md)] [!INCLUDE[ssGemini](../../analysis-services/includes/ssgemini-md.md)] for SharePoint that adds [!INCLUDE[ssGemini](../../analysis-services/includes/ssgemini-md.md)] query processing to a SharePoint farm. Data Feed support is deployed through the [!INCLUDE[ssGemini](../../analysis-services/includes/ssgemini-md.md)] solution package.  
...
##  <a name="securedsdoc"></a> Secure a Data Service Document  
 ...
 To use a data service document as a data feed import in the [!INCLUDE[ssGemini](../../analysis-services/includes/ssgemini-md.md)] client application, a user only needs view permissions on the document. View permissions are sufficient to resolve the URL in the Import Wizard.  
...
##  <a name="modifydsdoc"></a> Modify a Data Service Document  
 ...
 Because there is no persistent link between a data service document on a SharePoint site and the [!INCLUDE[ssGemini](../../analysis-services/includes/ssgemini-md.md)] workbook that contains the imported feed, modifying any part of a data service document has no effect on existing [!INCLUDE[ssGemini](../../analysis-services/includes/ssgemini-md.md)] workbooks.  
