...
-   **sp_rda_deauthorize_db**  
    ...
    -   Run [sys.sp_rda_set_query_mode](../../../relational-databases/reference/system-stored-procedures/sys.sp-rda-set-query-mode-transact-sql.md) with the LOCAL_ONLY argument to let queries continue to run against local data only.  
