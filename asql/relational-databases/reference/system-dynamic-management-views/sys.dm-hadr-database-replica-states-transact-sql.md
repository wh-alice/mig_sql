...
|-----------------|---------------|----------------------------------------|  
|**database_id**|**int**|Identifier of the database, unique within an instance of SQL Server. This is the same value as displayed in the [sys.databases](../../../relational-databases/reference/system-catalog-views/sys.databases-transact-sql.md) catalog view.|  
...
|**is_local**|**bit**|Whether the availability database is local, one of:<br /><br /> 0 = The database is not local to the [!INCLUDE[ssNoVersion](../../../a9notintoc/includes/ssnoversion-md.md)] instance.<br /><br /> 1 = The database is local to the server instance.|  
