...
## Arguments  
 ...
 [ **@params =** ] **N'***parameters***'**  
 @params provides a declaration string for parameters for the [!INCLUDE[tsql](../../../a9notintoc/includes/tsql-md.md)] batch, similarly to the way sp_executesql works. *Parameters* may be **nvarchar(***n***)** or **nvarchar(max)**.  
