...
You can create queries that include any number of search conditions, linked with any number of AND and OR operators. A query with a combination of AND and OR clauses can become complex, so it is helpful to understand how such a query is interpreted when you execute it, and how such a query is represented in the [Criteria Pane](../ssms/criteria-pane--visual-database-tools-.md) and [SQL Pane](../ssms/sql-pane--visual-database-tools-.md).  
  
> [!NOTE]  
> For details about search conditions that contain only one AND or OR operator, see [Specify Multiple Search Conditions for One Column &#40;Visual Database Tools&#41;](../ssms/specify-multiple-search-conditions-for-one-column--visual-database-tools-.md) and [Specify Multiple Search Conditions for Multiple Columns &#40;Visual Database Tools&#41;](../ssms/specify-multiple-search-conditions-for-multiple-columns--visual-database-tools-.md).  
...
The Query and View Designer represents your search conditions in the [Criteria Pane](../ssms/criteria-pane--visual-database-tools-.md). However, in some cases that involve multiple clauses linked with AND and OR, the representation in the Criteria Pane might not be what you expect. In addition, if you modify your query in the Criteria Pane or [Diagram Pane](../ssms/diagram-pane--visual-database-tools-.md), you might find that your SQL statement has been changed from what you entered.  
...
![OR clause precedence in the Criteria Pane](../ssms/media/vs_criteriapane1.gif "OR clause precedence in the Criteria Pane")  
...
![Multiple AND and OR clauses in the Criteria Pane](../ssms/media/vs_criteriapane2.gif "Multiple AND and OR clauses in the Criteria Pane")  
...
![Linked OR clauses defined in the Criteria Pane](../ssms/media/vs_criteriapane3.gif "Linked OR clauses defined in the Criteria Pane")  
