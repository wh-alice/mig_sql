...
|**GetCustomErrorObject**|Returns a reference on interfaces **ISQLErrorInfo,** and [ISQLServerErrorInfo](http://msdn.microsoft.com/en-US/library/ms131458(SQL.130).aspx).|  
