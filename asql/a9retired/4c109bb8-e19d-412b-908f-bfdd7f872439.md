...
ms.topic: "reference"
f1_keywords: 
  - "sql13.asvs.schemagenwizard.subjectareaschemaopts.f1"
...
> [!NOTE]  
>  This option is enabled only if Schema Generation Wizard is called from an [!INCLUDE[ssASnoversion](../a9notintoc/includes/ssasnoversion-md.md)] project, using [!INCLUDE[ssBIDevStudioFull](../a9notintoc/includes/ssbidevstudiofull-md.md)] in project mode.  
