...
## Copy and Paste  
 ...
 When you copy a package object, [!INCLUDE[ssISnoversion](../a9notintoc/includes/ssisnoversion-md.md)] automatically assigns a new GUID to the **ID** property of the new object and updates the **Name** property.  
...
-   [Save a Package as a Package Template](../a9retired/save-a-package-as-a-package-template.md)  
