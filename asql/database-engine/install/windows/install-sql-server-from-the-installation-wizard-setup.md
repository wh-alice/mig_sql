...
12. On the Instance Configuration page, specify whether to install a default instance or a named instance. For more information, see [Instance Configuration](http://msdn.microsoft.com/en-US/library/ms143531(SQL.130).aspx).  
