...
## Components that Use Expressions  
 The following elements in [!INCLUDE[ssISnoversion](../../a9notintoc/includes/ssisnoversion-md.md)] can use expressions:  
