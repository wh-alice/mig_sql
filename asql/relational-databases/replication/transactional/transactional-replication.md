...
-   The Publisher or Subscriber is a non-[!INCLUDE[ssNoVersion](../../../a9notintoc/includes/ssnoversion-md.md)] database, such as Oracle.  
...
##  <a name="SnapshotAgent"></a> Snapshot Agent  
 ...
 After the snapshot files have been generated, you can view them in the snapshot folder using [!INCLUDE[msCoName](../../../a9notintoc/includes/msconame-md.md)] Windows Explorer.  
