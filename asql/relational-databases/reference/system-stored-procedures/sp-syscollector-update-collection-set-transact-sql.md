...
## Arguments  
 ...
 [ **@proxy_id =** ] *proxy_id*  
 Is the unique identifier for a [!INCLUDE[ssNoVersion](../../../a9notintoc/includes/ssnoversion-md.md)] Agent proxy account. *proxy_id* is **int**.  
 ...
 0 - Log execution information and [!INCLUDE[ssIS](../../../a9retired/includes/ssis-md.md)] events that track:  
...
-   Warning events from [!INCLUDE[ssIS](../../../a9retired/includes/ssis-md.md)]  
  
 2 - Level-1 logging and detailed event information from [!INCLUDE[ssIS](../../../a9retired/includes/ssis-md.md)].  
...
## Remarks  
 ...
 If the collection set is running, you can only update *schedule_uid* and *description*. To stop the collection set, use [sp_syscollector_stop_collection_set](../../../relational-databases/reference/system-stored-procedures/sp-syscollector-stop-collection-set-transact-sql.md).  
