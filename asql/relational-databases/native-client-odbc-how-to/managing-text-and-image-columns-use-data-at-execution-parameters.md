...
1.  When calling [SQLBindParameter](../../relational-databases/extended-stored-procedures-reference/sqlbindparameter.md) to bind a program buffer to the statement parameter:  
...
2.  Calling [SQLExecDirect](http://go.microsoft.com/fwlink/?LinkId=58399) or [SQLExecute](http://go.microsoft.com/fwlink/?LinkId=58400) returns SQL_NEED_DATA, which indicates that data-at-execution parameters are ready for processing.  
...
3.  For each data-at-execution parameter:  
    ...
    -   Call [SQLPutData](../../relational-databases/extended-stored-procedures-reference/sqlputdata.md) one or more times, to send the parameter data, until length is sent.  
