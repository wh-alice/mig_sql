...
|Task|Tool|Link|  
|----------|----------|----------|  
|Add a shared dataset or change shared dataset definition properties.|Save in Report Builder.<br /><br /> Deploy in Report Designer.<br /><br /> Upload an .rsd file in Report Manager|[Report Embedded Datasets and Shared Datasets &#40;Report Builder and SSRS&#41;](../../reporting-services/report-data/report-embedded-datasets-and-shared-datasets-report-builder-and-ssrs.md) in the [Report Builder documentation](http://go.microsoft.com/fwlink/?LinkId=154494) on msdn.microsoft.com<br /><br /> [Upload File Page &#40;Report Manager&#41;](http://msdn.microsoft.com/en-US/library/ms187015(SQL.130).aspx)<br /><br /> If you upload a shared dataset before the shared data source that it depends is published, you must manually bind the shared dataset to the shared data source. For more information, see [General Properties Page, Shared Datasets &#40;Report Manager&#41;](http://msdn.microsoft.com/en-US/library/ee636366(SQL.130).aspx).|  
|Change shared dataset item properties.|Report Manager|[General Properties Page, Shared Datasets &#40;Report Manager&#41;](http://msdn.microsoft.com/en-US/library/ee636366(SQL.130).aspx)|  
|Specify additional shared dataset properties for a shared dataset instance in a report.|Report Builder Report Designer|[Dataset Properties Dialog Box, Query](http://msdn.microsoft.com/en-US/library/ms178261(SQL.130).aspx)|  
|Bind to a different shared data source for a shared dataset.|Report Manager|[Data Source Selection Page &#40;Report Manager&#41;](http://msdn.microsoft.com/en-US/library/ms186978(SQL.130).aspx)|  
...
|Enable caching|Report Manager|[Cache Shared Datasets &#40;SSRS&#41;](../../reporting-services/report-server/cache-shared-datasets-ssrs.md)<br /><br /> [Caching Page, Shared Datasets &#40;Report Manager&#41;](http://msdn.microsoft.com/en-US/library/ee636977(SQL.130).aspx)|  
|Create or edit a cache refresh plan|Report Manager|[Cache Refresh Options &#40;Report Manager&#41;](http://msdn.microsoft.com/en-US/library/ee636367(SQL.130).aspx)|  
