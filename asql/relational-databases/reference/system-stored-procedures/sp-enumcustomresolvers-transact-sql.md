...
|**dotnet_assembly_name**|**nvarchar(255)**|The name of the [!INCLUDE[msCoName](../../../a9notintoc/includes/msconame-md.md)] .NET Framework assembly that implements the business logic handler.|  
