...
---
# User Roles
  This section describes the user roles for the Change Data Capture Service for Oracle by Attunity. The roles described are [!INCLUDE[ssNoVersion](../../a9notintoc/includes/ssnoversion-md.md)] database roles, Windows roles, or Oracle database roles.  
...
-   Setting up the CDC Service connection to the target [!INCLUDE[ssNoVersion](../../a9notintoc/includes/ssnoversion-md.md)] instance (connection string and credentials)  
...
## SQL Server User Roles  
 The following describes the [!INCLUDE[ssNoVersion](../../a9notintoc/includes/ssnoversion-md.md)] user roles used by the Oracle CDC Service.  
...
### Oracle CDC Service Administrator  
 ...
 The CDC Service Administrator should be granted the [!INCLUDE[ssNoVersion](../../a9notintoc/includes/ssnoversion-md.md)] fixed server roles **public** and **dbcreator**.  
...
### Oracle CDC Service User  
 ...
 The [!INCLUDE[ssNoVersion](../../a9notintoc/includes/ssnoversion-md.md)] Oracle CDC Service user should be granted the following:  
...
-   Member of the fixed database roles **db_datareader** and **db_datawriter** for the MSXDBCDC database.  
 ...
 Because the Oracle CDC Service uses a single [!INCLUDE[ssNoVersion](../../a9notintoc/includes/ssnoversion-md.md)] login to work with all CDC databases and the MSXDBCDC database, this login should be mapped in all of these databases.  
  
### Oracle CDC Change Consumer  
 The Oracle CDC Change Consumer is a [!INCLUDE[ssNoVersion](../../a9notintoc/includes/ssnoversion-md.md)] user that consumes changes stored in the CDC tables in the [!INCLUDE[ssNoVersion](../../a9notintoc/includes/ssnoversion-md.md)] Oracle CDC Instance database.  
...
-   Helping to restore archived transaction log files no longer available so they can be processed.  
 ...
 The Oracle database administrator works in coordination with the Oracle CDC Service administrator on the configuration of the [!INCLUDE[ssNoVersion](../../a9notintoc/includes/ssnoversion-md.md)] Oracle CDC Instances.  
