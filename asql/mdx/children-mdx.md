...
|Release|History|  
|-------------|-------------|  
|[!INCLUDE[ssBOL2005_R03](../mdx/includes/ssbol2005-r03-md.md)]|**Changed content:**<br /> — Updated syntax and arguments to improve clarity.<br /><br /> — Added updated examples.|  
