...
7.  Select one of the following create stoplist options:  
    ...
    -   **Create from an existing full-text stoplist**  
     ...
     For more information, see [New Full-Text Stoplist &#40;General Page&#41;](http://msdn.microsoft.com/en-US/library/cc280518(SQL.130).aspx).  
...
5.  In the [Full-Text Stoplist Properties](http://msdn.microsoft.com/en-US/library/cc280415(SQL.130).aspx) dialog box:  
