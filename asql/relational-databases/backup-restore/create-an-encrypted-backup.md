...
-   A windows storage account and a container. For more information, see. [Lesson 1: Create Windows Azure Storage Objects](../../a9notintoc/lesson-1-create-windows-azure-storage-objects.md).  
