...
|[ListInstalledSharePointVersions Method &#40;WMI&#41;](../../reporting-services/wmi-provider-library-reference/configurationsetting-method-listinstalledsharepointversions.md)|Returns a set of tokens that represent the versions of Microsoft [!INCLUDE[winSPServ](../../relational-databases/tables/includes/winspserv-md.md)] [!INCLUDE[offSPServ](../../a9retired/includes/offspserv-md.md)], [!INCLUDE[SPF2010](../../a9retired/includes/spf2010-md.md)], or [!INCLUDE[SPS2010](../../a9retired/includes/sps2010-md.md)] that are installed on the same computer as the report server.|  
