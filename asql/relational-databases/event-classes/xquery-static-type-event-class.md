...
---
# XQuery Static Type Event Class
  The XQuery Static Type event class occurs when [!INCLUDE[ssNoVersion](../../advanced-analytics/r-services/includes/ssnoversion-md.md)] executes an XQuery expression. This event class provides the static type of the XQuery expression.  
