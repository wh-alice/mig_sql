...
-   Set the cursor capabilities using [SQLSetStmtAttr](../../relational-databases/extended-stored-procedures-reference/sqlsetstmtattr.md).  
  
-   Open the cursor using **SQLExecute** or **SQLExecDirect**.  
  
-   Scroll and fetch rows using **SQLFetch** or [SQLFetchScroll](../../relational-databases/extended-stored-procedures-reference/sqlfetchscroll.md).  
