...
## sql-relation  
 ...
 The **sql:relation** annotation is also useful when identifiers that are valid in [!INCLUDE[msCoName](../../advanced-analytics/r-services/tutorials/includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../advanced-analytics/r-services/includes/ssnoversion-md.md)] are not valid in XML. For example, "Order Details" is a valid table name in [!INCLUDE[ssNoVersion](../../advanced-analytics/r-services/includes/ssnoversion-md.md)] but not in XML. In such cases, the **sql:relation** annotation can be used to specify the mapping, for example:  
