...
## Getting Started with a Destination Component  
 When you add a Script component to the Data Flow tab of [!INCLUDE[ssIS](../../analysis-services/instances/includes/ssis-md.md)] Designer, the **Select Script Component Type** dialog box opens and prompts you to select a **Source**, **Destination**, or **Transformation** script. In this dialog box, select **Destination**.  
  
 Next, connect the output of a transformation to the destination component in [!INCLUDE[ssIS](../../analysis-services/instances/includes/ssis-md.md)] Designer. For testing, you can connect a source directly to a destination without any transformations.  
...
### ADO.NET Destination Example  
 This example demonstrates a destination component that uses an existing [!INCLUDE[vstecado](../../analysis-services/data-mining/includes/vstecado-md.md)] connection manager to save data from the data flow into a [!INCLUDE[ssNoVersion](../../advanced-analytics/r-services/includes/ssnoversion-md.md)] table.  
...
2.  Create a destination table by running the following [!INCLUDE[tsql](../../advanced-analytics/r-services/includes/tsql-md.md)] command in the **AdventureWorks** database:  
...
7.  On the **Connection Managers** page, add or create the [!INCLUDE[vstecado](../../analysis-services/data-mining/includes/vstecado-md.md)] connection manager with a name such as **MyADONETConnectionManager**.  
