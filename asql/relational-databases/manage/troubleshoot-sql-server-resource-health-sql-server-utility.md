...
# Troubleshoot SQL Server Resource Health (SQL Server Utility)
 ...
 For more information about failed data collection resulting in gray status icons in the managed instance list view on a UCP, see [Troubleshoot the SQL Server Utility](../../a9retired/troubleshoot-the-sql-server-utility.md). For more information about getting started with [!INCLUDE[ssNoVersion](../../a9notintoc/includes/ssnoversion-md.md)] Utility, see [SQL Server Utility Features and Tasks](../../relational-databases/manage/sql-server-utility-features-and-tasks.md).  
  
 For more information about mitigating specific resource health issues identified by a [!INCLUDE[ssNoVersion](../../a9notintoc/includes/ssnoversion-md.md)] UCP, see the following topics:  
