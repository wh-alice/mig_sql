...
```  
 ...
 Instead of XML, you may return these values as non-xml type, as shown in the following query. The query uses the [value() method (xml data type)](../t-sql/data-types/value-method-xml-data-type.md) to retrieve the work center location count.  
