 ...
 **Windows Azure**: For information on using [!INCLUDE[ssRSnoversion](../../../advanced-analytics/r-services/includes/ssrsnoversion-md.md)] with Windows Azure Virtual Machines, see the following:  
...
|Task|Link|  
|----------|----------|  
|Review Hardware and software requirements.|[Hardware and Software Requirements for Reporting Services in SharePoint Mode](http://msdn.microsoft.com/en-US/library/jj714188(SQL.130).aspx).|  
