...
-   View and edit results immediately.  
 ...
 For more information, see [Query Builder](http://msdn.microsoft.com/en-US/library/ms186906(SQL.130).aspx).  
