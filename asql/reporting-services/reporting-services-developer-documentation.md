...
## In This Section  
 ...
 Provides an overview of how to use [!INCLUDE[ssRSnoversion](../a9notintoc/includes/ssrsnoversion-md.md)] to integrate reporting into custom applications. Describes when to use direct URL access and when to use the Web service to access the report server.  
 ...
 Describes how to use the [!INCLUDE[ssRSnoversion](../a9notintoc/includes/ssrsnoversion-md.md)] WMI Provider to manage report server deployments.  
