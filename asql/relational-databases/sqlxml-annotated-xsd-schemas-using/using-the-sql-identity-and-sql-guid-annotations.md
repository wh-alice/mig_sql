...
## sql:identity Annotation  
 ...
 ignore  
 Directs the updategram to ignore any value that is provided in the updategram for that column and to rely on [!INCLUDE[ssNoVersion](../../a9notintoc/includes/ssnoversion-md.md)] to generate the identity value.  
...
## sql:guid Annotation  
 ...
 generate  
 Specifies that the GUID generated by [!INCLUDE[ssNoVersion](../../a9notintoc/includes/ssnoversion-md.md)] be used for that column in the update operation.  
