...
helpviewer_keywords: 
  - "DTC"
ms.assetid: f9b9a429-5fb6-4eae-88f0-6613c58a38a0
...
The walkthrough creates a clustered DTC resource and the SQL Server Availability Groups to align with the requirements at [Cluster MSDTC for SQL Server Availability Groups](../a9notintoc/cluster-dtc-for-sql-server-2016-availability-groups.md).
