...
## Customizing the Logistic Regression Algorithm  
 The [!INCLUDE[msCoName](../../a9notintoc/includes/msconame-md.md)] logistic regression algorithm supports several parameters that affect the behavior, performance, and accuracy of the resulting mining model. You can also modify the behavior of the model by setting modeling flags on the columns used as input.  
...
### Modeling Flags  
 The following modeling flags are supported for use with the [!INCLUDE[msCoName](../../a9notintoc/includes/msconame-md.md)] Logistic Regression algorithm.  
