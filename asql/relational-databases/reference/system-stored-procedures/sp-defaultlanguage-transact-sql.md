...
[!INCLUDE[tsql-appliesto-ss2008-xxxx-xxxx-xxx_md](../../../a9retired/includes/tsql-appliesto-ss2008-xxxx-xxxx-xxx-md.md)]
  ...
  Changes the default language of for a [!INCLUDE[ssNoVersion](../../../a9notintoc/includes/ssnoversion-md.md)] login.  
...
## Arguments  
 [ **@loginame =** ] **'***login***'**  
 Is the login name. *login* is **sysname**, with no default. *login* can be an existing [!INCLUDE[ssNoVersion](../../../a9notintoc/includes/ssnoversion-md.md)] login or a Windows user or group.  
