...
[!INCLUDE[tsql-appliesto-ss2008-xxxx-xxxx-xxx_md](../../a9retired/includes/tsql-appliesto-ss2008-xxxx-xxxx-xxx-md.md)]
  ...
  This topic describes how to move system databases in [!INCLUDE[ssNoVersion](../../a9notintoc/includes/ssnoversion-md.md)]. Moving system databases may be useful in the following situations:  
...
> [!IMPORTANT]  
>  After moving files, the [!INCLUDE[ssNoVersion_md](../../a9notintoc/includes/ssnoversion-md.md)] service account must have permission to access the files in new file folder location.
...
5.  Verify the file change by running the following query.  
 ...
 If the msdb database is moved and the instance of [!INCLUDE[ssNoVersion](../../a9notintoc/includes/ssnoversion-md.md)] is configured for [Database Mail](../../relational-databases/database-mail/database-mail.md), complete these additional steps.  
...
5.  Stop the instance of [!INCLUDE[ssNoVersion](../../a9notintoc/includes/ssnoversion-md.md)]. For example, run `NET STOP MSSQLSERVER`.  
  
6.  Move the file or files to the new location.  
  
7.  Restart the instance of [!INCLUDE[ssNoVersion](../../a9notintoc/includes/ssnoversion-md.md)]. For example, run `NET START MSSQLSERVER`.  
...
2.  In the **SQL Server Services** node, right-click the instance of [!INCLUDE[ssNoVersion](../../a9notintoc/includes/ssnoversion-md.md)] (for example, **SQL Server (MSSQLSERVER)**) and choose **Properties**.  
...
6.  Stop the instance of [!INCLUDE[ssNoVersion](../../a9notintoc/includes/ssnoversion-md.md)] by right-clicking the instance name and choosing **Stop**.  
  
7.  Move the master.mdf and mastlog.ldf files to the new location.  
  
8.  Restart the instance of [!INCLUDE[ssNoVersion](../../a9notintoc/includes/ssnoversion-md.md)].  
