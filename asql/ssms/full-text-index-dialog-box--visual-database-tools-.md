...
> [!NOTE]  
> Full-text index functionality is not available in every edition of MicrosoftSQL Server. For a list of features that are supported by the editions of SQL Server, see [Features Supported by the Editions of SQL Server 2012](http://msdn.microsoft.com/en-us/5da61ff5-12b9-48e6-b3c8-0dacca1751c4).  
...
## See Also  
[Use the Full-Text Indexing Wizard](http://msdn.microsoft.com/en-us/3e9d9605-6525-4781-9168-fdaa06db3459)  
