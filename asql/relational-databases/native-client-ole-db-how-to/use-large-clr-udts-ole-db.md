...
[!INCLUDE[SNAC_Deprecated](../../relational-databases/extended-stored-procedures-reference/includes/snac-deprecated.md)]
  ...
  This sample shows how to fetch rows with large user-defined types from a result set. For more information, see [Large CLR User-Defined Types &#40;OLE DB&#41;](../../relational-databases/native-client/ole-db/large-clr-user-defined-types-ole-db.md). This sample works with [!INCLUDE[ssKatmai](../../analysis-services/data-mining/includes/sskatmai-md.md)] or later.  
...
## Example  
 ...
 Execute the second ([!INCLUDE[tsql](../../advanced-analytics/r-services/includes/tsql-md.md)]) code listing to add the assembly to the master database.  
 ...
 Execute the fourth ([!INCLUDE[tsql](../../advanced-analytics/r-services/includes/tsql-md.md)]) code listing to delete the assembly to the master database.  
