...
-   A negative buffer is returned when the dimensions of the instance are 2 or more.  
 ...
 The error between the theorectical and computed buffer is max(tolerance, extents \* 1.E-7) where tolerance is the value of the *tolerance* parameter. For more information on extents, see [geometry Data Type Method Reference](http://msdn.microsoft.com/en-US/library/bb933973(SQL.130).aspx).  
