...
# Force a WSFC Cluster to Start Without a Quorum
  This topic describes how to force a Windows Server Failover Clustering (WSFC) cluster node to start without a quorum.  This may be required in disaster recovery and multi-subnet scenarios to recover data and fully re-establish high-availability for [!INCLUDE[ssHADR](../../../a9notintoc/includes/sshadr-md.md)] and [!INCLUDE[ssNoVersion](../../../a9notintoc/includes/ssnoversion-md.md)] Failover Cluster Instances.  
...
-   Other [!INCLUDE[ssNoVersion](../../../a9notintoc/includes/ssnoversion-md.md)] features such as [!INCLUDE[ssHADR](../../../a9notintoc/includes/sshadr-md.md)], database mirroring, and log shipping may also require subsequent actions to recover data and to fully re-establish high-availability.  
