...
## Remarks  
 ...
 To view the current database name, query the [syscollector_config_store](../../../relational-databases/reference/system-catalog-views/syscollector-config-store-transact-sql.md) system view.  
