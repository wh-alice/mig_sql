...
>  CLR functionality, such as CLR user functions, are *not* supported for Azure SQL Database.  
 ...
 Describes how a CLR routine can access data stored in an instance of [!INCLUDE[ssNoVersion](../../a9notintoc/includes/ssnoversion-md.md)].  
 ...
 Provides information about the tools that can be used to monitor and troubleshoot managed database objects and assemblies running in [!INCLUDE[ssNoVersion](../../a9notintoc/includes/ssnoversion-md.md)].  
