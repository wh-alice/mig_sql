...
##  <a name="SupportedAvModes"></a> Supported Availability Modes  
 [!INCLUDE[ssHADR](../../../a9notintoc/includes/sshadr-md.md)] supports two availability modes—asynchronous-commit mode and synchronous-commit mode, as follows:  
...
> [!NOTE]  
>  For information about WSFC quorum and [!INCLUDE[ssHADR](../../../a9notintoc/includes/sshadr-md.md)], see For more information, see [WSFC Quorum Modes and Voting Configuration &#40;SQL Server&#41;](../../../sql-server/failover-clusters/windows/wsfc-quorum-modes-and-voting-configuration-sql-server.md).  
