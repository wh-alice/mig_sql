...
|Access reports using mobile devices||||[HTML 5 (supports viewing <10MB files)](http://go.microsoft.com/fwlink/?LinkId=391853)|[HTML 5 (supports viewing <1GB)](http://go.microsoft.com/fwlink/?LinkId=799619)<br /><br /> [Power BI apps for mobile devices](https://powerbi.microsoft.com/documentation/powerbi-power-bi-apps-for-mobile-devices/)|[Reporting Services](https://msdn.microsoft.com/library/ms159106.aspx)<br/>(using the Power BI apps for mobile devices)|  
...
|**Corporate BI**|IT Pro||||||  
|Create multi-dimensional/tabular corporate models||||||[Analysis Services](https://msdn.microsoft.com/library/bb522607.aspx)|  
...
|Create operational reports||||||*[Reporting Services](https://msdn.microsoft.com/library/ms159106.aspx)|  
|Create custom and embedded reports|||||[Power BI Embedded](https://azure.microsoft.com/services/power-bi-embedded/)|*[Reporting Services](https://msdn.microsoft.com/library/ms159106.aspx)|  
|**Advanced Analytics**|Data Scientist||||||  
|Perform self-service predictive analytics||||||[Data Mining Add-Ins for Excel](http://msdn.microsoft.com/library/dn282385.aspx) (Excel 2016 supported)|  
|Use data mining algorithms||||||[Data Mining in Analysis Services](https://msdn.microsoft.com/library/bb510516.aspx)<br/><br/>[SQL Server R Services](https://msdn.microsoft.com/library/mt604845.aspx)|  
