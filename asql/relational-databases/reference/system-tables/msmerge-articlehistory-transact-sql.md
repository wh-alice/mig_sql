...
|-----------------|---------------|-----------------|  
|**session_id**|**int**|The ID of a Merge Agent job session in the [MSmerge_sessions](../../../relational-databases/reference/system-tables/msmerge-sessions-transact-sql.md) system table.|  
