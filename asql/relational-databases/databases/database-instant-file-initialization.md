...
> [!NOTE]  
>  Instant file initialization is available only on [!INCLUDE[msCoName](../../a9notintoc/includes/msconame-md.md)][!INCLUDE[winxppro](../../relational-databases/databases/includes/winxppro-md.md)] or [!INCLUDE[winxpsvr](../../database-engine/configure/windows/includes/winxpsvr-md.md)] or later versions.  
...
-   Disable instant file initialization for the instance of [!INCLUDE[ssNoVersion](../../a9notintoc/includes/ssnoversion-md.md)] by revoking SE_MANAGE_VOLUME_NAME from the [!INCLUDE[ssNoVersion](../../a9notintoc/includes/ssnoversion-md.md)] service account.  
