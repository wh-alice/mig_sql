...
---
# Prepare SQL Event Class
  The Prepare SQL event class indicates that SqlClient, ODBC, OLE DB, or DB-Library has prepared a [!INCLUDE[tsql](../../a9notintoc/includes/tsql-md.md)] statement or statements for use.  
...
|Handle|**int**|Handle of the prepared [!INCLUDE[tsql](../../a9notintoc/includes/tsql-md.md)] statement.|33|Yes|  
