...
|**software_major_version**|**tinyint**|[!INCLUDE[msCoName](../../../a9notintoc/includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../../a9notintoc/includes/ssnoversion-md.md)] major version number. Can be NULL.|  
|**software_minor_version**|**tinyint**|[!INCLUDE[ssNoVersion](../../../a9notintoc/includes/ssnoversion-md.md)] minor version number. Can be NULL.|  
|**software_build_version**|**smallint**|[!INCLUDE[ssNoVersion](../../../a9notintoc/includes/ssnoversion-md.md)] build number. Can be NULL.|  
...
|**mtf_minor_version**|**tinyint**|[!INCLUDE[msCoName](../../../a9notintoc/includes/msconame-md.md)] Tape Format minor version number. Can be NULL.|  
...
|**compatibility_level**|**tinyint**|Compatibility level setting for the database. Can be:<br /><br /> 90 = [!INCLUDE[ssVersion2005](../../../a9notintoc/includes/ssversion2005-md.md)]<br /><br /> 100 = [!INCLUDE[ssKatmai](../../../a9notintoc/includes/sskatmai-md.md)]<br /><br /> 110 = [!INCLUDE[ssSQL11](../../../a9notintoc/includes/sssql11-md.md)]<br /><br /> 120 = [!INCLUDE[ssSQL14](../../../a9notintoc/includes/sssql14-md.md)]<br /><br /> Can be NULL.<br /><br /> For more information about compatibility levels, see [ALTER DATABASE Compatibility Level &#40;Transact-SQL&#41;](../../../t-sql/statements/alter-database-transact-sql-compatibility-level.md).|  
...
|**server_name**|**nvarchar(128)**|Name of the server running the [!INCLUDE[ssNoVersion](../../../a9notintoc/includes/ssnoversion-md.md)] backup operation. Can be NULL.|  
|**machine_name**|**nvarchar(128)**|Name of the computer running [!INCLUDE[ssNoVersion](../../../a9notintoc/includes/ssnoversion-md.md)]. Can be NULL.|  
