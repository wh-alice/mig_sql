...
## Next Steps  
You have successfully created Windows accounts for replication agents. Next, you will configure the snapshot folder. See [Lesson 2: Preparing the Snapshot Folder](../../../relational-databases/replication/tutorials/lesson-2-preparing-the-snapshot-folder.md).  
