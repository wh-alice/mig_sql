...
# Known Issues for SQL Server R Services
  This topic describes limitations and issues with [!INCLUDE[rsql_productname](../../a9notintoc/includes/rsql-productname-md.md)] and its related components in [!INCLUDE[ssCurrent](../../a9notintoc/includes/sscurrent-md.md)] and [!INCLUDE[ssSQLv14_md](../../advanced-analytics/r-services/includes/sssqlv14-md.md)].  
...
If you encounter resource limitations, check the current default, and if 20% is not enough, see the documentation for [!INCLUDE[ssNoVersion](../../a9notintoc/includes/ssnoversion-md.md)] on how to change this value.  

### Avoid clearing workspaces when executing R code in a [!INCLUDE[ssNoVersion](../../a9notintoc/includes/ssnoversion-md.md)] compute context  
...
As a workaround, avoid indiscriminate clearing of variables and other objects while running R in [!INCLUDE[ssNoVersion](../../a9notintoc/includes/ssnoversion-md.md)]. Although clearing the workspace is common when working in the R console,  it can have unintended consequences. 
...
-   Data from a [!INCLUDE[tsql](../../a9notintoc/includes/tsql-md.md)] query that references AlwaysEncrypted columns.  
  
-   Data from a [!INCLUDE[tsql](../../a9notintoc/includes/tsql-md.md)] query that references masked columns.  
...
> [!TIP]
> This standalone option is **not** required in order to use R with [!INCLUDE[tsql](../../a9notintoc/includes/tsql-md.md)].
> 
> If you need to set up a data science client computer capable of connecting to either [!INCLUDE[rsql_productname](../../a9notintoc/includes/rsql-productname-md.md)] or to the Microsoft R Server (Standalone), we recommend [Microsoft R Client](http://go.microsoft.com/fwlink/?LinkId=799768).  
...
### Possible string corruption  
 ...
 Any round-trip of string data from [!INCLUDE[tsql](../../a9notintoc/includes/tsql-md.md)] to R and then to [!INCLUDE[tsql](../../a9notintoc/includes/tsql-md.md)] again can result in corruption. This is due to the different encodings used in R and in [!INCLUDE[ssNoVersion](../../a9notintoc/includes/ssnoversion-md.md)], as well as the different collations and languages that are supported in R and [!INCLUDE[tsql](../../a9notintoc/includes/tsql-md.md)]. Any string in a non-ASCII encoding can potentially be handled incorrectly.  
...
### Only one raw value can be returned from sp_execute_external_script  
 ...
 One possible workaround if multiple output sets are desired is to do multiple calls of the stored procedure and send the result sets back to [!INCLUDE[ssNoVersion](../../a9notintoc/includes/ssnoversion-md.md)] using ODBC.  
...
### Loss of precision  
 ...
 [!INCLUDE[tsql](../../a9notintoc/includes/tsql-md.md)] and R support different data types; therefore, numeric data types can suffer loss of precision during conversion.  
...
## Revolution R Enterprise and Microsoft R Open 
 ...
 This section lists issues specific to R connectivity, development, and performance tools provided by Revolution Analytics. These tools were provided in earlier pre-release versions of  [!INCLUDE[ssCurrent](../../a9notintoc/includes/sscurrent-md.md)]. 
...
### Running side by side versions of Revolution R Enterprise  
 ...
 Installing Revolution R Enterprise  with side by side with any version of [!INCLUDE[rsql_productname_md](../../a9notintoc/includes/rsql-productname-md.md)] is not supported.  
...
### Limited support for RevoScaleR rxExec  
 ...
 As of RC0, the `rxExec` function provided by [!INCLUDE[rsql_rre-short](../../a9notintoc/includes/rsql-rre-short-md.md)] can be used only in single-threaded mode.  
