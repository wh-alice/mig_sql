...
[!INCLUDE[tsql-appliesto-xxxxxx-xxxx-xxxx-pdw_md](../../relational-databases/reference/system-catalog-views/includes/tsql-appliesto-xxxxxx-xxxx-xxxx-pdw-md.md)]
  ...
  Creates a new database on a [!INCLUDE[ssPDW](../../a9notintoc/includes/sspdw-md.md)] appliance. Use this statement to create all files associated with an appliance database and to set maximum size and auto-growth options for the database tables and transaction log.  
 ...
 *database_name*  
 ...
 If AUTOGROW is OFF, the sizes will not grow automatically. [!INCLUDE[ssPDW](../../a9notintoc/includes/sspdw-md.md)] will return an error when attempting an action that requires *replicated_size*, *distributed_size*, or *log_size* to grow beyond their specified value.  
...
## General Remarks  
 Databases are created with database compatibility level 120, which is the compatibility level for [!INCLUDE[ssSQL14](../../a9notintoc/includes/sssql14-md.md)]. This ensures the database will be able to use all of the [!INCLUDE[ssSQL14](../../a9notintoc/includes/sssql14-md.md)] functionality that PDW uses.  
...
-   [!INCLUDE[ssNoVersion](../../a9notintoc/includes/ssnoversion-md.md)] database with tables the size of *replicated_table_size*.  
  
-   [!INCLUDE[ssNoVersion](../../a9notintoc/includes/ssnoversion-md.md)] database with tables the size of (*distributed_table_size* / number of Compute nodes ).  
  
-   [!INCLUDE[ssNoVersion](../../a9notintoc/includes/ssnoversion-md.md)] logs the size of (*log_size* / number of Compute nodes).  
