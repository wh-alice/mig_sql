...
|filestream_data_space_id|**int**|Data space ID for a FILESTREAM filegroup or [!INCLUDE[ssInfoNA](../../../relational-databases/reference/system-catalog-views/includes/ssinfona-md.md)]|NULL|  
...
|pdw_node_id|**int**|Unique identifier of a [!INCLUDE[ssSDW](../../../database-engine/configure/windows/includes/sssdw-md.md)] node.|NOT NULL|  
