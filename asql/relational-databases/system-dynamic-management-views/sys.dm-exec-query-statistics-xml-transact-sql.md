...
## Remarks
This system function is available starting with [!INCLUDE[ssSQL15](../../analysis-services/powershell/includes/sssql15-md.md)] SP1.
...
**Lightweight** statistics profiling infrastructure is available in [!INCLUDE[ssSQL14](../../analysis-services/includes/sssql14-md.md)] SP2 and [!INCLUDE[ssSQL15](../../analysis-services/powershell/includes/sssql15-md.md)] and can be enabled:
