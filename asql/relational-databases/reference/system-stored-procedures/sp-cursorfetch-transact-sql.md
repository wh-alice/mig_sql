...
## Arguments  
 *cursor*  
 Is a *handle* value generated by [!INCLUDE[ssNoVersion](../../../a9notintoc/includes/ssnoversion-md.md)] and returned by sp_cursoropen. *cursor* is a required parameter that calls for an **int** input value. For more information, see the Remarks section later in this topic.  
