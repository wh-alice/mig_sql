...
## Arguments  
 *prepared handle*  
 Is a [!INCLUDE[ssNoVersion](../../../advanced-analytics/r-services/includes/ssnoversion-md.md)] generated prepared *handle* identifier. *prepared handle* is required and returns **int**.  
  
 *cursor*  
 Is the [!INCLUDE[ssNoVersion](../../../advanced-analytics/r-services/includes/ssnoversion-md.md)] generated cursor identifier. *cursor* is a required parameter that must be supplied on all subsequent procedures which act upon this cursor, e.g. sp_cursorfetch.  
...
|0x100000|FAST_FORWARD_ACCEPTABLE|  
 ...
 Because of the possibility that the requested option is not appropriate for the cursor defined by *\<stmt>*, this parameter serves as both input and output. In such cases, [!INCLUDE[ssNoVersion](../../../advanced-analytics/r-services/includes/ssnoversion-md.md)] assigns an appropriate type and modifies this value.  
...
|0x80000|OPTIMISITC_ACCEPTABLE|  
 ...
 As with *scrollpt*, [!INCLUDE[ssNoVersion](../../../advanced-analytics/r-services/includes/ssnoversion-md.md)] can assign a different value than the one requested.  
...
## See Also  
 ...
 [sp_cursorprepare &#40;Transact-SQL&#41;](../../../relational-databases/reference/system-stored-procedures/sp-cursorprepare-transact-sql.md)   
