...
[!INCLUDE[tsql-appliesto-ss2008-xxxx-xxxx-xxx_md](../../../a9retired/includes/tsql-appliesto-ss2008-xxxx-xxxx-xxx-md.md)]
  ...
  Returns information for the steps in a job used by [!INCLUDE[ssNoVersion](../../../a9notintoc/includes/ssnoversion-md.md)] Agent service to perform automated activities.  
...
|**database_name**|**sysname**|For a [!INCLUDE[tsql](../../../a9notintoc/includes/tsql-md.md)] step, this is the database in which the command executes.|  
...
|**output_file_name**|**nvarchar(200)**|File to which command output should be written ([!INCLUDE[tsql](../../../a9notintoc/includes/tsql-md.md)], **CmdExec**, and **PowerShell** steps only).|  
