...
|end_lsn|**binary(10)**|LSN representing the high endpoint for querying the change table. In [!INCLUDE[ssSQL11](../../../analysis-services/includes/sssql11-md.md)], this column is always NULL.|  
|supports_net_changes|**bit**|Net change support is enabled.|  
|has_drop_pending|**bit**|Not used in [!INCLUDE[ssSQL11](../../../analysis-services/includes/sssql11-md.md)].|  
