...
Returns [USE HINT](Query%20Hints%20\(Transact-SQL\).md) supported hint names. It lists one hint name per row.  
...
See [Query Hints](Query%20Hints%20\(Transact-SQL\).md) for descriptions of each hint.
