...
8.  Copy the [!INCLUDE[tsql](../a9notintoc/includes/tsql-md.md)] test script into a file and save it as `test.sql` in the sample directory.  
...
```  
 ...
 This is the [!INCLUDE[tsql](../a9notintoc/includes/tsql-md.md)] installation script (`Install.sql`), which deploys the assembly and creates the stored procedures.  
...
```  
 ...
 This is the [!INCLUDE[tsql](../a9notintoc/includes/tsql-md.md)] test script (`test.sql`), which tests the sample.  
