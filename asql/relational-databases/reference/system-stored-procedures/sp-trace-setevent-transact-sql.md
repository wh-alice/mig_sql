...
|41|SQL:StmtCompleted|Occurs when the [!INCLUDE[tsql](../../../a9notintoc/includes/tsql-md.md)] statement has completed.|  
...
|5|**LineNumber**|Contains the number of the line that contains the error. For events that involve [!INCLUDE[tsql](../../../a9notintoc/includes/tsql-md.md)] statements, like **SP:StmtStarting**, the **LineNumber** contains the line number of the statement in the stored procedure or batch.|  
|6|**NTUserName**|[!INCLUDE[msCoName](../../../a9notintoc/includes/msconame-md.md)] Windows user name.|  
...
|10|**ApplicationName**|Name of the client application that created the connection to an instance of [!INCLUDE[ssNoVersion](../../../a9notintoc/includes/ssnoversion-md.md)]. This column is populated with the values passed by the application rather than the displayed name of the program.|  
|11|**LoginName**|[!INCLUDE[ssNoVersion](../../../a9notintoc/includes/ssnoversion-md.md)] login name of the client.|  
|12|**SPID**|Server Process ID assigned by [!INCLUDE[ssNoVersion](../../../a9notintoc/includes/ssnoversion-md.md)] to the process associated with the client.|  
...
|26|**ServerName**|Name of the instance of [!INCLUDE[ssNoVersion](../../../a9notintoc/includes/ssnoversion-md.md)], either *servername* or *servername\instancename*, being traced.|  
