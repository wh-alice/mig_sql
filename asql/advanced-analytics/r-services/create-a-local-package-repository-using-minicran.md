...
2. Download or install the packages you need to this  computer. This will create the folder structure that you need to copy the packages to the [!INCLUDE[ssNoVersion_md](../../a9notintoc/includes/ssnoversion-md.md)] later.
...
3. Copy the miniCRAN repository to the R_SERVICES library on the [!INCLUDE[ssNoVersion_md](../../a9notintoc/includes/ssnoversion-md.md)] instance.

## Step 2. Install the packages on the SQL Server computer 

4. On the [!INCLUDE[ssNoVersion_md](../../a9notintoc/includes/ssnoversion-md.md)] computer, run the R command  `install.packages()`. You can use one of the R tools that are installed with [!INCLUDE[rsql_productname_md](../../a9notintoc/includes/rsql-productname-md.md)], such as Rgui.exe, or you can run the command as part of a [!INCLUDE[tsql_md](../../a9notintoc/includes/tsql-md.md)] stored procedure.
