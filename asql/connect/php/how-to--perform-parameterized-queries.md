...
4.  Execute the query:  
    ...
    -   If you are using the SQLSRV driver, use [sqlsrv_query](../../connect/php/sqlsrv_query.md) or [sqlsrv_prepare](../../connect/php/sqlsrv_prepare.md)/[sqlsrv_execute](../../connect/php/sqlsrv_execute.md).  
...
[sqlsrv_rows_affected](../../connect/php/sqlsrv_rows_affected.md)  
