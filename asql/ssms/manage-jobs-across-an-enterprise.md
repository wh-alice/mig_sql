...
-   [SQL Server Management Studio](../ssms/modify-the-target-servers-for-a-job.md)  
...
-   [SQL Server Management Studio](../ssms/specify-a-target-server-s-location--sql-server-management-studio-.md)  
...
-   [SQL Server Management Studio](../ssms/synchronize-target-server-clocks--sql-server-management-studio-.md)  
...
-   [SQL Server Management Studio](../ssms/force-a-target-server-to-poll-the-master-server.md)  
