...
## Examples  
 ...
 The following example is based on the `[Association]` mining structure and mining model that you created in the [Basic Data Mining Tutorial](http://msdn.microsoft.com/en-US/library/ms167167(SQL.130).aspx). The query returns only those cases where the customer purchased at least one patch kit.  
