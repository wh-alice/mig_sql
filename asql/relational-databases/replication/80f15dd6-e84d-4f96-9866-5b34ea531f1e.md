...
> [!NOTE]  
>  Beginning with [!INCLUDE[firstref_longhorn](../../database-engine/install/windows/includes/firstref-longhorn-md.md)] and [!INCLUDE[wiprlhlong](../../a9retired/includes/wiprlhlong-md.md)], 64-bit versions of the Windows Synchronization Manager cannot detect 32-bit subscriptions.  
...
2.  In the **Items to Synchronize** dialog box, select the subscriptions to synchronize. Subscriptions are listed under the [!INCLUDE[ssNoVersion](../../a9notintoc/includes/ssnoversion-md.md)] instances installed on the computer.  
