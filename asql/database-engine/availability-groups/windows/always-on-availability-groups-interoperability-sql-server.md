...
[!INCLUDE[tsql-appliesto-ss2016-xxxx-xxxx-xxx_md](../../../a9notintoc/includes/tsql-appliesto-ss2016-xxxx-xxxx-xxx-md.md)]
  ...
  This topic documents interoperability of [!INCLUDE[ssHADR](../../../a9notintoc/includes/sshadr-md.md)] with other [!INCLUDE[ssNoVersion](../../../a9notintoc/includes/ssnoversion-md.md)] features in [!INCLUDE[ssCurrent](../../../a9notintoc/includes/sscurrent-md.md)].  
...
##  <a name="restrictions"></a> Features that Interoperate with Always On Availability Groups with Restrictions  
 The following features interoperate with [!INCLUDE[ssHADR](../../../a9notintoc/includes/sshadr-md.md)] with specific restrictions. See the linked topics for details.  
  
-   Cross-database transactions/distributed transactions ([!INCLUDE[ssSQL15](../../../a9notintoc/includes/sssql15-md.md)] and Windows Server 2016 Technical Preview 2). For more information, see [Cross-Database Transactions and Distributed Transactions for Always On Availability Groups and Database Mirroring &#40;SQL Server&#41;](../../../database-engine/availability-groups/windows/transactions-always-on-availability-and-database-mirroring.md)  
  
##  <a name="NoInterop"></a> Features that Do Not Interoperate with Always On Availability Groups  
 [!INCLUDE[ssHADR](../../../a9notintoc/includes/sshadr-md.md)] does not interoperate with the following features:  
