...
# Calling Natively Compiled Stored Procedures from Data Access Applications
 ...
 Versions of [!INCLUDE[ssNoVersion](../../a9notintoc/includes/ssnoversion-md.md)] Native Client prior to [!INCLUDE[ssSQL11](../../a9notintoc/includes/sssql11-md.md)] do not support retrieving schema-only information (metadata discovery) about the result sets returned by a natively compiled stored procedure. Instead, use [sp_describe_first_result_set &#40;Transact-SQL&#41;](../../relational-databases/reference/system-stored-procedures/sp-describe-first-result-set-transact-sql.md).  
  
 The following recommendations apply to calls of natively compiled stored procedure using the ODBC driver in [!INCLUDE[ssNoVersion](../../a9notintoc/includes/ssnoversion-md.md)] Native Client.  
  
 The most efficient way to call a stored procedure once is to issue a direct RPC call using **SQLExecDirect** and ODBC CALL clauses. Do not use the [!INCLUDE[tsql](../../a9notintoc/includes/tsql-md.md)]**EXECUTE** statement. If a stored procedure is called more than once, prepared execution is more efficient.  
  
 The most efficient way to call a [!INCLUDE[ssNoVersion](../../a9notintoc/includes/ssnoversion-md.md)] stored procedure more than once is through prepared RPC procedure calls. Prepared RPC calls are performed as follows using the ODBC driver in [!INCLUDE[ssNoVersion](../../a9notintoc/includes/ssnoversion-md.md)] Native Client:  
...
2.  Create an ODBC data source called PrepExecSample that points to the database. Use the [!INCLUDE[ssNoVersion](../../a9notintoc/includes/ssnoversion-md.md)] Native Client driver. You could also modify the sample and use the [Microsoft ODBC Driver for SQL Server](http://msdn.microsoft.com/library/jj730314.aspx).  
  
3.  Run the [!INCLUDE[tsql](../../a9notintoc/includes/tsql-md.md)] script (below) on the sample database.  
...
5.  Verify successful execution of the program by querying the contents of the tables:  
 ...
 The following is the [!INCLUDE[tsql](../../a9notintoc/includes/tsql-md.md)] code listing that creates the memory-optimized database objects.  
