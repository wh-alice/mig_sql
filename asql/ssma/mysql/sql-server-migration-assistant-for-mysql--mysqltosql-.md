...
MicrosoftSQL Server Migration Assistant (SSMA) for MySQL is a tool for migrating MySQL databases to MicrosoftSQL Server 2005 / MicrosoftSQL Server 2008 / MicrosoftSQL Server 2012 / MicrosoftSQL Server 2014 / MicrosoftSQL Server 2016 / Azure Microsoft DB. SSMA for MySQL converts MySQL database objects to SQL Server database objects, creates these objects in SQL Server, and then migrates data from MySQL to SQL Server.  
