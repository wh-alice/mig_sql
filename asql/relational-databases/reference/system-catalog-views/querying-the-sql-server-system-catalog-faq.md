...
###  <a name="_FAQ26"></a> How do I find the views, Transact-SQL functions, and Transact-SQL stored procedures that depend on a specified CLR user-defined type or alias type?  
 ...
 The following query returns all schema-bound dependencies in views, [!INCLUDE[tsql](../../../a9notintoc/includes/tsql-md.md)] functions, and [!INCLUDE[tsql](../../../a9notintoc/includes/tsql-md.md)] stored procedures for a specified CLR user-defined type or alias type.  
