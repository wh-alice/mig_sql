...
# Delete a Policy-Based Management Policy
  This topic describes how to delete a Policy-Based Management policy in [!INCLUDE[ssCurrent](../../a9notintoc/includes/sscurrent-md.md)] by using [!INCLUDE[ssManStudioFull](../../a9notintoc/includes/ssmanstudiofull-md.md)].  
