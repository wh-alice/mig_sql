...
|[Memory-Optimized Table Variables](http://msdn.microsoft.com/en-US/library/dn535766(SQL.130).aspx)|Code example showing how to use a memory-optimized table variable instead of a traditional table variable to reduce tempdb use.|  
|[Indexes on Memory-Optimized Tables](http://msdn.microsoft.com/en-US/library/dn511012(SQL.130).aspx)|Introduces memory-optimized indexes.|  
...
|[Managing Memory for In-Memory OLTP](http://msdn.microsoft.com/en-US/library/dn465872(SQL.130).aspx)|Understanding and managing memory usage on your system.|  
...
|[Backup, Restore, and Recovery of Memory-Optimized Tables](http://msdn.microsoft.com/en-US/library/dn624160(SQL.130).aspx)|Discusses backup, restore, and recovery for memory-optimized tables.|  
