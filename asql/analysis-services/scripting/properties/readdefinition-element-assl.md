...
|*Allowed*|Full access to the object definition is allowed.<br /><br /> Note: This permission is required for executing a [Discover](../Topic/Discover%20Method%20\(XMLA\).md) XML for Analysis (XMLA) call using the DISCOVER_XML_METADATA parameter.|  
