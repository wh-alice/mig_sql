...
-   **Task input**. The Data Profiling task reads its input from [!INCLUDE[ssNoVersion](../../a9notintoc/includes/ssnoversion-md.md)] tables. Therefore, you have to save data that is in memory to staging tables if you want to profile data that has already been loaded and transformed in the data flow.  
...
-   An [!INCLUDE[vstecado](../../a9retired/includes/vstecado-md.md)] connection manager that connects to the [!INCLUDE[ssSampleDBnormal](../../a9notintoc/includes/sssampledbnormal-md.md)] database.  
...
1.  In [!INCLUDE[ssBIDevStudioFull](../../a9notintoc/includes/ssbidevstudiofull-md.md)], create a new [!INCLUDE[ssISnoversion](../../a9notintoc/includes/ssisnoversion-md.md)] package.  
  
2.  Add an [!INCLUDE[vstecado](../../a9retired/includes/vstecado-md.md)] connection manager to the package. Configure this connection manager to use the NET Data Provider for [!INCLUDE[ssNoVersion](../../a9notintoc/includes/ssnoversion-md.md)] (SqlClient) and to connect to an available instance of the [!INCLUDE[ssSampleDBnormal](../../a9notintoc/includes/sssampledbnormal-md.md)] database.  
...
-   To use the data that the [!INCLUDE[vstecado](../../a9retired/includes/vstecado-md.md)] connection manager supplies as input.  
...
5.  In the **Request properties** pane, for **ConnectionManager**, select the [!INCLUDE[vstecado](../../a9retired/includes/vstecado-md.md)] connection manager that you have previously configured. Then, for **TableOrView**, select Person.Address.  
...
1.  In [!INCLUDE[ssBIDevStudioFull](../../a9notintoc/includes/ssbidevstudiofull-md.md)], create a package.  
