...
##  <a name="Tasks"></a> Tasks  
 [!INCLUDE[ssISnoversion](../../a9notintoc/includes/ssisnoversion-md.md)] includes numerous tasks with properties that can be set by property expressions.  
...
##  <a name="MaintenancePlanTasks"></a> Maintenance Plan Tasks  
 [!INCLUDE[ssISnoversion](../../a9notintoc/includes/ssisnoversion-md.md)] includes a set of tasks that perform SQL Server tasks for use in maintenance plans and [!INCLUDE[ssISnoversion](../../a9notintoc/includes/ssisnoversion-md.md)] packages.  
  
 [!INCLUDE[ssNoVersion](../../a9notintoc/includes/ssnoversion-md.md)] does not support working with these tasks programmatically and programming reference documentation does not include API documentation of these tasks and their enumerators.  
 ...
 **BackupDevice** property—Set by using values from the [!INCLUDE[ssNoVersion](../../a9notintoc/includes/ssnoversion-md.md)] Management Objects (SMO) **DeviceType** enumeration.  
 ...
 **UpdateType** property—Set by using values from the [!INCLUDE[ssNoVersion](../../a9notintoc/includes/ssnoversion-md.md)] Management Objects (SMO) **StatisticsTarget** enumeration.  
