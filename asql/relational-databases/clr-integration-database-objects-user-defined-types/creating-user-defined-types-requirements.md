...
## Requirements for Implementing UDTs  
 To run in [!INCLUDE[ssNoVersion](../../a9notintoc/includes/ssnoversion-md.md)], your UDT must implement the following requirements in the UDT definition:  
...
-   Public names cannot be longer than 128 characters, and must conform to the [!INCLUDE[ssNoVersion](../../a9notintoc/includes/ssnoversion-md.md)] naming rules for identifiers as defined in [Database Identifiers](../../relational-databases/databases/database-identifiers.md).  
  
-   **sql_variant** columns cannot contain instances of a UDT.  
  
-   Inherited members are not accessible from [!INCLUDE[tsql](../../a9notintoc/includes/tsql-md.md)] because the [!INCLUDE[ssNoVersion](../../a9notintoc/includes/ssnoversion-md.md)] type system is not aware of the inheritance hierarchy among UDTs. However, you can use inheritance when you structure your classes and you can call such methods in the managed code implementation of the type.  
 ...
 **IsByteOrdered**  
 A **Boolean** value that determines how [!INCLUDE[ssNoVersion](../../a9notintoc/includes/ssnoversion-md.md)] performs binary comparisons on the UDT.  
...
-   The ability to use [!INCLUDE[tsql](../../a9notintoc/includes/tsql-md.md)] ORDER BY, GROUP BY, and PARTITION BY clauses. In these cases, the binary representation of the type is used to determine the order.  
  
-   The ability to use comparison operators in [!INCLUDE[tsql](../../a9notintoc/includes/tsql-md.md)] statements.  
...
-   Use UDTs in parameterized queries and Web methods with Native XML Web Services in [!INCLUDE[ssNoVersion](../../a9notintoc/includes/ssnoversion-md.md)].  
