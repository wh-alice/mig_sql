...
[!INCLUDE[tsql-appliesto-ss2008-xxxx-xxxx-xxx_md](../../../a9retired/includes/tsql-appliesto-ss2008-xxxx-xxxx-xxx-md.md)]
  ...
  Contains one row for each system error or warning that can be returned by the [!INCLUDE[ssDEnoversion](../../../a9notintoc/includes/ssdenoversion-md.md)]. The [!INCLUDE[ssDE](../../../a9notintoc/includes/ssde-md.md)] displays the error description on the user's screen.  
