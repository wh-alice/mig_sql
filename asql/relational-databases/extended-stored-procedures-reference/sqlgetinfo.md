...
|SQL_ACTIVE_CONNECTIONS|The number of connections is limited by [!INCLUDE[ssNoVersion](../../a9notintoc/includes/ssnoversion-md.md)]. The driver returns 0 for this **SQLGetInfo** request.|  
...
|SQL_CONVERT_DOUBLE|No support for conversion of ODBC SQL_DOUBLE data type. The [!INCLUDE[ssNoVersion](../../a9notintoc/includes/ssnoversion-md.md)] Native Client ODBC driver supports the ODBC SQL_DOUBLE data type as SQL_FLOAT. See SQL_CONVERT_FLOAT below.|  
...
|SQL_DBMS_NAME|"Microsoft [!INCLUDE[ssNoVersion](../../a9notintoc/includes/ssnoversion-md.md)]"|  
|SQL_DBMS_VER|The version number of the connected instance of [!INCLUDE[ssNoVersion](../../a9notintoc/includes/ssnoversion-md.md)].|  
...
|SQL_SPECIAL_CHARACTERS|Depends on [!INCLUDE[ssNoVersion](../../a9notintoc/includes/ssnoversion-md.md)]-installed character set.|  
