...
# Unable to refresh data for a data connection in the workbook
  For Excel workbooks that contain [!INCLUDE[ssGemini](../../a9notintoc/includes/ssgemini-md.md)] data, Excel Services returns this error if it submits a connection request to a [!INCLUDE[ssGemini](../../a9notintoc/includes/ssgemini-md.md)] server and the request fails.  
  
## Details  
  
|||  
|-|-|  
|Applies to:|[!INCLUDE[ssGemini](../../a9notintoc/includes/ssgemini-md.md)] for SharePoint installation|  
...
|Cause|See below.|  
|Message Text|Unable to refresh data for a data connection in the workbook. Try again or contact your system administrator. The following connections failed to refresh: [!INCLUDE[ssGemini](../../a9notintoc/includes/ssgemini-md.md)] Data|  
  
## Explanation and Resolution  
 Excel Services cannot connect to or load the [!INCLUDE[ssGemini](../../a9notintoc/includes/ssgemini-md.md)] data. Conditions that cause this error to occur include the following:  
 ...
 **Scenario 2a: Opening an earlier version workbook n the server**  
 ...
 If this is the case, you will find this message in the ULS log: “Refresh failed for ‘[!INCLUDE[ssGemini](../../a9notintoc/includes/ssgemini-md.md)]t Data’ in the workbook ‘\<URL to workbook>’”, followed by “Unable to get a connection”.  
