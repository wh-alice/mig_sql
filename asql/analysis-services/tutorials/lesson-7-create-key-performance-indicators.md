...
## Prerequisites  
This topic is part of a tabular modeling tutorial, which should be completed in order. Before performing the tasks in this lesson, you should have completed the previous lesson: [Lesson 6: Create Measures](../../analysis-services/tutorials/lesson-6-create-measures.md).  
...
## Next Step  
To continue this tutorial, go to the next lesson: [Lesson 8: Create Perspectives](../../analysis-services/tutorials/lesson-8-create-perspectives.md).  
