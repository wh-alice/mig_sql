...
## Plan Guide Matching Requirements  
 ...
 When [!INCLUDE[ssNoVersion](../../../a9notintoc/includes/ssnoversion-md.md)] matches the value of *statement_text* to *batch_text* and *@parameter_name data_type* [,*...n* ], or if @type = **'**OBJECT', to the text of the corresponding query inside *object_name*, the following string elements are not considered:  
...
-   Trailing semicolons  
 ...
 For example, [!INCLUDE[ssNoVersion](../../../a9notintoc/includes/ssnoversion-md.md)] can match the *statement_text* string `N'SELECT * FROM T WHERE a = 10'` to the following *batch_text*:  
