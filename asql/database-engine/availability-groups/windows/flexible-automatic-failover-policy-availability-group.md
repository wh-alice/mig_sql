...
|Level|Failure Condition|[!INCLUDE[tsql](../../../a9notintoc/includes/tsql-md.md)] Value|PowerShell Value|  
|-----------|-----------------------|------------------------------|----------------------|  
...
> [!NOTE]  
>  Lack of response by an instance of [!INCLUDE[ssNoVersion](../../../a9notintoc/includes/ssnoversion-md.md)] to client requests is irrelevant to availability groups.  
