...
manager: "erikre"
---
# Integrating Reporting Services Using ReportViewer Controls - WebForms ReportViewer
...
1.  Create a new [!INCLUDE[msCoName](../../advanced-analytics/r-services/tutorials/includes/msconame-md.md)] ASP.NET Web Site using either [!INCLUDE[msCoName](../../advanced-analytics/r-services/tutorials/includes/msconame-md.md)] [!INCLUDE[csprcs](../../integration-services/includes/csprcs-md.md)] or [!INCLUDE[msCoName](../../advanced-analytics/r-services/tutorials/includes/msconame-md.md)] [!INCLUDE[vbprvb](../../analysis-services/data-mining/includes/vbprvb-md.md)].  
...
## Viewing Reports in Remote Processing Mode  
 The following example demonstrates how to render a report that has been deployed to a report server. This example uses the Sales Order Detail report that is included with the [!INCLUDE[ssSampleDBobject](../../database-engine/availability-groups/windows/includes/sssampledbobject-md.md)] sample reports project.  
...
## See Also  
 ...
 [Data collection in ReportViewer Control 2016](Data%20collection%20in%20ReportViewer%20Control%202016.md)
