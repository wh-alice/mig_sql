...
## Arguments  
 ...
 0 = [!INCLUDE[ssNoVersion](../../../a9notintoc/includes/ssnoversion-md.md)] Authentication. *monitor_server_security_mode* is **bit** and cannot be NULL.  
 ...
 [ **@backup_job_id=** ] *backup_job_id* OUTPUT  
 The [!INCLUDE[ssNoVersion](../../../a9notintoc/includes/ssnoversion-md.md)] Agent job ID associated with the backup job on the primary server. *backup_job_id* is **uniqueidentifier** and cannot be NULL.  
...
## Examples  
 This example adds the database [!INCLUDE[ssSampleDBobject](../../../a9retired/includes/sssampledbobject-md.md)] as the primary database in a log shipping configuration.  
