...
# Non-XML Format Files (SQL Server)
  In [!INCLUDE[ssCurrent](../../advanced-analytics/r-services/includes/sscurrent-md.md)], two types of format files are supported for bulk exporting and importing: *non-XML format files* and *XML format files*.  
...
|------------------------|-----------------|  
|Version|Version number of the **bcp** utility:<br /><br /> 9.0 = [!INCLUDE[ssVersion2005](../../analysis-services/data-mining/includes/ssversion2005-md.md)]<br /><br /> 10.0 = [!INCLUDE[ssKatmai](../../analysis-services/data-mining/includes/sskatmai-md.md)]<br /><br /> 11.0 = [!INCLUDE[ssSQL11](../../analysis-services/includes/sssql11-md.md)]<br /><br /> 12.0 = [!INCLUDE[ssSQL14](../../analysis-services/includes/sssql14-md.md)]<br /><br /> The version number is recognized only by **bcp**, not by [!INCLUDE[tsql](../../advanced-analytics/r-services/includes/tsql-md.md)].<br /><br /> <br /><br /> Note: The version of the **bcp** utility (Bcp.exe) used to read a format file must be the same as, or a later version than was used to create the format file. For example, [!INCLUDE[ssSQL11](../../analysis-services/includes/sssql11-md.md)]**bcp** can read a version 10.0 format file, which is generated by [!INCLUDE[ssKatmai](../../analysis-services/data-mining/includes/sskatmai-md.md)]**bcp**, but [!INCLUDE[ssKatmai](../../analysis-services/data-mining/includes/sskatmai-md.md)]**bcp** cannot read a version 12.0 format file, which is generated by [!INCLUDE[ssSQL14](../../analysis-services/includes/sssql14-md.md)]**bcp**.|  
...
|**Server column order**|Order in which columns appear in the [!INCLUDE[ssNoVersion](../../advanced-analytics/r-services/includes/ssnoversion-md.md)] table. For example, if the fourth field in the data file maps to the sixth column in a [!INCLUDE[ssNoVersion](../../advanced-analytics/r-services/includes/ssnoversion-md.md)] table, the server column order for the fourth field is 6.<br /><br /> To prevent a column in the table from receiving any data from the data file, set the server column order value to 0.|  
|**Server column name**|Name of the column copied from the [!INCLUDE[ssNoVersion](../../advanced-analytics/r-services/includes/ssnoversion-md.md)] table. The actual name of the field is not required, but the field in the format file must not be blank.|  
