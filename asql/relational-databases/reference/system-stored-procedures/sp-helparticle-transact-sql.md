...
> [!NOTE]  
>  *publisher* should not be specified when requesting information on an article published by a [!INCLUDE[ssNoVersion](../../../a9notintoc/includes/ssnoversion-md.md)] Publisher.  
