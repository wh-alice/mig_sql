...
|**4**|Go to step *fail_step_id**.*|  
 ...
 [ **@database_name =**] **'***database***'**  
 The name of the database in which to execute a [!INCLUDE[tsql](../../../a9notintoc/includes/tsql-md.md)] step. *database*is **sysname**. Names that are enclosed in brackets ([ ]) are not allowed. The default value is NULL.  
  
 [ **@database_user_name =**] **'***user***'**  
 The name of the user account to use when executing a [!INCLUDE[tsql](../../../a9notintoc/includes/tsql-md.md)] step. *user*is **sysname**, with a default of NULL.  
 ...
 [ **@output_file_name =**] **'***file_name***'**  
 The name of the file in which the output of this step is saved. *file_name* is **nvarchar(200)**, with a default of NULL. This parameter is only valid with commands running in [!INCLUDE[tsql](../../../a9notintoc/includes/tsql-md.md)] or CmdExec subsystems.  
