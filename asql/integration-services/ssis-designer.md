...
---
# SSIS Designer
  [!INCLUDE[ssIS](../a9retired/includes/ssis-md.md)] Designer is a graphical tool that you can use to create and maintain [!INCLUDE[ssISnoversion](../a9notintoc/includes/ssisnoversion-md.md)] packages. [!INCLUDE[ssIS](../a9retired/includes/ssis-md.md)] Designer is available in [!INCLUDE[ssBIDevStudioFull](../a9notintoc/includes/ssbidevstudiofull-md.md)] as part of an [!INCLUDE[ssISnoversion](../a9notintoc/includes/ssisnoversion-md.md)] project.  
  
 You can use [!INCLUDE[ssIS](../a9retired/includes/ssis-md.md)] Designer to perform the following tasks:  
...
-   At run time, viewing the execution progress of the package.  
 ...
 The following diagram shows [!INCLUDE[ssIS](../a9retired/includes/ssis-md.md)] Designer and the **Toolbox** window.  
 ...
 [!INCLUDE[ssIS](../a9retired/includes/ssis-md.md)] Designer has no dependency on the [!INCLUDE[ssISnoversion](../a9notintoc/includes/ssisnoversion-md.md)] service, the service that manages and monitors packages, and it is not required that the service be running to create or modify packages in [!INCLUDE[ssIS](../a9retired/includes/ssis-md.md)] Designer. However, if you stop the service while [!INCLUDE[ssIS](../a9retired/includes/ssis-md.md)] Designer is open, you can no longer open the dialog boxes that [!INCLUDE[ssIS](../a9retired/includes/ssis-md.md)] Designer provides and you may receive the error message "RPC server is unavailable." To reset [!INCLUDE[ssIS](../a9retired/includes/ssis-md.md)] Designer and continue working with the package, you must close the designer, exit [!INCLUDE[ssBIDevStudioFull](../a9notintoc/includes/ssbidevstudiofull-md.md)], and then reopen [!INCLUDE[ssBIDevStudioFull](../a9notintoc/includes/ssbidevstudiofull-md.md)], the [!INCLUDE[ssISnoversion](../a9notintoc/includes/ssisnoversion-md.md)] project, and the package.  
  
## Undo and Redo  
 You can undo and redo up to 20 actions in the [!INCLUDE[ssIS](../a9retired/includes/ssis-md.md)] Designer. For a package, undo /redo is available in the **Control Flow**, **Data Flow**, **Event Handlers**, and **Parameters** tabs, and in the **Variables** window. For a project, undo/redo is available in the **Project Parameters** window.  
...
### Event Handlers Tab  
 ...
 For more information, see [Add an Event Handler to a Package](../a9retired/add-an-event-handler-to-a-package.md).  
...
#### Connection Managers Area  
 You add and modify the connection managers that a package uses in the **Connection Managers** area. [!INCLUDE[ssISnoversion](../a9notintoc/includes/ssisnoversion-md.md)] includes connection managers to connect to a variety of data sources, such as text files, OLE DB databases, and .NET providers.  
  
 For more information, see [Integration Services &#40;SSIS&#41; Connections](../integration-services/connection-manager/integration-services-ssis-connections.md) and [Create Connection Managers](../a9retired/create-connection-managers.md).  
...
Packages use connection managers to connect to data sources such as files, relational databases, and servers.  
 ...
 Use the **Connections Managers** area of [!INCLUDE[ssIS](../a9retired/includes/ssis-md.md)] Designer to add, delete, modify, rename, and copy and paste the connection managers.  
