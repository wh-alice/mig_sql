...
3.  In Query Editor, type and execute a [!INCLUDE[tsql](../../advanced-analytics/r-services/includes/tsql-md.md)] statement, such as the following:  
...
1.  In [!INCLUDE[ssManStudio](../../advanced-analytics/r-services/includes/ssmanstudio-md.md)], on the **Tools** menu, click **Options**.  
