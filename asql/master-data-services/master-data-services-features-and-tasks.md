...
# Master Data Services Features and Tasks
  Learn how to use [!INCLUDE[ssMDSshort](../analysis-services/includes/ssmdsshort-md.md)] to manage your organization’s master data. Learn how to create and manipulate model objects, which are containers for data. Learn how to organize and maintain the master data itself. Learn how to import and export master data, as well as share models between test and production environments. Finally, learn how to develop custom applications that access the [!INCLUDE[ssMDSshort](../analysis-services/includes/ssmdsshort-md.md)] web service.  
