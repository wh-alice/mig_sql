...
|**type**|**tinyint**|Type of Subscriber:<br /><br /> **0** = [!INCLUDE[msCoName](../../../a9notintoc/includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../../a9notintoc/includes/ssnoversion-md.md)] database **1** = ODBC data source|  
|**login**|**sysname**|Login ID for [!INCLUDE[ssNoVersion](../../../a9notintoc/includes/ssnoversion-md.md)] Authentication.|  
|**password**|**sysname**|Password for [!INCLUDE[ssNoVersion](../../../a9notintoc/includes/ssnoversion-md.md)] Authentication.|  
...
|**security_mode**|**int**|Implemented security mode:<br /><br /> **0** = [!INCLUDE[ssNoVersion](../../../a9notintoc/includes/ssnoversion-md.md)] Authentication<br /><br /> **1** = [!INCLUDE[msCoName](../../../a9notintoc/includes/msconame-md.md)] Windows Authentication|  
