...
7.  Copy the [!INCLUDE[tsql](../a9notintoc/includes/tsql-md.md)] installation code into a file and save it as `Install.sql` in the sample directory.  
...
10. Copy [!INCLUDE[tsql](../a9notintoc/includes/tsql-md.md)] test command script into a file and save it as `test.sql` in the sample directory.  
  
11. Execute the test script with the following command  
  
    -   `sqlcmd -E -I -i test.sql`  
  
12. Copy the [!INCLUDE[tsql](../a9notintoc/includes/tsql-md.md)] cleanup script into a file and save it as `cleanup.sql` in the sample directory.  
...
```  
 ...
 This is the [!INCLUDE[tsql](../a9notintoc/includes/tsql-md.md)] installation script (`Install.sql`), which deploys the assembly and creates the UDT in the database.  
...
```  
 ...
 The following [!INCLUDE[tsql](../a9notintoc/includes/tsql-md.md)] removes the assembly and type from the database.  
