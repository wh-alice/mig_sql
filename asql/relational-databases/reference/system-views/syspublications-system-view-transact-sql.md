...
|**compress_snapshot**|**bit**|Specifies that the snapshot that is written to the *alt_snapshot_folder* location is to be compressed into the [!INCLUDE[msCoName](../../../a9notintoc/includes/msconame-md.md)] CAB format. **1** means that the snapshot will be compressed.|  
...
|**allow_dts**|**bit**|Specifies whether the publication allows [!INCLUDE[ssVersion2000](../../../a9notintoc/includes/ssversion2000-md.md)] Data Transformation Services (DTS) transformations. **1** specifies that DTS transformations are allowed.|  
...
|**backward_comp_level**|**int**|Database compatibility level, which can be one of the following values:<br /><br /> **90** = [!INCLUDE[ssVersion2005](../../../a9notintoc/includes/ssversion2005-md.md)].<br /><br /> **100** = [!INCLUDE[ssKatmai](../../../a9notintoc/includes/sskatmai-md.md)].|  
