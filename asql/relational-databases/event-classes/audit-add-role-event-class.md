...
# Audit Add Role Event Class
 ...
 This event class may be removed from a future version of [!INCLUDE[msCoName](../../a9notintoc/includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../a9notintoc/includes/ssnoversion-md.md)]. It is recommended that you use the **Audit Database Principal Management** event class instead.  
