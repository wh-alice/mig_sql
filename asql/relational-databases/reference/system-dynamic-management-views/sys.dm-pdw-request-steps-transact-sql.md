...
[!INCLUDE[tsql-appliesto-xxxxxx-xxxx-asdw-pdw_md](../../../a9retired/includes/tsql-appliesto-xxxxxx-xxxx-asdw-pdw-md.md)]
  ...
  Holds information about all steps that compose a given request or query in [!INCLUDE[ssSDW](../../../a9retired/includes/sssdw-md.md)]. It lists one row per query step.  
