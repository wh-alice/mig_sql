...
> [!NOTE]  
>  To call this from [!INCLUDE[ssSDWfull](../../../relational-databases/reference/system-catalog-views/includes/sssdwfull-md.md)] or [!INCLUDE[ssPDW](../../../database-engine/configure/windows/includes/sspdw-md.md)], use the name **sys.dm_pdw_nodes_exec_query_memory_grants**.  
...
|**sql_handle**|**varbinary(64)**|Identifier for [!INCLUDE[tsql](../../../advanced-analytics/r-services/includes/tsql-md.md)] text for this query. Use **sys.dm_exec_sql_text** to get the actual [!INCLUDE[tsql](../../../advanced-analytics/r-services/includes/tsql-md.md)] text.|  
...
-   Check overall system memory status using [sys.dm_os_memory_clerks](../../../relational-databases/reference/system-dynamic-management-views/sys.dm-os-memory-clerks-transact-sql.md), [sys.dm_os_sys_info](../../../relational-databases/reference/system-dynamic-management-views/sys.dm-os-sys-info-transact-sql.md), and various performance counters.  
...
-   Further examine memory-intensive queries using [sys.dm_exec_requests](../../../relational-databases/reference/system-dynamic-management-views/sys.dm-exec-requests-transact-sql.md).  
...
-   If a runaway query is suspected, examine the Showplan from [sys.dm_exec_query_plan](../../../relational-databases/reference/system-dynamic-management-views/sys.dm-exec-query-plan-transact-sql.md) and batch text from [sys.dm_exec_sql_text](../../../relational-databases/reference/system-dynamic-management-views/sys.dm-exec-sql-text-transact-sql.md).  
 ...
 The Resource Governor feature enables a database administrator to distribute server resources among resource pools, up to a maximum of 64 pools. Beginning with [!INCLUDE[ssKatmai](../../../analysis-services/data-mining/includes/sskatmai-md.md)], each pool behaves like a small independent server instance and requires 2 semaphores. The number of rows that are returned from **sys.dm_exec_query_resource_semaphores** can be up to 20 times more than the rows that are returned in [!INCLUDE[ssVersion2005](../../../analysis-services/data-mining/includes/ssversion2005-md.md)].  
  
## See Also  
 [sys.dm_exec_query_resource_semaphores &#40;Transact-SQL&#41;](../../../relational-databases/reference/system-dynamic-management-views/sys.dm-exec-query-resource-semaphores-transact-sql.md)   
