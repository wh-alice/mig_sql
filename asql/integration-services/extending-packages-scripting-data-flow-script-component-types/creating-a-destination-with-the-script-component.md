...
## Getting Started with a Destination Component  
 When you add a Script component to the Data Flow tab of [!INCLUDE[ssIS](../../a9retired/includes/ssis-md.md)] Designer, the **Select Script Component Type** dialog box opens and prompts you to select a **Source**, **Destination**, or **Transformation** script. In this dialog box, select **Destination**.  
  
 Next, connect the output of a transformation to the destination component in [!INCLUDE[ssIS](../../a9retired/includes/ssis-md.md)] Designer. For testing, you can connect a source directly to a destination without any transformations.  
...
## Scripting a Destination Component in Code-Design Mode  
 After you have configured the metadata for your component, you can write your custom script. In the **Script Transformation Editor**, on the **Script** page, click **Edit Script** to open the [!INCLUDE[msCoName](../../a9notintoc/includes/msconame-md.md)] [!INCLUDE[vsprvs](../../a9retired/includes/vsprvs-md.md)] Tools for Applications (VSTA) IDE where you can add your custom script. The scripting language that you use depends on whether you selected [!INCLUDE[msCoName](../../a9notintoc/includes/msconame-md.md)] Visual Basic or [!INCLUDE[msCoName](../../a9notintoc/includes/msconame-md.md)] Visual C# as the script language for the **ScriptLanguage** property on the **Script** page.  
...
### ADO.NET Destination Example  
 This example demonstrates a destination component that uses an existing [!INCLUDE[vstecado](../../a9retired/includes/vstecado-md.md)] connection manager to save data from the data flow into a [!INCLUDE[ssNoVersion](../../a9notintoc/includes/ssnoversion-md.md)] table.  
...
2.  Create a destination table by running the following [!INCLUDE[tsql](../../a9notintoc/includes/tsql-md.md)] command in the **AdventureWorks** database:  
...
7.  On the **Connection Managers** page, add or create the [!INCLUDE[vstecado](../../a9retired/includes/vstecado-md.md)] connection manager with a name such as **MyADONETConnectionManager**.  
...
3.  Connect the output of an upstream source or transformation to the destination component in [!INCLUDE[ssIS](../../a9retired/includes/ssis-md.md)] Designer. (You can connect a source directly to a destination without any transformations.) This output should provide data from the **Person.Address** table of the **AdventureWorks** sample database, and should contain at least the **AddressID** and **City** columns.  
