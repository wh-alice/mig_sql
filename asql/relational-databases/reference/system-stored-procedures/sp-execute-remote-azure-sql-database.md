...
## Remarks  
 ...
 `sp_execute_remote` can be used similar to [sp_executesql &#40;Transact-SQL&#41;](../../../relational-databases/reference/system-stored-procedures/sp-executesql-transact-sql.md).  
