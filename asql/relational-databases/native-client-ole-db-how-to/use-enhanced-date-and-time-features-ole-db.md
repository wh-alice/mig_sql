...
[!INCLUDE[SNAC_Deprecated](../../a9retired/includes/snac-deprecated.md)]
  ...
  This sample shows how to use the date/time features that were introduced in [!INCLUDE[ssKatmai](../../a9notintoc/includes/sskatmai-md.md)]. The sample uses the four new date and time types (**date**, **time**, **datetime2**, and **datetimeoffset**) to execute commands with parameters and retrieve rowset results.  
...
## Example  
 The first ([!INCLUDE[tsql](../../a9notintoc/includes/tsql-md.md)]) code listing creates a stored procedure used by the sample.  
 ...
 The third ([!INCLUDE[tsql](../../a9notintoc/includes/tsql-md.md)]) code listing deletes the stored procedure used by the sample.  
