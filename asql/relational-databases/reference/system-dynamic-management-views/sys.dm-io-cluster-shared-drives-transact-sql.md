...
> [!NOTE]  
>  To call this from [!INCLUDE[ssPDW](../../../a9notintoc/includes/sspdw-md.md)], use the name **sys.dm_pdw_nodes_io_cluster_shared_drives**.  
...
> [!NOTE]  
>  This view will be deprecated in a future release. We recommend that you use [sys.dm_io_cluster_valid_path_names &#40;Transact-SQL&#41;](../../../relational-databases/reference/system-dynamic-management-views/sys.dm-io-cluster-valid-path-names-transact-sql.md) instead.  
