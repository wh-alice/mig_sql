...
## Remarks  
 The permissions listed include the [!INCLUDE[tsql](../../../a9notintoc/includes/tsql-md.md)] statements that can be executed, and other special activities that can be performed by members of the fixed server role. To display a list of the fixed server roles, execute **sp_helpsrvrole**.  
