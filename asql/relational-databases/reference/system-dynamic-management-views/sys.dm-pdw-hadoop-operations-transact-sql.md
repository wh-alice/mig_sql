...
|operation_name|**nvarchar(4000)**|The job ID for a map-reduce job. This is returned by Hadoop after [!INCLUDE[ssSDW](../../../a9retired/includes/sssdw-md.md)] submits the job.||  
