...
6.  Provide a parameterized SQL command in one of the following ways:  
    ...
    |[!INCLUDE[vstecado](../a9retired/includes/vstecado-md.md)]|`SELECT* FROM Production.Product WHERE ProductId > @parmMinProductID AND ProductID < @parmMaxProductID`|  
     ...
     For examples of using parameters with stored procedures, see [Parameters and Return Codes in the Execute SQL Task](../a9retired/parameters-and-return-codes-in-the-execute-sql-task.md).  
...
## See Also  
 ...
 [Parameters and Return Codes in the Execute SQL Task](../a9retired/parameters-and-return-codes-in-the-execute-sql-task.md)   
