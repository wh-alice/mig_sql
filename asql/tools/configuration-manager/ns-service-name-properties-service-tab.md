...
# NS$&lt;service name&gt; Properties (Service Tab)
  This service is the [!INCLUDE[msCoName](../../a9notintoc/includes/msconame-md.md)] [!INCLUDE[ssNS](../../tools/configuration-manager/includes/ssns-md.md)] service. The property values in light gray cannot be changed using this application.  
