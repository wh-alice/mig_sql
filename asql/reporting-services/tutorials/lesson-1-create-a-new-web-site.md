...
## Next Task  
You’ve successfully created a new website project. Next, you will create a data connection and a data table for the parent report. See [Lesson 2: Define a Data Connection and Data Table for Parent Report](../../reporting-services/tutorials/lesson-2-define-a-data-connection-and-data-table-for-parent-report.md).