...
## Prerequisites  
This topic is part of a tabular modeling tutorial, which should be completed in order. Before performing the tasks in this lesson, you should have completed the previous lesson: [Lesson 10: Create Hierarchies](../../analysis-services/tutorials/lesson-10-create-hierarchies.md).  
...
## Next Steps  
To continue this tutorial, go to the next lesson: Lesson: [Lesson 12: Create Roles](../../analysis-services/tutorials/lesson-12-create-roles.md).  
