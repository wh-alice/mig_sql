...
### A. Using REPLICATE  
 The following example replicates a `0` character four times in front of a production line code in the [!INCLUDE[ssSampleDBnormal](../../a9notintoc/includes/sssampledbnormal-md.md)] database.  
