...
4.  In the **Open** dialog box, locate the SampleCurrencyData.txt file on your machine.  
    ...
    The sample data is included with the [!INCLUDE[ssIS](../../a9retired/includes/ssis-md.md)] lesson packages. To download the sample data and the lesson packages, do the following.  
