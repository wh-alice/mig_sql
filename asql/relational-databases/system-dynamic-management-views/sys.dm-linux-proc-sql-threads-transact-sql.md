...
This dmv is based off of the linux stat file for every thread under `/proc/self/task` (aka [!INCLUDE[ssNoVersion_md](../../advanced-analytics/r-services/includes/ssnoversion-md.md)]). It has one row per thread. 
