...
> [!NOTE]  
>  *publisher* should not be used for [!INCLUDE[ssNoVersion](../../../a9notintoc/includes/ssnoversion-md.md)] Publishers.  
...
## Example  
 [!code-sql[HowTo#sp_reinittranpushsub](../../../a9retired/codesnippet/tsql/sp-reinitsubscription-tr_1.sql)]  
