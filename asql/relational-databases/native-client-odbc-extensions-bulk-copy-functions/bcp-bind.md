...
[!INCLUDE[SNAC_Deprecated](../../a9retired/includes/snac-deprecated.md)]
  ...
  Binds data from a program variable to a table column for bulk copy into [!INCLUDE[ssNoVersion](../../a9notintoc/includes/ssnoversion-md.md)].  
 ...
 *eDataType*  
 ...
 [!INCLUDE[ssVersion2005](../../a9notintoc/includes/ssversion2005-md.md)] introduced support for SQLXML and SQLUDT data type tokens in the ***eDataType*** paramenter.  
...
## Remarks  
 Use **bcp_bind** for a fast, efficient way to copy data from a program variable into a table in [!INCLUDE[ssNoVersion](../../a9notintoc/includes/ssnoversion-md.md)].  
 ...
 Whenever you want [!INCLUDE[ssNoVersion](../../a9notintoc/includes/ssnoversion-md.md)] to commit the rows already received, call [bcp_batch](../../relational-databases/native-client-odbc-extensions-bulk-copy-functions/bcp-batch.md). For example, call **bcp_batch** once for every 1000 rows inserted or at any other interval.  
