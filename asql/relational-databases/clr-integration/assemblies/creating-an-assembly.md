 ...
 **UNSAFE** code permission is for those situations in which an assembly is not verifiably safe or requires additional access to restricted resources, such as the [!INCLUDE[msCoName](../../../a9notintoc/includes/msconame-md.md)] Win32 API.  
  
 To create an **EXTERNAL_ACCESS** or **UNSAFE** assembly in [!INCLUDE[ssNoVersion](../../../a9notintoc/includes/ssnoversion-md.md)], one of the following two conditions must be met:  
