...
> [!NOTE]  
>  Mirrored backup media sets are supported only in the Enterprise edition of [!INCLUDE[ssNoVersion](../../a9notintoc/includes/ssnoversion-md.md)].  
...
##  <a name="OverviewofMirroredMediaSets"></a> Overview of Mirrored Media Sets  
 ...
 The [!INCLUDE[ssDEnoversion](../../a9notintoc/includes/ssdenoversion-md.md)] guarantees that the mirrored media have identical contents by synchronizing writes to the devices. When any one of the mirrors fills, all the mirrors are spanned at one time.  
