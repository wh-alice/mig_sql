...
> [!IMPORTANT]  
>  Many of the error messages that you may see while working with [!INCLUDE[ssISnoversion](../advanced-analytics/r-services/includes/ssisnoversion-md.md)] come from other components. In this topic, you will find all the errors raised by [!INCLUDE[ssISnoversion](../advanced-analytics/r-services/includes/ssisnoversion-md.md)] components. If you do not see your error in the list, the error was raised by a component outside [!INCLUDE[ssISnoversion](../advanced-analytics/r-services/includes/ssisnoversion-md.md)]. These may include OLE DB providers, other database components such as the [!INCLUDE[ssDE](../analysis-services/instances/install/windows/includes/ssde-md.md)] and [!INCLUDE[ssASnoversion](../analysis-services/includes/ssasnoversion-md.md)] , or other services or components such as the file system, the SMTP server, Message Queuing (also known as MSMQ), and so forth. To find information about these external error messages, see the documentation specific to the component.  
...
##  <a name="msgError"></a> Error Messages  
 The symbolic names of [!INCLUDE[ssISnoversion](../advanced-analytics/r-services/includes/ssisnoversion-md.md)] error messages begin with **DTS_E_**.  
...
|0xC000F427|-1073679321|DTS_E_SSISSTANDALONENOTINSTALLED|To run a SSIS package outside of [!INCLUDE[ssBIDevStudioFull](../analysis-services/includes/ssbidevstudiofull-md.md)] you must install %1 of Integration Services or higher.|  
...
##  <a name="msgWarning"></a> Warning Messages  
 The symbolic names of [!INCLUDE[ssISnoversion](../advanced-analytics/r-services/includes/ssisnoversion-md.md)] warning messages begin with **DTS_W_**.  
...
##  <a name="msgInfo"></a> Informational Messages  
 The symbolic names of [!INCLUDE[ssISnoversion](../advanced-analytics/r-services/includes/ssisnoversion-md.md)] informational messages begin with **DTS_I_**.  
...
##  <a name="msgGeneral"></a> General and Event Messages  
 The symbolic names of [!INCLUDE[ssISnoversion](../advanced-analytics/r-services/includes/ssisnoversion-md.md)] error messages begin with **DTS_MSG_**.  
...
##  <a name="msgSuccess"></a> Success Messages  
 The symbolic names of [!INCLUDE[ssISnoversion](../advanced-analytics/r-services/includes/ssisnoversion-md.md)] success messages begin with **DTS_S_**.  
...
##  <a name="msgPipeline"></a> Data Flow Component Error Messages  
 The symbolic names of [!INCLUDE[ssISnoversion](../advanced-analytics/r-services/includes/ssisnoversion-md.md)] error messages begin with **DTSBC_E_**, where "BC" refers to the native base class from which most Microsoft data flow components are derived.  
