...
## Remarks  
 The [syspolicy_policy_execution_history_details](../../../relational-databases/reference/system-catalog-views/syspolicy-policy-execution-history-details-transact-sql.md) view contains related details about the targets of the policy and the condition expressions tested.  
