...
### Setting Algorithm Parameters  
 The [!INCLUDE[msCoName](../../a9notintoc/includes/msconame-md.md)] Naive Bayes algorithm supports several parameters that affect the performance and accuracy of the resulting mining model. The following table describes each parameter.  
