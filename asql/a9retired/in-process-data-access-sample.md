...
# In-Process Data Access Sample
  The `InProcessDataAccess` sample contains a number of simple functions that demonstrate various features of the [!INCLUDE[ssNoVersion](../a9notintoc/includes/ssnoversion-md.md)] CLR in-process data access provider.  
...
8.  Copy the [!INCLUDE[tsql](../a9notintoc/includes/tsql-md.md)] installation code into a file and save it as `test.sql` in the sample directory.  
...
```  
 ...
 This is the [!INCLUDE[tsql](../a9notintoc/includes/tsql-md.md)] installation script (`Install.sql`), which deploys the assembly and creates the stored procedures and function required by this example.  
...
```  
 ...
 The following [!INCLUDE[tsql](../a9notintoc/includes/tsql-md.md)] (`test.sql`) tests the example by exercising the stored procedures and function defined in this sample.  
...
```  
 ...
 The following [!INCLUDE[tsql](../a9notintoc/includes/tsql-md.md)] removes the assembly, function and stored procedures from the database.  
