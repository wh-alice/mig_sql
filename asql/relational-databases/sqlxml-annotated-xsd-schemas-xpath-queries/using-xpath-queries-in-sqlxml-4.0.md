...
# Using XPath Queries in SQLXML 4.0
  Microsoft [!INCLUDE[ssNoVersion](../../a9notintoc/includes/ssnoversion-md.md)] support for annotated XSD schemas allows you to create XML views of the relational data stored in the database. You can use a subset of the XPath language to query the XML views created by an annotated XSD schema.  
...
## In This Section  
 ...
 Describes XPath data types, which are significantly different from those of both [!INCLUDE[ssNoVersion](../../a9notintoc/includes/ssnoversion-md.md)] and XSD.  
