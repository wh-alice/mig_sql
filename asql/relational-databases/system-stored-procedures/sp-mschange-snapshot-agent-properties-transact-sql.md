 ...
 **sp_MSchange_snapshot_agent_properties** is used in snapshot replication, transactional replication, and merge replication.  
 ...
 When the Publisher runs on an instance of [!INCLUDE[ssVersion2005](../../analysis-services/data-mining/includes/ssversion2005-md.md)] or later version, you should use [sp_changepublication_snapshot](../../relational-databases/system-stored-procedures/sp-changepublication-snapshot-transact-sql.md) to change properties of a Snapshot Agent job.  
