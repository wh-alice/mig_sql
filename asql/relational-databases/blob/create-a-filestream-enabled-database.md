...
2.  Copy the [!INCLUDE[tsql](../../advanced-analytics/r-services/includes/tsql-md.md)] code from the following example into the Query Editor. This [!INCLUDE[tsql](../../advanced-analytics/r-services/includes/tsql-md.md)] code creates a FILESTREAM-enabled database called Archive.  
