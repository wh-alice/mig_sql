...
|**maxirow**|**smallint**|Maximum size of a nonleaf index row.<br /><br /> In [!INCLUDE[ssVersion2005](../../../a9notintoc/includes/ssversion2005-md.md)] and later, **maxirow** is not fully compatible with earlier versions.|  
...
## Remarks  
 ...
 In SQL Server 2000 and earlier, the [!INCLUDE[ssDE](../../../a9notintoc/includes/ssde-md.md)] maintained row-level modification counters. Such counters are now maintained at the column level. Therefore, the **rowmodctr** column is calculated and produces results that are similar to the results in earlier versions, but are not exact.  
