...
---
# SP:StmtStarting Event Class
  The SP:StmtStarting event class indicates that a [!INCLUDE[tsql](../../advanced-analytics/r-services/includes/tsql-md.md)] statement within a stored procedure has started.  
