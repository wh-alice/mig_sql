...
Because you have changed the model, you must re-deploy it. You will essentially repeat the tasks performed in [Lesson 14: Deploy](../../analysis-services/tutorials/lesson-13-deploy.md).  
