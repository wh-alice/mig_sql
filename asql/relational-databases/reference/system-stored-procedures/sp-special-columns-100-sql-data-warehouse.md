...
|PSEUDO_COLUMN|**smallint**|Indicates whether the column is a pseudocolumn. [!INCLUDE[ssNoVersion](../../../a9notintoc/includes/ssnoversion-md.md)] always returns 1:<br /><br /> 0 = SQL_PC_UNKNOWN<br /><br /> 1 = SQL_PC_NOT_PSEUDO<br /><br /> 2 = SQL_PC_PSEUDO|  
...
## See Also  
 [SQL Data Warehouse Stored Procedures](../../../relational-databases/reference/system-stored-procedures/sql-data-warehouse-stored-procedures.md)  
