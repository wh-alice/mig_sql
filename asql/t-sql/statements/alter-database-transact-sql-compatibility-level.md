...
Sets certain database behaviors to be compatible with the specified version of [!INCLUDE[ssNoVersion](../../a9notintoc/includes/ssnoversion-md.md)]. For other ALTER DATABASE options, see [ALTER DATABASE &#40;Transact-SQL&#41;](../../t-sql/statements/alter-database-transact-sql.md).  
 ...
 *database_name*  
 ...
 Is the version of [!INCLUDE[ssNoVersion](../../a9notintoc/includes/ssnoversion-md.md)] with which the database is to be made compatible. The following compatibility level values can be configured:  
...
|[!INCLUDE[ssSQL15](../../a9notintoc/includes/sssql15-md.md)]|13|130|130, 120, 110, 100|  
|[!INCLUDE[ssSDS](../../a9retired/includes/sssds-md.md)]|12|120|130, 120, 110, 100|  
|[!INCLUDE[ssSQL14](../../a9notintoc/includes/sssql14-md.md)]|12|120|120, 110, 100|  
|[!INCLUDE[ssSQL11](../../a9notintoc/includes/sssql11-md.md)]|11|110|110, 100, 90|  
|[!INCLUDE[ssKilimanjaro](../../a9notintoc/includes/sskilimanjaro-md.md)]|10.5|105|100, 90, 80|  
|[!INCLUDE[ssKatmai](../../a9notintoc/includes/sskatmai-md.md)]|10|100|100, 90, 80|  
...
>  For details about how to assess the performance differences of your most important queries, between two compatibility levels on Azure SQL Database, see [Improved Query Performance with Compatibility Level 130 in Azure SQL Database](http://azure.microsoft.com/documentation/articles/sql-database-compatibility-level-query-performance-130/).
 ...
 Execute the following query to determine the version of the [!INCLUDE[ssDE](../../a9notintoc/includes/ssde-md.md)] that you are connected to.  
...
> [!NOTE]  
>  Not all features that vary by compatibility level are  supported on [!INCLUDE[ssSDS](../../a9retired/includes/sssds-md.md)].  
...
|The RC4 algorithm is only supported for backward compatibility. New material can only be encrypted using RC4 or RC4_128 when the database is in compatibility level 90 or 100. (Not recommended.) In [!INCLUDE[ssSQL11](../../a9notintoc/includes/sssql11-md.md)], material encrypted using RC4 or RC4_128 can be decrypted in any compatibility level.|New material cannot be encrypted using RC4 or RC4_128. Use a newer algorithm such as one of the AES algorithms instead. In [!INCLUDE[ssSQL11](../../a9notintoc/includes/sssql11-md.md)], material encrypted using RC4 or RC4_128 can be decrypted in any compatibility level.|  
...
## Reserved Keywords  
 The compatibility setting also determines the keywords that are reserved by the [!INCLUDE[ssDE](../../a9notintoc/includes/ssde-md.md)]. The following table shows the reserved keywords that are introduced by each of the compatibility levels.  
...
### A. Changing the compatibility level  
 The following example changes the compatibility level of the [!INCLUDE[ssSampleDBobject](../../a9retired/includes/sssampledbobject-md.md)] database to `110,`[!INCLUDE[ssSQL11](../../a9notintoc/includes/sssql11-md.md)].  
