...
> [!IMPORTANT]  
>  Both instances of the capture logic require [!INCLUDE[ssNoVersion](../../a9notintoc/includes/ssnoversion-md.md)] Agent to be running for the process to execute.  
