...
In the task in this lesson, you define  KPIs in the [!INCLUDE[ssASnoversion](../../analysis-services/includes/ssasnoversion-md.md)] Tutorial project, and you then browse the [!INCLUDE[ssASnoversion](../../analysis-services/includes/ssasnoversion-md.md)] Tutorial cube by using these KPIs. You will define the following KPIs:  
...
1.  Open Cube Designer for the [!INCLUDE[ssASnoversion](../../analysis-services/includes/ssasnoversion-md.md)] Tutorial cube, and then click the **KPIs** tab.  
    ...
    ![KPIs tab of Cube Designer](../../analysis-services/tutorials/media/l7-kpi-1.gif "KPIs tab of Cube Designer")  
...
2.  On the toolbar of the **KPIs** tab, click the **New KPI** button.  
    ...
    ![Blank KPI template in display pane](../../analysis-services/tutorials/media/l7-kpi-2.gif "Blank KPI template in display pane")  
...
1.  On the **Build** menu of [!INCLUDE[ssBIDevStudioFull](../../analysis-services/includes/ssbidevstudiofull-md.md)], click **Deploy Analysis Service Tutorial**.  
