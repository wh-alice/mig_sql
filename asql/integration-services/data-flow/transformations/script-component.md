...
-   Use custom formulas and functions in addition to the functions and operators that the [!INCLUDE[ssISnoversion](../../../a9notintoc/includes/ssisnoversion-md.md)] expression grammar provides. For example, validate credit card numbers that use the LUHN formula.  
...
## Writing the Script that the Component Uses  
 ...
 VSTA includes all the standard features of the [!INCLUDE[vsprvs](../../../a9retired/includes/vsprvs-md.md)] environment, such as the color-coded [!INCLUDE[vsprvs](../../../a9retired/includes/vsprvs-md.md)] editor, IntelliSense, and Object Browser. The script that the Script component uses is stored in the package definition. When you are designing the package, the script code is temporarily written to a project file.  
  
 VSTA supports the [!INCLUDE[msCoName](../../../a9notintoc/includes/msconame-md.md)] Visual C# and [!INCLUDE[msCoName](../../../a9notintoc/includes/msconame-md.md)] Visual Basic programming languages.  
...
-   Select the input columns to reference.  
    ...
    > [!NOTE]  
    >  You can configure only one input when you use the [!INCLUDE[ssIS](../../../a9retired/includes/ssis-md.md)] Designer.  
