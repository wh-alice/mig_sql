...
-   SQLXML Managed Classes  
     ...
     Expose SQLXML functionality inside the [!INCLUDE[msCoName](../../../advanced-analytics/r-services/tutorials/includes/msconame-md.md)] .NET Framework. For more information, see [SQLXML Managed Classes](../../../relational-databases/sqlxml-annotated-xsd-schemas-xpath-queries/net-framework-classes/sqlxml-4.0-.net-framework-support-managed-classes.md).  
...
## In This Section  
 [SQLXMLOLEDB Provider &#40;SQLXML 4.0&#41;](http://msdn.microsoft.com/en-US/library/ms172675(SQL.130).aspx)  
