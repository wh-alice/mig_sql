...
---
# InstanceName Property (ServerNetworkProtocolProperty Class)
  Gets the name of an instance of [!INCLUDE[msCoName](../../../a9notintoc/includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../../a9notintoc/includes/ssnoversion-md.md)] on which the server network protocol is installed.  
...
## Property Value/Return Value  
 A string value that specifies the name of the instance of [!INCLUDE[ssNoVersion](../../../a9notintoc/includes/ssnoversion-md.md)] on which the server network protocol is installed.  
