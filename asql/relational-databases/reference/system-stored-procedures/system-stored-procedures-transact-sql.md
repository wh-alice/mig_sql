...
|--------------|-----------------|  
|[Active Geo-Replication Stored Procedures](http://msdn.microsoft.com/en-US/library/dn467646(SQL.130).aspx)|Used to manage to manage Active Geo-Replication configurations in Azure SQL Database|  
...
|[Filestream and FileTable Stored Procedures &#40;Transact-SQL&#41;](http://msdn.microsoft.com/en-US/library/gg492081(SQL.130).aspx)|Used to configure and manage the FILESTREAM and FileTable features.|  
...
|[PolyBase stored procedures](http://msdn.microsoft.com/en-US/library/mt621173(SQL.130).aspx)|Add or remove a computer from a PolyBase scale-out group.|  
...
|[Snapshot Backup Stored Procedures](http://msdn.microsoft.com/en-US/library/mt146386(SQL.130).aspx)|Used to delete the FILE_SNAPSHOT backup along with all of its snapshots or to delete an individual backup file snapshot.|  
|[Spatial Index Stored Procedures](http://msdn.microsoft.com/en-US/library/cc645724(SQL.130).aspx)|Used to analyze and improve the indexing performance of spatial indexes.|  
...
|[Temporal Tables Stored Procedures](http://msdn.microsoft.com/en-US/library/mt607133(SQL.130).aspx)|Use for temporal tables|  
