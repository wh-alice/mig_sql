...
## Configuring DB2 Console Settings  
...
7.  **Stop Operation:** During the mid-operation, if the user wants to stop the operation, then **‘Ctrl+C’** hotkey can be used. SSMA for DB2 Console will wait for the operation to complete and terminates the console execution.  
...
For example, a typical data migration of a specific table in an DB2 database follows the hierarchy of: Schema -&gt; Table.  
...
Complete list of script-commands can be found in [Executing the SSMA Console &#40;DB2ToSQL&#41;](../../ssma/db2/executing-the-ssma-console--db2tosql-.md)  
...
## Next Step  
The next step in operating the console is [Creating Variable Value Files &#40;DB2ToSQL&#41;](../../ssma/db2/creating-variable-value-files--db2tosql-.md).  
