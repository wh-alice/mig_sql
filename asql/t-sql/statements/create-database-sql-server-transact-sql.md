...
## Arguments  
 *database_name*  
 Is the name of the new database. Database names must be unique within an instance of [!INCLUDE[ssNoVersion](../../a9notintoc/includes/ssnoversion-md.md)] and comply with the rules for [identifiers](../../relational-databases/databases/database-identifiers.md).  
 ...
 *database_name* can be a maximum of 128 characters, unless a logical name is not specified for the log file. If a logical log file name is not specified, [!INCLUDE[ssNoVersion](../../a9notintoc/includes/ssnoversion-md.md)] generates the *logical_file_name* and the *os_file_name* for the log by appending a suffix to *database_name*. This limits *database_name* to 123 characters so that the generated logical file name is no more than 128 characters.  
 ...
 If data file name is not specified, [!INCLUDE[ssNoVersion](../../a9notintoc/includes/ssnoversion-md.md)] uses *database_name* as both the *logical_file_name* and as the *os_file_name*. The default path is obtained from the registry. The default path can be changed by using the **Server Properties (Database Settings Page)** in [!INCLUDE[ssManStudio](../../a9notintoc/includes/ssmanstudio-md.md)]. Changing the default path requires restarting [!INCLUDE[ssNoVersion](../../a9notintoc/includes/ssnoversion-md.md)].  
...
> [!NOTE]  
>  Attach works with the **vardecimal** storage format, but the [!INCLUDE[ssDEnoversion](../../a9notintoc/includes/ssdenoversion-md.md)] must be upgraded to at least [!INCLUDE[ssVersion2005](../../a9notintoc/includes/ssversion2005-md.md)] Service Pack 2. You cannot attach a database using vardecimal storage format to an earlier version of [!INCLUDE[ssNoVersion](../../a9notintoc/includes/ssnoversion-md.md)]. For more information about the **vardecimal** storage format, see [Data Compression](../../relational-databases/data-compression/data-compression.md).  
...
> [!NOTE]  
>  If the log files are available, the [!INCLUDE[ssDE](../../a9notintoc/includes/ssde-md.md)] uses those files instead of rebuilding the log files.  
 ...
 *size*  
 ...
 When *size* is not supplied for the primary file, the [!INCLUDE[ssDE](../../a9notintoc/includes/ssde-md.md)] uses the size of the primary file in the model database. The default size of model is 8 MB (beginning with [!INCLUDE[ssSQL15](../../a9notintoc/includes/sssql15-md.md)]) or 1 MB (for earlier versions). When a secondary data file or log file is specified, but *size* is not specified for the file, the [!INCLUDE[ssDE](../../a9notintoc/includes/ssde-md.md)] makes the file 8 MB (beginning with [!INCLUDE[ssSQL15](../../a9notintoc/includes/sssql15-md.md)]) or 1 MB (for earlier versions). The size specified for the primary file must be at least as large as the primary file of the model database.  
 ...
 *max_size*  
 ...
 UNLIMITED  
 Specifies that the file grows until the disk is full. In [!INCLUDE[ssNoVersion](../../a9notintoc/includes/ssnoversion-md.md)], a log file specified with unlimited growth has a maximum size of 2 TB, and a data file has a maximum size of 16 TB.  
...
|-------------|--------------------|  
|Beginning [!INCLUDE[ssSQL15](../../a9notintoc/includes/sssql15-md.md)]|Data 64 MB. Log files 64 MB.|  
|Beginning [!INCLUDE[ssVersion2005](../../a9notintoc/includes/ssversion2005-md.md)]|Data 1 MB. Log files 10%.|  
|Prior to [!INCLUDE[ssVersion2005](../../a9notintoc/includes/ssversion2005-md.md)]|Data 10%. Log files 10%.|  
 ...
 *database_snapshot_name*  
 Is the name of the new database snapshot. Database snapshot names must be unique within an instance of [!INCLUDE[ssNoVersion](../../a9notintoc/includes/ssnoversion-md.md)] and comply with the rules for identifiers. *database_snapshot_name* can be a maximum of 128 characters.  
...
## Remarks  
 ...
 You can use one CREATE DATABASE statement to create a database and the files that store the database. [!INCLUDE[ssNoVersion](../../a9notintoc/includes/ssnoversion-md.md)] implements the CREATE DATABASE statement by using the following steps:  
  
1.  The [!INCLUDE[ssNoVersion](../../a9notintoc/includes/ssnoversion-md.md)] uses a copy of the [model database](../../relational-databases/databases/model-database.md) to initialize the database and its metadata.  
  
2.  A service broker GUID is assigned to the database.  
  
3.  The [!INCLUDE[ssDE](../../a9notintoc/includes/ssde-md.md)] then fills the rest of the database with empty pages, except for pages that have internal data that records how the space is used in the database.  
...
## Viewing Database Information  
 You can use catalog views, system functions, and system stored procedures to return information about databases, files, and filegroups. For more information, see [System Views &#40;Transact-SQL&#41;](../../a9retired/system-views-transact-sql.md).  
...
### Permissions on Data and Log Files  
 In [!INCLUDE[ssNoVersion](../../a9notintoc/includes/ssnoversion-md.md)], certain permissions are set on the data and log files of each database. The following permissions are set whenever the following operations are applied to a database:  
...
> [!NOTE]  
>  [!INCLUDE[msCoName](../../a9notintoc/includes/msconame-md.md)] [!INCLUDE[ssExpressEd2005](../../a9retired/includes/ssexpressed2005-md.md)] does not set data and log file permissions.  
