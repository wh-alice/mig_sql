...
To use a column in a query, you must add it to the query. You might add a column to display it in query output, to use it for sorting, to search the contents of the column, or to summarize its contents. You can decide which of the columns you use in the query are included in the results pane when the query is run. For more information see [Remove Columns from Query Results &#40;Visual Database Tools&#41;](../ssms/remove-columns-from-query-results--visual-database-tools-.md).  
...
## See Also  
[Remove Columns from Query Results &#40;Visual Database Tools&#41;](../ssms/remove-columns-from-query-results--visual-database-tools-.md)  
