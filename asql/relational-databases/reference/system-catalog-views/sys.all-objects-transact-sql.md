...
|schema_id|**int**|ID of the schema that contains the object.<br /><br /> For all schema scoped system objects that are included with [!INCLUDE[ssNoVersion](../../../a9notintoc/includes/ssnoversion-md.md)], this value is always in (schema_id('sys'), schema_id('INFORMATION_SCHEMA')).|  
...
|is_ms_shipped|**bit**|Object created by an internal [!INCLUDE[ssNoVersion](../../../a9notintoc/includes/ssnoversion-md.md)] component.|  
