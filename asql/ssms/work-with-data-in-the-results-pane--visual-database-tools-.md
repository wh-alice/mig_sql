...
For more information see [Open Queries &#40;Visual Database Tools&#41;](../ssms/open-queries--visual-database-tools-.md).  
  
To change the design of the query or view so it returns a different set of results or returns records in a different order see the topics listed in [Design Queries and Views How-to Topics &#40;Visual Database Tools&#41;](../ssms/design-queries-and-views-how-to-topics--visual-database-tools-.md).  
...
For information about using keyboard shortcuts in the Query and View Designer see [Navigate in the Query and View Designer &#40;Visual Database Tools&#41;](../ssms/navigate-in-the-query-and-view-designer--visual-database-tools-.md).  
...
In addition to copying rows into the Results pane you can add new records or modify or delete existing ones. For more information see [Add New Rows in the Results Pane &#40;Visual Database Tools&#41;](../ssms/add-new-rows-in-the-results-pane--visual-database-tools-.md), [Delete Rows in the Results Pane &#40;Visual Database Tools&#41;](../ssms/delete-rows-in-the-results-pane--visual-database-tools-.md), and [Edit Rows in the Results Pane &#40;Visual Database Tools&#41;](../ssms/edit-rows-in-the-results-pane--visual-database-tools-.md).  
