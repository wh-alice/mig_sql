...
|Setting|Description|  
|-------------|-----------------|  
|**1050**|This value is not visible in script or tools, but it corresponds to databases created in [!INCLUDE[ssVersion2005](../../analysis-services/data-mining/includes/ssversion2005-md.md)], [!INCLUDE[ssKatmai](../../analysis-services/data-mining/includes/sskatmai-md.md)], or [!INCLUDE[ssKilimanjaro](../../analysis-services/instances/install/windows/includes/sskilimanjaro-md.md)]. Any database that does not have **CompatibilityLevel** explicitly set is implicitly running at the **1050** level.|  
|**1100**|This is the default value for new databases that you create in [!INCLUDE[ssSQL11](../../analysis-services/includes/sssql11-md.md)] or [!INCLUDE[ssCurrent](../../advanced-analytics/r-services/includes/sscurrent-md.md)]. You can also specify it for databases created in earlier versions of [!INCLUDE[ssASnoversion](../../analysis-services/includes/ssasnoversion-md.md)] to enable the use of features that are supported only at this compatibility level (namely, increased string storage for dimension attributes or distinct count measures that contain string data).<br /><br /> Databases that have a **CompatibilityLevel** set to **1100** get an additional property, **StringStoresCompatibilityLevel**, that lets you choose alternative string storage for partitions and dimensions.|  
  
> [!WARNING]  
>  Setting the database compatibility to a higher level is irreversible. After you increase the compatibility level to **1100**, you must continue to run the database on newer servers. You cannot rollback to **1050**. You cannot attach or restore an **1100** database on a server version that is earlier than [!INCLUDE[ssSQL11](../../analysis-services/includes/sssql11-md.md)] or [!INCLUDE[ssCurrent](../../advanced-analytics/r-services/includes/sscurrent-md.md)].  
  
## Prerequisites  
 Database compatibility levels are introduced in [!INCLUDE[ssSQL11](../../analysis-services/includes/sssql11-md.md)]. You must have [!INCLUDE[ssSQL11](../../analysis-services/includes/sssql11-md.md)][!INCLUDE[ssASnoversion](../../analysis-services/includes/ssasnoversion-md.md)] or higher to view or set the database compatibility level.  
...
2.  Using SQL Server Management Studio, connect to the [!INCLUDE[ssCurrent](../../advanced-analytics/r-services/includes/sscurrent-md.md)][!INCLUDE[ssASnoversion](../../analysis-services/includes/ssasnoversion-md.md)] server that hosts the database.  
