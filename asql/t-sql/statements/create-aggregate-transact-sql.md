...
## Examples  
 The following example assumes that a StringUtilities.csproj sample application is compiled. For more information, see [String Utility Functions Sample](http://msdn.microsoft.com/en-US/library/ff878119(SQL.130).aspx).  
