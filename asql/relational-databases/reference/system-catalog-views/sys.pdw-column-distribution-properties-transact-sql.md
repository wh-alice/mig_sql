...
|**distribution_ordinal**|**tinyint**|Ordinal (1-based) within set of distribution.|0 = Not a distribution column. 1 = [!INCLUDE[ssSDW](../../../database-engine/configure/windows/includes/sssdw-md.md)] is using this column to distribute the parent table.|  
