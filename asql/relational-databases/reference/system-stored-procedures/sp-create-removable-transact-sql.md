...
> [!IMPORTANT]  
>  [!INCLUDE[ssNoteDepFutureAvoid](../../../database-engine/configure/windows/includes/ssnotedepfutureavoid-md.md)] We recommend that you use [CREATE DATABASE](../../../t-sql/statements/create-database-sql-server-transact-sql.md) instead.  
...
> [!NOTE]  
>  [!INCLUDE[ssNoVersion](../../../advanced-analytics/r-services/includes/ssnoversion-md.md)] does not set data and log file permissions.  
...
## See Also  
 ...
 [sp_certify_removable &#40;Transact-SQL&#41;](../../../relational-databases/reference/system-stored-procedures/sp-certify-removable-transact-sql.md)   
