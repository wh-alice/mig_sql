...
## Arguments  
 [**@publisher** = ] **'***publisher***'**  
 Is the name of the non-[!INCLUDE[ssNoVersion](../../../a9notintoc/includes/ssnoversion-md.md)] Publisher to which the job belongs. *publisher* is **sysname**, with no default.  
...
## See Also  
 ...
 [sp_publisherproperty &#40;Transact-SQL&#41;](../../../relational-databases/reference/system-stored-procedures/sp-publisherproperty-transact-sql.md)  
