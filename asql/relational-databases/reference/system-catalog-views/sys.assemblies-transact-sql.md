...
|**is_visible**|**bit**|1 = Assembly is visible to register [!INCLUDE[tsql](../../../advanced-analytics/r-services/includes/tsql-md.md)] entry points.<br /><br /> 0 = Assembly is intended only for managed callers. That is, the assembly provides internal implementation for other assemblies in the database.|  
