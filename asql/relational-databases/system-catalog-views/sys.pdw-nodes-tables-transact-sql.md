...
|filestream_data_space_id|**int**|Data space ID for a FILESTREAM filegroup or [!INCLUDE[ssInfoNA](../../relational-databases/system-catalog-views/includes/ssinfona-md.md)]|NULL|  
