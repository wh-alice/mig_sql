...
> [!NOTE]  
>  To call this from [!INCLUDE[ssSDWfull](../../../a9notintoc/includes/sssdwfull-md.md)] or [!INCLUDE[ssPDW](../../../a9notintoc/includes/sspdw-md.md)], use the name **sys.dm_pdw_nodes_os_workers**.  
...
|is_in_cc_exception|**bit**|1 = Worker is currently handling a non-[!INCLUDE[ssNoVersion](../../../a9notintoc/includes/ssnoversion-md.md)] exception.|  
...
|fiber_address|**varbinary(8)**|Memory address of the fiber with which this worker is associated.<br /><br /> NULL = [!INCLUDE[ssNoVersion](../../../a9notintoc/includes/ssnoversion-md.md)] is not configured for lightweight pooling.|  
