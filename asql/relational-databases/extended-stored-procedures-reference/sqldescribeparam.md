...
-   When there are comments (/* \*/) in the [!INCLUDE[tsql](../../a9notintoc/includes/tsql-md.md)] command.  
  
 When processing a batch of [!INCLUDE[tsql](../../a9notintoc/includes/tsql-md.md)] statements, the driver also does not support calling SQLDescribeParam for parameter markers in statements after the first statement in the batch.  
