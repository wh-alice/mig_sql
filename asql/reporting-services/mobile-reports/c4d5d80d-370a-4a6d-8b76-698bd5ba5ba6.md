...
manager: "erikre"
---
# Create a tabbed mobile report by using drillthrough | Reporting Services mobile reports
Learn how to create a [!INCLUDE[ssRSnoversion_md](../../a9notintoc/includes/ssrsnoversion-md.md)] mobile report that looks and acts like a tabbed report by using drillthrough and parameters.
...
3. Save it to a [!INCLUDE[ssRSnoversion_md](../../a9notintoc/includes/ssrsnoversion-md.md)] report server.
...
3. Save them to the [!INCLUDE[ssRSnoversion_md](../../a9notintoc/includes/ssrsnoversion-md.md)] report server.
...
1. Go to the [!INCLUDE[ssRSnoversion_md](../../a9notintoc/includes/ssrsnoversion-md.md)] report server and open one of the reports. 
