...
4.  In the **Input Output Selection** dialog box, select **Unique Records**, and click **OK**.  
    ...
    ![Input Output Selection Dialog Box](../a9notintoc/media/et-addingdcttoaddcolumnsrequiredbymds-01.jpg "Input Output Selection Dialog Box")  
  
5.  Click **SSIS** on the menu bar and click **Variables**.  
  
6.  In the **Variables** window, click **Add Variable** button on the toolbar.  
  
    ![SSIS Variables Window](../a9notintoc/media/et-addingdcttoaddcolumnsrequiredbymds-02.jpg "SSIS Variables Window")  
...
12. Expand **Variables and Parameters** in the top-left pane, drag-drop **User::ImportType** to the **Expression** column.  
    ...
    ![Derived Column Transformation Editor](../a9notintoc/media/et-addingdcttoaddcolumnsrequiredbymds-03.jpg "Derived Column Transformation Editor")  
...
## Next Step  
[Task 13: Adding OLE DB Destination to Write Data to MDS Staging Table](../a9notintoc/task-13-adding-ole-db-destination-to-write-data-to-mds-staging-table.md)  
