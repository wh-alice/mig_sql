...
# Upgrade Workbooks and Scheduled Data Refresh (SharePoint 2013)
  This topic explains the user experience of workbooks created in previous [!INCLUDE[ssGemini](../../../../analysis-services/includes/ssgemini-md.md)] environments and how to upgrade [!INCLUDE[ssGemini](../../../../analysis-services/includes/ssgemini-md.md)] workbooks so that you can take advantage of new features introduced in this release. To learn more about new features, see [What’s New in Power Pivot](http://go.microsoft.com/fwlink/?LinkID=203917).  
...
##  <a name="bkmk_overview"></a> Overview of Upgrading Workbooks  
 A [!INCLUDE[ssGemini](../../../../analysis-services/includes/ssgemini-md.md)] workbook is an Excel workbook that contains embedded [!INCLUDE[ssGemini](../../../../analysis-services/includes/ssgemini-md.md)] data. Upgrading a workbook has two benefits:  
  
-   Use new features in [!INCLUDE[ssGeminiClient](../../../../analysis-services/includes/ssgeminiclient-md.md)].  
...
##  <a name="bkmk_to_2012sp1_from_2008r2"></a> Upgrade to SQL Server 2012 Service Pack 1 (SP1) workbooks from 2008 R2 Workbooks  
 This section describes upgrading to SQL Server 2012 SP1 [!INCLUDE[ssGemini](../../../../analysis-services/includes/ssgemini-md.md)] for Excel 2013 workbooks from SQL Server 2008 R2 [!INCLUDE[ssGemini](../../../../analysis-services/includes/ssgemini-md.md)] for Excel 2010 workbooks.  
 ...
 **Behavior Change:** SQL Server 2008 R2 [!INCLUDE[ssGemini](../../../../analysis-services/includes/ssgemini-md.md)] workbooks will not be automatically upgraded  when they are used in SQL Server 2012 SP1 [!INCLUDE[ssGemini](../../../../analysis-services/includes/ssgemini-md.md)] for SharePoint 2013. Therefore, scheduled data refreshes will not work for SQL Server 2008 R2 [!INCLUDE[ssGemini](../../../../analysis-services/includes/ssgemini-md.md)] workbooks  
 ...
 2008 R2 workbooks will open in [!INCLUDE[ssGemini](../../../../analysis-services/includes/ssgemini-md.md)] for SharePoint 2013, however scheduled data refreshes will not work. If you review the refresh history you will see an error message similar to the following:  
  
 “The workbook contains an unsupported [!INCLUDE[ssGemini](../../../../analysis-services/includes/ssgemini-md.md)] model. The [!INCLUDE[ssGemini](../../../../analysis-services/includes/ssgemini-md.md)] model in the workbook is in the SQL Server 2008 R2 [!INCLUDE[ssGemini](../../../../analysis-services/includes/ssgemini-md.md)] for Excel 2010 format. Supported [!INCLUDE[ssGemini](../../../../analysis-services/includes/ssgemini-md.md)] models are the following:  
  
-   SQL Server 2012 [!INCLUDE[ssGemini](../../../../analysis-services/includes/ssgemini-md.md)] for Excel 2010.  
  
-   SQL Server 2012 [!INCLUDE[ssGemini](../../../../analysis-services/includes/ssgemini-md.md)] for Excel 2013.  
...
-   Download and open the workbook in Microsoft Excel 2010 with the SQL Server 2012 [!INCLUDE[ssGemini](../../../../analysis-services/includes/ssgemini-md.md)] for Excel add-in installed.  
  
     Open the [!INCLUDE[ssGemini](../../../../analysis-services/includes/ssgemini-md.md)] window and upgrade the [!INCLUDE[ssGemini](../../../../analysis-services/includes/ssgemini-md.md)] model.  
...
##  <a name="bkmk_to_2012sp1_from_2012"></a> Upgrade to Office 2013 workbooks from Versions created by using the 2012 Power Pivot Add-In for Excel  
 This section describes Upgrading **to** SQL Server 2012 SP1 [!INCLUDE[ssGemini](../../../../analysis-services/includes/ssgemini-md.md)] in Excel 2013 **from** SQL Server 2012 [!INCLUDE[ssGemini](../../../../analysis-services/includes/ssgemini-md.md)] for Excel 2010 workbooks.  
 ...
 “Refresh operation for workbooks created with earlier version of [!INCLUDE[ssGemini](../../../../analysis-services/includes/ssgemini-md.md)] is not available.”  
...
3.  Open the [!INCLUDE[ssGemini](../../../../analysis-services/includes/ssgemini-md.md)] window and upgrade the [!INCLUDE[ssGemini](../../../../analysis-services/includes/ssgemini-md.md)] model.  
...
##  <a name="bkmk_to_2012_from_2008R2"></a> Upgrade to SQL Server 2012 workbooks from Versions created by using the 2008 R2 Power Pivot Add-In for Excel 2010  
 This section describes Upgrading **to** SQL Server 2012 [!INCLUDE[ssGemini](../../../../analysis-services/includes/ssgemini-md.md)] for Excel 2010 **from** SQL Server 2008 R2 [!INCLUDE[ssGemini](../../../../analysis-services/includes/ssgemini-md.md)] for Excel 2010 workbooks.  
 ...
 **How to configure automatic upgrade during data refresh**  
 ...
 To use automatic upgrade, you must select the **Automatically upgrade [!INCLUDE[ssGemini](../../../../analysis-services/includes/ssgemini-md.md)] workbooks to enable data refresh from the server** checkbox in the [!INCLUDE[ssGemini](../../../../analysis-services/includes/ssgemini-md.md)] Configuration Tool. Within the tool, the checkbox is on the **Upgrade [!INCLUDE[ssGemini](../../../../analysis-services/includes/ssgemini-md.md)] System Service** page, and on the **Create [!INCLUDE[ssGemini](../../../../analysis-services/includes/ssgemini-md.md)] Service Application** page if you are configuring a new installation.  
...
```  
 ...
 After you upgrade the workbook, you can use scheduled data refresh and new features in the [!INCLUDE[ssGemini](../../../../analysis-services/includes/ssgemini-md.md)] for Excel add-in.  
  
##  <a name="bkmk_runold"></a> Running Multiple Workbook Versions on a Newer Server  
 You can run older and newer versions of [!INCLUDE[ssGemini](../../../../analysis-services/includes/ssgemini-md.md)] workbooks side by side on a [!INCLUDE[ssSQL11SP1](../../../../analysis-services/instances/install/windows/includes/sssql11sp1-md.md)] instance of [!INCLUDE[ssGeminiShort](../../../../analysis-services/includes/ssgeminishort-md.md)].  
 ...
 Note that Publishing newer version workbooks on previous SQL Server instances of [!INCLUDE[ssGeminiShort](../../../../analysis-services/includes/ssgeminishort-md.md)] is not supported. A [!INCLUDE[ssKilimanjaro](../../../../analysis-services/instances/install/windows/includes/sskilimanjaro-md.md)] instance will not load a workbook that you created in the [!INCLUDE[ssSQL11](../../../../analysis-services/includes/sssql11-md.md)] version of [!INCLUDE[ssGeminiClient](../../../../analysis-services/includes/ssgeminiclient-md.md)], and a SQL Server 2012 instance will not load Office 2013 workbooks with advanced data models that you created using the [!INCLUDE[ssSQL11SP1](../../../../analysis-services/instances/install/windows/includes/sssql11sp1-md.md)] version of [!INCLUDE[ssGemini](../../../../analysis-services/includes/ssgemini-md.md)] in Excel.  
  
###  <a name="bkmk_msolapxslx"></a> How to Check for MSOLAP Data Provider Information in a Power Pivot Workbook  
 Use the following instructions to check which OLE DB provider is used in a [!INCLUDE[ssGemini](../../../../analysis-services/includes/ssgemini-md.md)] workbook. Checking the data connection information does not require the [!INCLUDE[ssGeminiClient](../../../../analysis-services/includes/ssgeminiclient-md.md)] add-in to be installed.  
...
2.  On the **Definition** tab, the provider version appears at the beginning of the connection string.  
     ...
     **Provider=MSOLAP.5** indicates the workbook is [!INCLUDE[ssSQL11](../../../../analysis-services/includes/sssql11-md.md)].  
  
     **Provider=MSOLAP.4** indicates [!INCLUDE[ssKilimanjaro](../../../../analysis-services/instances/install/windows/includes/sskilimanjaro-md.md)].  
  
     **Data Source=$Embedded$** indicates that the workbook is a [!INCLUDE[ssGemini](../../../../analysis-services/includes/ssgemini-md.md)] workbook, using an embedded database.  
  
###  <a name="bkmk_msolappc"></a> How to Check for the Current Version of the MSOLAP Data Provider on a Local Computer  
 Use the following instructions to check which OLE DB provider is the current version on the server or workstation that runs [!INCLUDE[ssGemini](../../../../analysis-services/includes/ssgemini-md.md)] workbooks. Knowing the current version can help you troubleshoot data connection errors after upgrading.  
