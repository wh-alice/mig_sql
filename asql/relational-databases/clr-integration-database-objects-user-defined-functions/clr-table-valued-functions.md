...
### Defining a Table-Valued Function in Transact-SQL  
 The syntax for defining a CLR table-valued function is similar to that of a [!INCLUDE[tsql](../../advanced-analytics/r-services/includes/tsql-md.md)] table-valued function, with the addition of the **EXTERNAL NAME** clause. For example:  
...
###### Declaring and Using the Sample Table-Valued Function  
 After the sample table-valued function has been compiled, it can be declared in [!INCLUDE[tsql](../../advanced-analytics/r-services/includes/tsql-md.md)] like this:  
...
```  
 ...
 Visual C++ database objects compiled with /clr:pure are not supported for execution on [!INCLUDE[ssVersion2005](../../analysis-services/data-mining/includes/ssversion2005-md.md)]. For example, such database objects include table-valued functions.  
  
 To test the sample, try the following [!INCLUDE[tsql](../../advanced-analytics/r-services/includes/tsql-md.md)] code:  
...
```  
 ...
 Compile the source code to a DLL and copy the DLL to the root directory of your C drive.  Then, execute the following [!INCLUDE[tsql](../../advanced-analytics/r-services/includes/tsql-md.md)] query.  
