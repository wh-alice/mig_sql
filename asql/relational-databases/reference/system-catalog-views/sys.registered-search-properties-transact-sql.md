...
|**property_name**|**nvarchar(64)**|Name that uniquely identifies this search property in the search property list.<br /><br /> Note: To search on a property, specify this property name in the [CONTAINS](../Topic/CONTAINS%20\(Transact-SQL\).md) predicate.|  
