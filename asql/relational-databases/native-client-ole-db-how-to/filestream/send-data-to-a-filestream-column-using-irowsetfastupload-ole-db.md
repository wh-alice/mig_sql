...
## Example  
 ...
 The server must have a directory called C:\DBFsa; this is where the sample will create the database. Your instance of [!INCLUDE[ssNoVersion](../../../a9notintoc/includes/ssnoversion-md.md)] must have write access to this location (for example, log on as a local system account).  
 ...
 The fourth ([!INCLUDE[tsql](../../../a9notintoc/includes/tsql-md.md)]) code listing deletes the database created by this sample.  
