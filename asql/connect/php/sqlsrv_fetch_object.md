...
-   If the specified class does not exist, the function returns **false** and adds an error to the error collection. For information about retrieving error information, see [sqlsrv_errors](../../connect/php/sqlsrv_errors.md).  
