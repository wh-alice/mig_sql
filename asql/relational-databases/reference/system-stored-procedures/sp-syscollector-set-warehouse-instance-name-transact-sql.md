...
## Remarks  
 ...
 To view the current instance name, query the [syscollector_config_store](../../../relational-databases/reference/system-catalog-views/syscollector-config-store-transact-sql.md) system view.  
...
## See Also  
 ...
 [syscollector_config_store &#40;Transact-SQL&#41;](../../../relational-databases/reference/system-catalog-views/syscollector-config-store-transact-sql.md)  
