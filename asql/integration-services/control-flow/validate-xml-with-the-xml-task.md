...
```  
 ...
 Here is the result in [!INCLUDE[ssManStudio](../../advanced-analytics/r-services/includes/ssmanstudio-md.md)] of the second sample query shown in the preceding text.  
