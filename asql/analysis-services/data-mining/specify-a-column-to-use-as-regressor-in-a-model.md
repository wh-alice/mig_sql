...
# Specify a Column to Use as Regressor in a Model
 ...
 The following procedure describes how to create a simple linear regression model, using the same sample data that is used for the [neural networks tutorial](http://msdn.microsoft.com/en-US/library/dd206981(SQL.130).aspx). The model is not necessarily robust, but demonstrates how to use the Data Mining Designer to customize a linear regression model.  
