...
2.  Connect to the server in [!INCLUDE[ssManStudioFull](../../../a9notintoc/includes/ssmanstudiofull-md.md)], and then expand the server node.  
...
2.  At the Publisher, execute [sp_changepublication_snapshot](../../../relational-databases/reference/system-stored-procedures/sp-changepublication-snapshot-transact-sql.md), specifying **@publication** and one or more of the following security settings to change:  
    ...
    -   When changing the security mode used when connecting to the Publisher from **1** to **0** or when changing a [!INCLUDE[ssNoVersion](../../../a9notintoc/includes/ssnoversion-md.md)] login used for this connection, specify **@publisher_login** and **@publisher_password**.  
...
###  <a name="PShellExample"></a> Example (RMO)  
 ...
 [!code-cs[HowTo#rmo_ChangeServerPasswords](../../../a9retired/codesnippet/csharp/rmohowto/rmotestevelope.cs#rmo_changeserverpasswords)]  
  
 [!code-vb[HowTo#rmo_vb_ChangeServerPasswords](../../../a9retired/codesnippet/visualbasic/rmohowtovb/rmotestenv.vb#rmo_vb_changeserverpasswords)]  
