...
## Examples  
 The following example unbinds and then drops the rule named `VendorID_rule`. (Beginning with [!INCLUDE[ssSQL15](../../a9notintoc/includes/sssql15-md.md)] you can use the DROP RULE IF EXISTS syntax.)  
