...
The Type Mapping project settings let you set default type mappings for the SSMA project. You can also specify type mappings for individual database objects. For more information see [Mapping MySQL and SQL Server Data Types](../../ssma/mysql/mapping-mysql-and-sql-server-data-types--mysqltosql-.md).  
