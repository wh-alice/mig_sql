...
## Prerequisites  
This topic is part of a tabular modeling tutorial, which should be completed in order. Before performing the tasks in this lesson, you should have completed the previous lesson: [Lesson 6: Create Calculated Columns](../Topic/Lesson%206:%20Create%20Calculated%20Columns.md).  
...
## Next Step  
To continue this tutorial, go to the next lesson: [Lesson 8: Create Key Performance Indicators](../Topic/Lesson%208:%20Create%20Key%20Performance%20Indicators.md).  
