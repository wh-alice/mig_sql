...
|WMI must be configured correctly.|To troubleshoot WMI configuration, see [Troubleshoot the SQL Server Utility](../Topic/Troubleshoot%20the%20SQL%20Server%20Utility.md).|  
...
>   
>  For more information about troubleshooting this failure, see [Troubleshoot the SQL Server Utility](../Topic/Troubleshoot%20the%20SQL%20Server%20Utility.md).  
