...
3.  In the [Choose Target Table for Insert Results Dialog Box](../ssms/choose-target-table-for-insert-results-dialog-box--visual-database-tools-.md), select the table to copy rows to (the destination table).  
...
6.  If you want to copy rows in a particular order, specify a sort order. For details, see [Sort and Group Query Results &#40;Visual Database Tools&#41;](../ssms/sort-and-group-query-results--visual-database-tools-.md).  
  
7.  Specify the rows to copy by entering search conditions in the **Filter** column. For details, see [Specify Search Criteria &#40;Visual Database Tools&#41;](../ssms/specify-search-criteria--visual-database-tools-.md).  
...
8.  If you want to copy summary information, specify Group By options. For details, see [Summarize Query Results &#40;Visual Database Tools&#41;](../ssms/summarize-query-results--visual-database-tools-.md).  
  
When you execute an Insert Results query, no results are reported in the [Results Pane](../ssms/results-pane--visual-database-tools-.md). Instead, a message appears indicating how many rows were copied.  
