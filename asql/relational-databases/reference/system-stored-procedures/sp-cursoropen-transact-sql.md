...
|0x80000|OPTIMISITC_ACCEPTABLE|  
 ...
 As with *scrollopt*, [!INCLUDE[ssNoVersion](../../../a9notintoc/includes/ssnoversion-md.md)] can override the requested *ccopt* values.  
...
## Return Code Values  
 ...
 A  
 This cursor has been deallocated by [!INCLUDE[ssNoVersion](../../../a9notintoc/includes/ssnoversion-md.md)] and is unavailable.  
