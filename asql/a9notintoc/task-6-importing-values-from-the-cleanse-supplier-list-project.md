...
3.  Click **down arrow** next to the **Import Values** icon on the toolbar and click **Import Project Values**.  
    ...
    ![Import Project Values Toolbar Button](../a9notintoc/media/et-importingvaluesfromthecslistproject-01.jpg "Import Project Values Toolbar Button")  
...
9. Click **Export Knowledge Base** icon on the toolbar and then click **Export Knowledge Base**.  
    ...
    ![Export Knowledge Base Menu](../a9notintoc/media/et-importingvaluesfromthecslistproject-02.jpg "Export Knowledge Base Menu")  
...
## Next Step  
[Lesson 3: Matching Data to Remove Duplicates from Supplier List](../a9notintoc/lesson-3-matching-data-to-remove-duplicates-from-supplier-list.md)  
