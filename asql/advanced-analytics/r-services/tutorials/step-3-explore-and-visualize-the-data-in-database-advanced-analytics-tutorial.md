...
4.  The output file will be created in the same directory where you ran the PowerShell command. To view the plot, just open the file plot.jpg.  
    ...
    ![taxi trips with and without tips](../../../advanced-analytics/r-services/tutorials/media/rsql-devtut-tippedornot.jpg "taxi trips with and without tips")  
...
*  rHistograms_Tip_and_Fare_Amount_*nnnn*.pdf: Shows  the distribution of values in the tip_amount and fare_amount columns.  
        ...
        ![histogram showing tip_amount and fare_amount](../../../advanced-analytics/r-services/tutorials/media/rsql-devtut-tipamtfareamt.PNG "histogram showing tip_amount and fare_amount")  
  
*  rXYPlots_Tip_vs_Fare_Amount_*nnnn*.pdf: A scatterplot with the fare amount on the x-axis and the tip amount on the y-axis.  
  
        ![tip amount plotted over fare amount](../../../advanced-analytics/r-services/tutorials/media/rsql-devtut-tipamtbyfareamt.PNG "tip amount plotted over fare amount")  
