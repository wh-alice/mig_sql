...
After you add parameters to a mobile report, you create a URL to [open the report with query string parameters](Open%20a%20mobile%20report%20with%20specific%20query%20string%20parameters.md).
...
2. Select the **Data** tab in the upper-left corner of [!INCLUDE[SS_MobileReptPub_Long](../../reporting-services/mobile-reports/includes/ss-mobilereptpub-long.md)].   
...
### See also  
-  [Open a mobile report with specific query string parameters](Open%20a%20mobile%20report%20with%20specific%20query%20string%20parameters.md)
