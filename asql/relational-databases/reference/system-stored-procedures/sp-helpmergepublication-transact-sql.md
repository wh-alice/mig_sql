...
|compress_snapshot|**bit**|Specifies that the snapshot that is written to the **alt_snapshot_folder** location is compressed into the [!INCLUDE[msCoName](../../../a9notintoc/includes/msconame-md.md)] CAB format.|  
