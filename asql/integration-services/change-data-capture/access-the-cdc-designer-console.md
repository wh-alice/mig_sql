 ...
 **Connection Timeout**  
 Type the time (in seconds) that the CDC Service for Oracle waits for a connection to the [!INCLUDE[ssNoVersion](../../a9notintoc/includes/ssnoversion-md.md)] before timing out. The default value is **15**.  
