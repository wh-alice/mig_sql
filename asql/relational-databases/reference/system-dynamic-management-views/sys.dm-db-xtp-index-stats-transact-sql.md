...
[!INCLUDE[tsql-appliesto-ss2014-asdb-xxxx-xxx_md](../../../a9retired/includes/tsql-appliesto-ss2014-asdb-xxxx-xxx-md.md)]
 ...
 For more information, see [In-Memory OLTP &#40;In-Memory Optimization&#41;](../../../relational-databases/in-memory-oltp/in-memory-oltp-in-memory-optimization.md) and [Guidelines for Using Indexes on Memory-Optimized Tables](../../../a9retired/guidelines-for-using-indexes-on-memory-optimized-tables.md).  

  
|Column name|Data type|Description|  
|-----------------|---------------|-----------------|  
|object_id|**bigint**|ID of the object to which this index belongs.|  
|xtp_object_id|**bigint**|Internal ID corresponding to the current version of the object.<br /><br /> Note: Applies to [!INCLUDE[ssSQL15](../../../a9notintoc/includes/sssql15-md.md)].|  
...
|rows_returned|**bigint**|Cumulative number of rows returned since the table was created or the start of [!INCLUDE[ssNoVersion](../../../a9notintoc/includes/ssnoversion-md.md)].|  
|rows_touched|**bigint**|Cumulative number of rows accessed since the table was created or the start of [!INCLUDE[ssNoVersion](../../../a9notintoc/includes/ssnoversion-md.md)].|  
