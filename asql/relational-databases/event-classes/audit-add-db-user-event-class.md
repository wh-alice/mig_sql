...
# Audit Add DB User Event Class
 ...
 This event class may be removed in a future version of [!INCLUDE[ssNoVersion](../../a9notintoc/includes/ssnoversion-md.md)]. It is recommended that you use the **Audit Database Principal Management** event class instead.  
