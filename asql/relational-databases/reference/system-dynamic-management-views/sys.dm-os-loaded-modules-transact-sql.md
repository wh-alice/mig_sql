...
> [!NOTE]  
>  To call this from [!INCLUDE[ssPDW](../../../a9notintoc/includes/sspdw-md.md)], use the name **sys.dm_pdw_nodes_os_loaded_modules**.  
...
|**pdw_node_id**|**int**|**Applies to**: [!INCLUDE[ssPDW](../../../a9notintoc/includes/sspdw-md.md)]<br /><br /> The identifier for the node that this distribution is on.|  
