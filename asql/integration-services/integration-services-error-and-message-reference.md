...
##  <a name="msgError"></a> Error Messages  
 The symbolic names of [!INCLUDE[ssISnoversion](../a9notintoc/includes/ssisnoversion-md.md)] error messages begin with **DTS_E_**.  
...
|0xC000F427|-1073679321|DTS_E_SSISSTANDALONENOTINSTALLED|To run a SSIS package outside of [!INCLUDE[ssBIDevStudioFull](../a9notintoc/includes/ssbidevstudiofull-md.md)] you must install %1 of Integration Services or higher.|  
...
##  <a name="msgWarning"></a> Warning Messages  
 The symbolic names of [!INCLUDE[ssISnoversion](../a9notintoc/includes/ssisnoversion-md.md)] warning messages begin with **DTS_W_**.  
...
##  <a name="msgInfo"></a> Informational Messages  
 The symbolic names of [!INCLUDE[ssISnoversion](../a9notintoc/includes/ssisnoversion-md.md)] informational messages begin with **DTS_I_**.  
...
##  <a name="msgGeneral"></a> General and Event Messages  
 The symbolic names of [!INCLUDE[ssISnoversion](../a9notintoc/includes/ssisnoversion-md.md)] error messages begin with **DTS_MSG_**.  
...
##  <a name="msgSuccess"></a> Success Messages  
 The symbolic names of [!INCLUDE[ssISnoversion](../a9notintoc/includes/ssisnoversion-md.md)] success messages begin with **DTS_S_**.  
...
##  <a name="msgPipeline"></a> Data Flow Component Error Messages  
 The symbolic names of [!INCLUDE[ssISnoversion](../a9notintoc/includes/ssisnoversion-md.md)] error messages begin with **DTSBC_E_**, where "BC" refers to the native base class from which most Microsoft data flow components are derived.  
