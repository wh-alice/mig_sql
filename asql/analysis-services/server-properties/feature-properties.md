...
|**SQMSupportEnabled**|1|A Boolean property that indicates whether error and feature usage reports are sent to [!INCLUDE[msCoName](../../a9notintoc/includes/msconame-md.md)] automatically.|  
