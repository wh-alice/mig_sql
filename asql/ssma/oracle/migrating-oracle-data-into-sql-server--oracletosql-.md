...
5.  In the **Connect to Oracle** dialog box, enter the connection credentials, and then click **Connect**. For more information on connecting to Oracle, see [Connect To Oracle &#40;OracleToSQL&#41;](../../ssma/oracle/connect-to-oracle--oracletosql-.md)  
    ...
    For connecting to the target database SQL Server, enter the connection credentials in the **Connect to SQL Server** dialog box, and click **Connect**. For more information on connecting to SQL Server, see [Connect to SQL Server](http://msdn.microsoft.com/en-us/bb8c4bde-cfc2-4636-92ae-5dd24abe9536)  
