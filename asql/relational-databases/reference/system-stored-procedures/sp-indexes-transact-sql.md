...
## Arguments  
 ...
 Is the name of a linked server running [!INCLUDE[ssNoVersion](../../../a9notintoc/includes/ssnoversion-md.md)] for which table information is being requested. *table_server* is **sysname**, with no default.  
 ...
 [ @table_schema= ] '*table_schema*'  
 Specifies the table schema. In the [!INCLUDE[ssNoVersion](../../../a9notintoc/includes/ssnoversion-md.md)] environment, this corresponds to the table owner. *table_schema* is **sysname**, with a default of NULL.  
...
|INDEX_QUALIFER|**sysname**|Name of the index owner. Some DBMS products allow for users other than the table owner to create indexes. In [!INCLUDE[ssNoVersion](../../../a9notintoc/includes/ssnoversion-md.md)], this column is always the same as **TABLE_NAME**.|  
...
|ASC_OR_DESC|**varchar**|Is the order used in collation:<br /><br /> A = Ascending<br /><br /> D = Descending<br /><br /> NULL = Not applicable<br /><br /> [!INCLUDE[ssNoVersion](../../../a9notintoc/includes/ssnoversion-md.md)] always returns A.|  
...
|FILTER_CONDITION|**nvarchar(**4000**)**|[!INCLUDE[ssNoVersion](../../../a9notintoc/includes/ssnoversion-md.md)] does not return a value.|  
