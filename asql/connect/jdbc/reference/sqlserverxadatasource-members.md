...
|[unwrap](../../../connect/jdbc/reference/unwrap-method--sqlserverxadatasource-.md)|Returns an object that implements the specified interface to allow access to the Microsoft JDBC Driver for SQL Server-specific methods.|  
