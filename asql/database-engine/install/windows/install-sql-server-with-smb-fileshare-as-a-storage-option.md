...
### Supported Data Definition Language (DDL) statements  
 The following [!INCLUDE[tsql](../../../a9notintoc/includes/tsql-md.md)] DDL statements and database engine stored procedures support SMB file shares:  
...
-   In command prompt installation, specify the “/INSTALLSQLDATADIR” as “\\\fileserver1\share1\”.  
     ...
     Here is the sample syntax to install [!INCLUDE[ssNoVersion](../../../a9notintoc/includes/ssnoversion-md.md)] on a Standalone server using SMB file share option:  
  
    ```  
    Setup.exe /q /ACTION=Install /FEATURES=SQL /INSTANCENAME=MSSQLSERVER /SQLSVCACCOUNT="<DomainName\UserName>" /SQLSVCPASSWORD="<StrongPassword>" /SQLSYSADMINACCOUNTS="<DomainName\UserName>" /AGTSVCACCOUNT="<DomainName\UserName>" /AGTSVCPASSWORD="<StrongPassword>" /INSTALLSQLDATADIR="\\FileServer\Share1\" /IACCEPTSQLSERVERLICENSETERMS  
    ```  
  
     To install a single-node [!INCLUDE[ssNoVersion](../../../a9notintoc/includes/ssnoversion-md.md)] failover cluster instance with the [!INCLUDE[ssDE](../../../a9notintoc/includes/ssde-md.md)] and [!INCLUDE[ssASnoversion](../../../a9notintoc/includes/ssasnoversion-md.md)], default instance:  
    ...
    ```  
     ...
     For more information about the usage of various command line parameter options in [!INCLUDE[ssCurrent](../../../a9notintoc/includes/sscurrent-md.md)], see [Install SQL Server 2016 from the Command Prompt](../../../database-engine/install/windows/install-sql-server-2016-from-the-command-prompt.md).  
  
## Operating System Considerations (SMB Protocol vs. [!INCLUDE[ssNoVersion](../../../a9notintoc/includes/ssnoversion-md.md)])  
 Different Windows operating systems has different SMB protocol versions, and the SMB protocol version is transparent to [!INCLUDE[ssNoVersion](../../../a9notintoc/includes/ssnoversion-md.md)]. You can find the benefits of different SMB protocol versions with respect to [!INCLUDE[ssCurrent](../../../a9notintoc/includes/sscurrent-md.md)].  
  
|Operating System|SMB2 protocol version|Benefits to [!INCLUDE[ssNoVersion](../../../a9notintoc/includes/ssnoversion-md.md)]|  
|----------------------|---------------------------|-------------------------------------------|  
...
-   The [!INCLUDE[ssNoVersion](../../../a9notintoc/includes/ssnoversion-md.md)] service account and [!INCLUDE[ssNoVersion](../../../a9notintoc/includes/ssnoversion-md.md)] agent service account should have FULL CONTROL share permissions and NTFS permissions on the SMB share folders. The [!INCLUDE[ssNoVersion](../../../a9notintoc/includes/ssnoversion-md.md)] service account can be a domain account or a system account if an SMB file server is used. For more information about share and NTFS permissions, see [Share and NTFS Permissions on a File Server](http://go.microsoft.com/fwlink/?LinkId=245535) (http://go.microsoft.com/fwlink/?LinkId=245535).  
    ...
    > [!NOTE]  
    >  The FULL CONTROL share permissions and NTFS permissions on the SMB share folders should be restricted to: [!INCLUDE[ssNoVersion](../../../a9notintoc/includes/ssnoversion-md.md)] service account, [!INCLUDE[ssNoVersion](../../../a9notintoc/includes/ssnoversion-md.md)] Agent service account and windows users with admin server roles.  
  
     It is recommended to use domain account as a [!INCLUDE[ssNoVersion](../../../a9notintoc/includes/ssnoversion-md.md)] service account. If system account is used as a service account, grant the permissions for the machine account in the format: *<domain_name>***\\***<computer_name>***$**.  
