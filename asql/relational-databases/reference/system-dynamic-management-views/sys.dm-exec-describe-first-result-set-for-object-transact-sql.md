...
## Arguments  
 *@object_id*  
 The @object_id of a [!INCLUDE[tsql](../../../advanced-analytics/r-services/includes/tsql-md.md)] stored procedure or a [!INCLUDE[tsql](../../../advanced-analytics/r-services/includes/tsql-md.md)] trigger. @object_id is type **int**.  
...
### B. Combining the sys.dm_exec_describe_first_result_set_for_object function and a table or view  
 The following example uses both the sys.procedures system catalog view and the **sys.dm_exec_describe_first_result_set_for_object** function to display metadata for the result sets of all stored procedures in the [!INCLUDE[ssSampleDBobject](../../../database-engine/availability-groups/windows/includes/sssampledbobject-md.md)] database.  
