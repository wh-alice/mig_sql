...
## In This Section  
 ...
 Units of syntax that [!INCLUDE[ssASnoversion](../a9notintoc/includes/ssasnoversion-md.md)] can resolve to single, or scalar, values, objects, or table values.  
 ...
 Text elements that you can insert into DMX statements or scripts to explain the purpose of a statement. [!INCLUDE[ssASnoversion](../a9notintoc/includes/ssasnoversion-md.md)] does not run comments.  
