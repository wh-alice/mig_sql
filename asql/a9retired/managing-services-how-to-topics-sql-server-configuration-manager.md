...
# Managing Services How-to Topics (SQL Server Configuration Manager)
  The [!INCLUDE[ssDE](../a9notintoc/includes/ssde-md.md)] and [!INCLUDE[ssNoVersion](../a9notintoc/includes/ssnoversion-md.md)] Agent run on the [!INCLUDE[msCoName](../a9notintoc/includes/msconame-md.md)] Windows operating systems as services. For more information about services, see [Manage the Database Engine Services](../database-engine/configure/windows/manage-the-database-engine-services.md).  
