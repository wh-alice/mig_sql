 ...
 **0** = [!INCLUDE[ssNoVersion](../../../a9notintoc/includes/ssnoversion-md.md)] Authentication  
 ...
 [ **@login** = ] **'***login***'**  
 Is the name of the Windows account or [!INCLUDE[ssNoVersion](../../../a9notintoc/includes/ssnoversion-md.md)] login being changed. *login* is **nvarchar(257)**, with no default  
