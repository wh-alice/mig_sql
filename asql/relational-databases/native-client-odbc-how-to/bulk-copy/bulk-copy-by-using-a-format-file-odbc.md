...
## Example  
 ...
 Execute the first ([!INCLUDE[tsql](../../../a9notintoc/includes/tsql-md.md)]) code listing to create the table that the sample will use.  
 ...
 Execute the fifth ([!INCLUDE[tsql](../../../a9notintoc/includes/tsql-md.md)]) code listing to delete the table that the sample used.  
