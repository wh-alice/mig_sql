...
7.  Copy the [!INCLUDE[tsql](../a9notintoc/includes/tsql-md.md)] database installation code into a file and save it as `installDB.sql` in the sample directory.  
...
9. Copy [!INCLUDE[tsql](../a9notintoc/includes/tsql-md.md)] test command script into a file and save it as `test.sql` in the sample directory.  
  
10. Execute the test script with the following command  
  
    -   `sqlcmd -E -I -i test.sql`  
  
11. Copy the [!INCLUDE[tsql](../a9notintoc/includes/tsql-md.md)] database cleanup script into a file and save it as `cleanupDB.sql` in the sample directory.  
...
13. Copy the [!INCLUDE[tsql](../a9notintoc/includes/tsql-md.md)] cleanup script into a file and save it as `cleanup.sql` in the sample directory.  
...
```  
 ...
 This is the [!INCLUDE[tsql](../a9notintoc/includes/tsql-md.md)] installation script (`InstallDB.sql`), which creates the audit database in the second instance of [!INCLUDE[ssNoVersion](../a9notintoc/includes/ssnoversion-md.md)].  
...
```  
 ...
 The following [!INCLUDE[tsql](../a9notintoc/includes/tsql-md.md)] removes the audit database from the second instance  
...
```  
 ...
 The following [!INCLUDE[tsql](../a9notintoc/includes/tsql-md.md)] removes the assembly and functions from the database.  
