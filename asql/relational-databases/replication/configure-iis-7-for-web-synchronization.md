...
[!INCLUDE[tsql-appliesto-ss2008-xxxx-xxxx-xxx_md](../../a9retired/includes/tsql-appliesto-ss2008-xxxx-xxxx-xxx-md.md)]
  ...
  The procedures in this topic will guide you through the process of manually configuring [!INCLUDE[msCoName](../../a9notintoc/includes/msconame-md.md)] Internet Information Services (IIS) version 7 and higher for use with Web synchronization for merge replication. 
...
1.  Install and configure the [!INCLUDE[msCoName](../../a9notintoc/includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../a9notintoc/includes/ssnoversion-md.md)] Replication Listener on the computer that is running IIS.  
...
4.  Configure an account and set permissions for the [!INCLUDE[ssNoVersion](../../a9notintoc/includes/ssnoversion-md.md)] Replication Listener.  
