...
> **NOTE!!** To call this from **[!INCLUDE[ssSDWfull](../../../a9notintoc/includes/sssdwfull-md.md)]** or **[!INCLUDE[ssPDW](../../../a9notintoc/includes/sspdw-md.md)]**, use the name **sys.dm_pdw_nodes_exec_background_job_queue**.  
...
## Examples  
 The following example returns the number of active asynchronous jobs in the background queue for each database in the instance of [!INCLUDE[ssNoVersion](../../../a9notintoc/includes/ssnoversion-md.md)].  
