...
---
# Unprepare SQL Event Class
  The Unprepare SQL event class indicates that the SqlClient, ODBC, OLE DB, or DB-Library has unprepared (deleted) a prepared [!INCLUDE[tsql](../../a9notintoc/includes/tsql-md.md)] statement or statements.  
