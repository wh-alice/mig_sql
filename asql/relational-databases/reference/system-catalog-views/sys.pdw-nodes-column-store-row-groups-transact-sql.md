...
|**pdw_node_id**|**int**|Unique id of a [!INCLUDE[ssSDW](../../../database-engine/configure/windows/includes/sssdw-md.md)] node.|  
...
The following [!INCLUDE[ssSDW_md](../../../database-engine/configure/windows/includes/sssdw-md.md)] example counts the rows per partition for clustered column stores as well as how many rows are in Open, Closed, or Compressed Row groups:  
