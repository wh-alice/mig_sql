...
##  <a name="bkmk_config_file_Summary_native_mode"></a> Summary of Configuration Files (Native Mode)  
 The following table provides a description of where configuration settings are stored. Most configuration settings are stored in configuration files that are included with [!INCLUDE[ssRSnoversion](../../a9notintoc/includes/ssrsnoversion-md.md)]. By default, the installation directory is the following:  
