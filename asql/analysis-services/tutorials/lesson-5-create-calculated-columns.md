...
## Prerequisites  
This topic is part of a tabular modeling tutorial, which should be completed in order. Before performing the tasks in this lesson, you should have completed the previous lesson: [Lesson 4: Create Relationships](../../analysis-services/tutorials/lesson-4-create-relationships.md).  
...
## Next Step  
To continue this lesson, go to the next lesson: [Lesson 6: Create Measures](../../analysis-services/tutorials/lesson-6-create-measures.md).  
