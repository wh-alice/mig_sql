...
> [!NOTE]  
>  This view does not include all possible [!INCLUDE[ssSDS](../../../a9retired/includes/sssds-md.md)] database events that can occur, only those listed here. Additional categories, event types, and subtypes may be added in future releases of [!INCLUDE[ssSDS](../../../a9retired/includes/sssds-md.md)].  
