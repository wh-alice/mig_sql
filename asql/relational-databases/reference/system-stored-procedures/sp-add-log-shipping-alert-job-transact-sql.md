...
## Arguments  
 [ **@alert_job_id =** ] *alert_job_id* OUTPUT  
 The [!INCLUDE[msCoName](../../../a9notintoc/includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../../a9notintoc/includes/ssnoversion-md.md)] Agent job ID of the log shipping alert job.  
