...
## Remarks  
 ...
 In [!INCLUDE[ssCurrent](../../../a9notintoc/includes/sscurrent-md.md)]**sp_dropextendedproc** does not drop system extended stored procedures. Instead, the system administrator should deny EXECUTE permission on the extended stored procedure to the **public** role.  
