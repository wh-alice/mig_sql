...
### Framework for Automating Responses  
 ...
 For example, if you were to create a response job in [!INCLUDE[tsql](../../../advanced-analytics/r-services/includes/tsql-md.md)] that services alert message 20574, you might use the following logic:  
