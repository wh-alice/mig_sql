...
# Upgrade a Database Using Detach and Attach (Transact-SQL)
  This topic describes how to use detach and attach operations to upgrade a database in [!INCLUDE[ssCurrent](../../a9notintoc/includes/sscurrent-md.md)]. After being attached to [!INCLUDE[ssCurrent](../../a9notintoc/includes/sscurrent-md.md)], the database is available immediately and is automatically upgraded.  
...
3.  Attach the copied files to the instance of [!INCLUDE[ssCurrent](../../a9notintoc/includes/sscurrent-md.md)]. For more information, see [Attach a Database](../../relational-databases/databases/attach-a-database.md).  
  
## Example  
 The following example upgrades a copy of a database from an earlier version of SQL Server. The [!INCLUDE[tsql](../../a9notintoc/includes/tsql-md.md)] statements are executed in a Query Editor window that is connected to the server instance to which is attached.  
  
1.  Detach the database by executing the following [!INCLUDE[tsql](../../a9notintoc/includes/tsql-md.md)] statements:  
...
3.  Attach the moved database and, optionally, its log by executing the following [!INCLUDE[tsql](../../a9notintoc/includes/tsql-md.md)] statement:  
