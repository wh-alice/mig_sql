...
[!INCLUDE[tsql-appliesto-ss2008-xxxx-xxxx-xxx_md](../../database-engine/configure/windows/includes/tsql-appliesto-ss2008-xxxx-xxxx-xxx-md.md)]
  ...
  Removes the login entries from [!INCLUDE[ssNoVersion](../../advanced-analytics/r-services/includes/ssnoversion-md.md)] for a Windows user or group created by using CREATE LOGIN, **sp_grantlogin**, or **sp_denylogin**.  
...
```  
 ...
 User **ADVWORKS\john** can still connect if **ADVWORKS\Admins** has been granted access to an instance of [!INCLUDE[ssNoVersion](../../advanced-analytics/r-services/includes/ssnoversion-md.md)]. Similarly, if Windows group **ADVWORKS\Admins** has its access revoked but **ADVWORKS\john** is granted access, **ADVWORKS\john** can still connect.  
  
 Use **sp_denylogin** to explicitly prevent users from connecting to an instance of [!INCLUDE[ssNoVersion](../../advanced-analytics/r-services/includes/ssnoversion-md.md)], regardless of their Windows group memberships.  
