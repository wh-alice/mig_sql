 ...
 **sp_MSchange_logreader_agent_properties** is used in transactional replication.  
 ...
 When the Publisher runs on an instance of [!INCLUDE[ssVersion2005](../../../analysis-services/data-mining/includes/ssversion2005-md.md)] or later version, you should use [sp_changelogreader_agent](../../../relational-databases/reference/system-stored-procedures/sp-changelogreader-agent-transact-sql.md) to change properties of the Log Reader Agent.  
