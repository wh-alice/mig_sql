...
## Arguments  
 ...
 [ **@publisher=** ] **'***publisher***'**  
 Is the name of a non-[!INCLUDE[ssNoVersion](../../../a9notintoc/includes/ssnoversion-md.md)] Publisher. *publisher* is **sysname**, with a default value of NULL. You should not specify this parameter for a [!INCLUDE[ssNoVersion](../../../a9notintoc/includes/ssnoversion-md.md)] Publisher.  
 ...
 **sp_startpublication_snapshot** is used with all types of replication.  
 ...
 For a non-[!INCLUDE[ssNoVersion](../../../a9notintoc/includes/ssnoversion-md.md)] Publisher, this stored procedure is executed at the Distributor on the distribution database.  
