...
## Script Task Development Environment  
 The Script task uses [!INCLUDE[msCoName](../../../a9notintoc/includes/msconame-md.md)] [!INCLUDE[vsprvs](../../../a9retired/includes/vsprvs-md.md)] Tools for Applications (VSTA) as the development environment for the script itself.  
...
## Interacting with the Package in the Script Task  
 The Script task uses the global **Dts** object, which is an instance of the <xref:Microsoft.SqlServer.Dts.Tasks.ScriptTask.ScriptObjectModel> class, and its members to interact with the containing package and with the [!INCLUDE[ssISnoversion](../../../a9notintoc/includes/ssisnoversion-md.md)] runtime.  
