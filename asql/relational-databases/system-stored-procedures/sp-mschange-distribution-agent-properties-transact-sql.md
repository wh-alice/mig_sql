 ...
 **sp_MSchange_distribution_agent_properties** is used in snapshot replication and transactional replication.  
 ...
 When the Publisher runs on an instance of [!INCLUDE[ssVersion2005](../../analysis-services/data-mining/includes/ssversion2005-md.md)] or later version, you should use [sp_changesubscription](../../relational-databases/system-stored-procedures/sp-changesubscription-transact-sql.md) to change properties of a Merge Agent job that synchronizes a push subscription that runs at the Distributor.  
