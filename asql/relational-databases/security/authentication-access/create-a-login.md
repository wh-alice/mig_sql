...
[!INCLUDE[tsql-appliesto-ss2008-all_md](../../../a9retired/includes/tsql-appliesto-ss2008-all-md.md)]
  ...
  This topic describes how to create a login in [!INCLUDE[ssCurrent](../../../a9notintoc/includes/sscurrent-md.md)] or [!INCLUDE[ssSDS](../../../a9retired/includes/sssds-md.md)] by using [!INCLUDE[ssManStudioFull](../../../a9notintoc/includes/ssmanstudiofull-md.md)] or [!INCLUDE[tsql](../../../a9notintoc/includes/tsql-md.md)]. A login is the identity of the person or process that is connecting to an instance of [!INCLUDE[ssNoVersion](../../../a9notintoc/includes/ssnoversion-md.md)].  
  
##  <a name="Background"></a> Background  
 A login is a security principal, or an entity that can be authenticated by a secure system. Users need a login to connect to [!INCLUDE[ssNoVersion](../../../a9notintoc/includes/ssnoversion-md.md)]. You can create a login based on a Windows principal (such as a domain user or a Windows domain group) or you can create a login that is not based on a Windows principal (such as an [!INCLUDE[ssNoVersion](../../../a9notintoc/includes/ssnoversion-md.md)] login).  
  
> **NOTE:** To use [!INCLUDE[ssNoVersion](../../../a9notintoc/includes/ssnoversion-md.md)] Authentication, the [!INCLUDE[ssDE](../../../a9notintoc/includes/ssde-md.md)] must use mixed mode authentication. For more information, see [Choose an Authentication Mode](../../../relational-databases/security/choose-an-authentication-mode.md).  
  
 As a security principal, permissions can be granted to logins. The scope of a login is the whole [!INCLUDE[ssDE](../../../a9notintoc/includes/ssde-md.md)]. To connect to a specific database on the instance of [!INCLUDE[ssNoVersion](../../../a9notintoc/includes/ssnoversion-md.md)], a login must be mapped to a database user. Permissions inside the database are granted and denied to the database user, not the login. Permissions that have the scope of the whole instance of [!INCLUDE[ssNoVersion](../../../a9notintoc/includes/ssnoversion-md.md)] (for example, the **CREATE ENDPOINT** permission) can be granted to a login.  
  
> **NOTE:** When a login connects to [!INCLUDE[ssNoVersion](../../../a9notintoc/includes/ssnoversion-md.md)] the identify is validated at the master database. Use contained database users to authenticate [!INCLUDE[ssNoVersion](../../../a9notintoc/includes/ssnoversion-md.md)]r and [!INCLUDE[ssSDS](../../../a9retired/includes/sssds-md.md)] connections at the database level. When using contained database users a login is not necessary. A contained database is a database that is isolated from other databases and from the instance of [!INCLUDE[ssNoVersion](../../../a9notintoc/includes/ssnoversion-md.md)]/[!INCLUDE[ssSDS](../../../a9retired/includes/sssds-md.md)] (and the master database) that hosts the database. [!INCLUDE[ssNoVersion](../../../a9notintoc/includes/ssnoversion-md.md)] supports contained database users for both Windows and [!INCLUDE[ssNoVersion](../../../a9notintoc/includes/ssnoversion-md.md)] authentication. When using [!INCLUDE[ssSDS](../../../a9retired/includes/sssds-md.md)], combine contained database users with database level firewall rules. For more information, see [Contained Database Users - Making Your Database Portable](../../../relational-databases/security/contained-database-users-making-your-database-portable.md).  
  
##  <a name="Security"></a> Security  

 [!INCLUDE[ssNoVersion](../../../a9notintoc/includes/ssnoversion-md.md)] requires **ALTER ANY LOGIN** or **ALTER LOGIN** permission on the server.  
  
 [!INCLUDE[ssSDS](../../../a9retired/includes/sssds-md.md)] requires membership in the **loginmanager** role.  
...
5.  To create a login that is saved on a [!INCLUDE[ssNoVersion](../../../a9notintoc/includes/ssnoversion-md.md)] database, select **SQL Server authentication**.  
 ...
 **processadmin** check box  
 Members of the **processadmin** fixed server role can terminate processes running in an instance of the [!INCLUDE[ssDE](../../../a9notintoc/includes/ssde-md.md)].  
  
 **public** check box  
 All SQL Server users, groups, and roles belong to the **public** fixed server role by default.  
  
 **securityadmin** check box  
 Members of the **securityadmin** fixed server role manage logins and their properties. They can GRANT, DENY, and REVOKE server-level permissions. They can also GRANT, DENY, and REVOKE database-level permissions. Additionally, they can reset passwords for [!INCLUDE[ssNoVersion](../../../a9notintoc/includes/ssnoversion-md.md)] logins.  
 ...
 **sysadmin** check box  
 Members of the **sysadmin** fixed server role can perform any activity in the [!INCLUDE[ssDE](../../../a9notintoc/includes/ssde-md.md)].  
...
2.  In the **Add Objects** dialog box, select one of the following options: **Specific objects…**, **All objects of the types…**, or **The server***server_name*. [!INCLUDE[clickOK](../../../a9notintoc/includes/clickok-md.md)]  
...
3.  If you select **Specific objects…**:  
    ...
    2.  In the **Select Object Types** dialog box, select any or all of the following object types: **Endpoints**, **Logins**, **Servers**, **Availability Groups**, and **Server roles**. [!INCLUDE[clickOK](../../../a9notintoc/includes/clickok-md.md)]  
...
4.  If you select **All objects of the types…**, in the **Select Object Types** dialog box, select any or all of the following object types: **Endpoints**, **Logins**, **Servers**, **Availability Groups**, and **Server roles**. [!INCLUDE[clickOK](../../../a9notintoc/includes/clickok-md.md)]  
...
### Status  
 The **Status** page lists some of the authentication and authorization options that can be configured on the selected [!INCLUDE[ssNoVersion](../../../a9notintoc/includes/ssnoversion-md.md)] login.  
 ...
 **Login**  
 ...
 A login that has been disabled continues to exist as a record. But if it tries to connect to [!INCLUDE[ssNoVersion](../../../a9notintoc/includes/ssnoversion-md.md)], the login will not be authenticated.  
 ...
 **SQL Server Authentication**  
 The check box **Login is locked out** is only available if the selected login connects using [!INCLUDE[ssNoVersion](../../../a9notintoc/includes/ssnoversion-md.md)] Authentication and the login has been locked out. This setting is read-only. To unlock a login that is locked out, execute ALTER LOGIN with the UNLOCK option.  
...
##  <a name="FollowUp"></a> Follow Up: Steps to take after you create a login  
 After creating a login, the login can connect to [!INCLUDE[ssNoVersion](../../../a9notintoc/includes/ssnoversion-md.md)], but does not necessarily have sufficient permission to perform any useful work. The following list provides links to common login actions.  
