...
## Example  
 ...
 The second ([!INCLUDE[tsql](../../advanced-analytics/r-services/includes/tsql-md.md)]) code listing creates the assembly in the master database.  
 ...
 The fourth ([!INCLUDE[tsql](../../advanced-analytics/r-services/includes/tsql-md.md)]) code listing deletes the assembly from the master database.  
