...
1.  For each bound column, do the following:  
    ...
    -   Call [SQLBindCol](../../../relational-databases/extended-stored-procedures-reference/sqlbindcol.md) to bind the column's data value and data length arrays to the column of the rowset.  
...
4.  Each call to [SQLFetch](http://go.microsoft.com/fwlink/?LinkId=58401) or [SQLFetchScroll](../../../relational-databases/extended-stored-procedures-reference/sqlfetchscroll.md) retrieves R rows and transfers the data into the bound columns.  
...
3.  For each column in the result set, call [SQLBindCol](../../../relational-databases/extended-stored-procedures-reference/sqlbindcol.md) to point the data value and data length pointer of the column to their variables in the first element of the array of structures allocated in Step 1.  
  
4.  Execute the statement.  
  
5.  Each call to [SQLFetch](http://go.microsoft.com/fwlink/?LinkId=58401) or [SQLFetchScroll](../../../relational-databases/extended-stored-procedures-reference/sqlfetchscroll.md) retrieves R rows and transfers the data into the bound columns.  
