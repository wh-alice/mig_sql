...
-   Executing the UPDATETEXT statement  
     ...
     This statement is deprecated and will be removed in a future version of [!INCLUDE[ssNoVersion](../../../advanced-analytics/r-services/includes/ssnoversion-md.md)]. However, changes that are made by using the .WRITE clause of the UPDATE statement are tracked.  
...
## See Also  
 ...
 [CHANGE_TRACKING_IS_COLUMN_IN_MASK &#40;Transact-SQL&#41;](../../../relational-databases/reference/system-functions/change-tracking-is-column-in-mask-transact-sql.md)   
