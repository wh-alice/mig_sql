 ...
 **Process Account** cannot be specified for pull subscriptions to [!INCLUDE[msCoName](../../a9notintoc/includes/msconame-md.md)] [!INCLUDE[ssExpress](../../a9notintoc/includes/ssexpress-md.md)], because the Merge Agent does not run on instances of [!INCLUDE[ssExpress](../../a9notintoc/includes/ssexpress-md.md)].  
