 ...
 **-70Subscribers**  
 Must be used if any Subscribers are running [!INCLUDE[ssNoVersion](../../../advanced-analytics/r-services/includes/ssnoversion-md.md)] version 7.0.  
 ...
 **-DistributorLogin** *distributor_login*  
 Is the login used when connecting to the Distributor using [!INCLUDE[ssNoVersion](../../../advanced-analytics/r-services/includes/ssnoversion-md.md)] Authentication.  
  
 **-DistributorPassword** *distributor_password*  
 Is the password used when connecting to the Distributor using [!INCLUDE[ssNoVersion](../../../advanced-analytics/r-services/includes/ssnoversion-md.md)] Authentication. .  
 ...
 **-FieldDelimiter** *field_delimiter*  
 Is the character or character sequence that marks the end of a field in the [!INCLUDE[ssNoVersion](../../../advanced-analytics/r-services/includes/ssnoversion-md.md)] bulk-copy data file. The default is \n\<x$3>\n.  
 ...
 **-PacketSize** *packet_size*  
 Is the packet size (in bytes) used by the Snapshot Agent when connecting to [!INCLUDE[ssNoVersion](../../../advanced-analytics/r-services/includes/ssnoversion-md.md)]. The default value is 8192 bytes.  
 ...
 **-PublisherLogin** *publisher_login*  
 Is the login used when connecting to the Publisher using [!INCLUDE[ssNoVersion](../../../advanced-analytics/r-services/includes/ssnoversion-md.md)] Authentication.  
  
 **-PublisherPassword**  *publisher_password*  
 Is the password used when connecting to the Publisher using [!INCLUDE[ssNoVersion](../../../advanced-analytics/r-services/includes/ssnoversion-md.md)] Authentication. .  
 ...
 **-RowDelimiter** *row_delimiter*  
 Is the character or character sequence that marks the end of a row in the [!INCLUDE[ssNoVersion](../../../advanced-analytics/r-services/includes/ssnoversion-md.md)] bulk-copy data file. The default is \n\<,@g>\n.  
