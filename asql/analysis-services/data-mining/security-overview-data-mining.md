...
# Security Overview (Data Mining)
  The process of securing [!INCLUDE[msCoName](../../a9notintoc/includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../a9notintoc/includes/ssnoversion-md.md)] [!INCLUDE[ssASnoversion](../../a9notintoc/includes/ssasnoversion-md.md)] occurs at multiple levels. You must secure each instance of [!INCLUDE[ssASnoversion](../../a9notintoc/includes/ssasnoversion-md.md)] and its data sources to make sure that only authorized users have read or read/write permissions to selected dimensions, mining models, and data sources. You must also secure underlying data sources to prevent unauthorized users from maliciously compromising sensitive business information. The process of securing an instance of [!INCLUDE[ssASnoversion](../../a9notintoc/includes/ssasnoversion-md.md)] is described in the following topics.  
  
##  <a name="bkmk_Architecture"></a> Security Architecture  
 See the following resources to learn about the basic security architecture of an instance of [!INCLUDE[ssASnoversion](../../a9notintoc/includes/ssasnoversion-md.md)], including how [!INCLUDE[ssASnoversion](../../a9notintoc/includes/ssasnoversion-md.md)] uses [!INCLUDE[msCoName](../../a9notintoc/includes/msconame-md.md)] Windows Authentication to authenticate user access.  
...
##  <a name="bkmk_Instance"></a> Securing an Analysis Services Instance  
 Next you must secure the [!INCLUDE[ssASnoversion](../../a9notintoc/includes/ssasnoversion-md.md)] computer, the Windows operating system on the [!INCLUDE[ssASnoversion](../../a9notintoc/includes/ssasnoversion-md.md)] computer, [!INCLUDE[ssASnoversion](../../a9notintoc/includes/ssasnoversion-md.md)] itself, and the data sources that [!INCLUDE[ssASnoversion](../../a9notintoc/includes/ssasnoversion-md.md)] uses.  
