...
## Next Task  
You have successfully designed the child report by using the Report Wizard. Next, you will add a ReportViewer control to the website application. See [Lesson 6: Add a ReportViewer Control to the Application](../../reporting-services/tutorials/lesson-6-add-a-reportviewer-control-to-the-application.md).  
