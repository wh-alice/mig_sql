...
|NULL (default)|Automatically set to true for a [!INCLUDE[ssNoVersion](../../../a9notintoc/includes/ssnoversion-md.md)] Subscriber and false for a non-[!INCLUDE[ssNoVersion](../../../a9notintoc/includes/ssnoversion-md.md)] Subscriber.|  
...
|Value|Description|  
|-----------|-----------------|  
|0 (default)|[!INCLUDE[ssNoVersion](../../../a9notintoc/includes/ssnoversion-md.md)] Subscriber|  
|1|ODBC data source server|  
|2|[!INCLUDE[msCoName](../../../a9notintoc/includes/msconame-md.md)] Jet database|  
|3|OLE DB provider|  
...
## Example  
 [!code-sql[HowTo#sp_addtranpushsubscription_agent](../../../a9retired/codesnippet/tsql/sp-addsubscription-trans_1.sql)]  
