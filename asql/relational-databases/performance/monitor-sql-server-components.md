...
# Monitor SQL Server Components
 ...
 To monitor any component of [!INCLUDE[ssNoVersion](../../a9notintoc/includes/ssnoversion-md.md)] effectively:  
...
## Determine Your Monitoring Goals  
 To monitor [!INCLUDE[ssNoVersion](../../a9notintoc/includes/ssnoversion-md.md)] effectively you should clearly identify your reason for monitoring. Reasons can include the following:  
...
-   Task Manager  
 ...
 [!INCLUDE[ssNoVersion](../../a9notintoc/includes/ssnoversion-md.md)] provides the following tools for monitoring components of [!INCLUDE[ssNoVersion](../../a9notintoc/includes/ssnoversion-md.md)]:  
...
-   [!INCLUDE[ssManStudioFull](../../a9notintoc/includes/ssmanstudiofull-md.md)] Activity Monitor  
  
-   [!INCLUDE[ssManStudioFull](../../a9notintoc/includes/ssmanstudiofull-md.md)] Graphical Showplan  
...
-   Trace flags  
 ...
 For more information about [!INCLUDE[ssNoVersion](../../a9notintoc/includes/ssnoversion-md.md)] monitoring tools, see [Performance Monitoring and Tuning Tools](../../relational-databases/performance/performance-monitoring-and-tuning-tools.md).  
  
## Identify the Components to Monitor  
 The third step to monitoring an instance of [!INCLUDE[ssNoVersion](../../a9notintoc/includes/ssnoversion-md.md)] is to identify the components that you monitor. For example, if you are using [!INCLUDE[ssSqlProfiler](../../a9retired/includes/sssqlprofiler-md.md)] to trace a server you can define the trace to collect data about specific events. You can also exclude events that do not apply to your situation.  
