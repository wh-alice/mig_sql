...
|**Number of Deadlocks/sec**|Number of lock requests per second that resulted in a deadlock.|  
 ...
 [!INCLUDE[ssNoVersion](../../../advanced-analytics/r-services/includes/ssnoversion-md.md)] can lock these resources.  
