...
> [!NOTE]  
>  To view the current setting of this value for a full-text catalog, run the following [!INCLUDE[tsql](../../../a9notintoc/includes/tsql-md.md)] statement: `SELECT fulltextcatalogproperty('`*catalog_name*`', 'AccentSensitivity');`.  
