...
# Planning for Reporting Services
  Use these topics to better understand [!INCLUDE[msCoName](../advanced-analytics/r-services/tutorials/includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../advanced-analytics/r-services/includes/ssnoversion-md.md)] [!INCLUDE[ssRSnoversion](../advanced-analytics/r-services/includes/ssrsnoversion-md.md)]. Learn how to install and configure the [!INCLUDE[ssRSnoversion](../advanced-analytics/r-services/includes/ssrsnoversion-md.md)] environment to best fit your needs.  
 ...
 [Deployment Checklist: Install Reporting Services into an Existing SharePoint Farm](http://msdn.microsoft.com/en-US/library/hh231676(SQL.130).aspx)  
  
 [Deployment Topologies for SQL Server BI Features in SharePoint](http://msdn.microsoft.com/en-US/library/hh231674(SQL.130).aspx)  
