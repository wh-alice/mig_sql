...
-   Providing [!INCLUDE[tsql](../a9notintoc/includes/tsql-md.md)] statements in scripts, stored procedures, and triggers access to the data in a result set.  
  
## Concepts  
 Cursor Implementations  
 [!INCLUDE[ssNoVersion](../a9notintoc/includes/ssnoversion-md.md)] supports three cursor implementations.  
  
 Transact-SQL cursors  
 Are based on the DECLARE CURSOR syntax and are used mainly in [!INCLUDE[tsql](../a9notintoc/includes/tsql-md.md)] scripts, stored procedures, and triggers. [!INCLUDE[tsql](../a9notintoc/includes/tsql-md.md)] cursors are implemented on the server and are managed by [!INCLUDE[tsql](../a9notintoc/includes/tsql-md.md)] statements sent from the client to the server. They may also be contained in batches, stored procedures, or triggers.  
 ...
 [!INCLUDE[ssNoVersion](../a9notintoc/includes/ssnoversion-md.md)] static cursors are always read-only.  
  
 Because the result set of a static cursor is stored in a work table in **tempdb**, the size of the rows in the result set cannot exceed the maximum row size for a [!INCLUDE[ssNoVersion](../a9notintoc/includes/ssnoversion-md.md)] table.  
  
 [!INCLUDE[tsql](../a9notintoc/includes/tsql-md.md)] uses the term insensitive for static cursors. Some database APIs identify them as snapshot cursors.  
...
## Requesting a Cursor  
 [!INCLUDE[ssNoVersion](../a9notintoc/includes/ssnoversion-md.md)] supports two methods for requesting a cursor:  
  
-   [!INCLUDE[tsql](../a9notintoc/includes/tsql-md.md)]  
  
     The [!INCLUDE[tsql](../a9notintoc/includes/tsql-md.md)] language supports a syntax for using cursors modeled after the ISO cursor syntax.  
  
-   Database application programming interface (API) cursor functions  
  
     [!INCLUDE[ssNoVersion](../a9notintoc/includes/ssnoversion-md.md)] supports the cursor functionality of these database APIs:  
  
    -   ADO ([!INCLUDE[msCoName](../a9notintoc/includes/msconame-md.md)] ActiveX Data Object)  
 ...
 If neither a [!INCLUDE[tsql](../a9notintoc/includes/tsql-md.md)] nor API cursor has been requested, [!INCLUDE[ssNoVersion](../a9notintoc/includes/ssnoversion-md.md)] defaults to returning a complete result set, known as a default result set, to the application.  
  
## Cursor Process  
 [!INCLUDE[tsql](../a9notintoc/includes/tsql-md.md)] cursors and API cursors have different syntax, but the following general process is used with all [!INCLUDE[ssNoVersion](../a9notintoc/includes/ssnoversion-md.md)] cursors:  
  
1.  Associate a cursor with the result set of a [!INCLUDE[tsql](../a9notintoc/includes/tsql-md.md)] statement, and define characteristics of the cursor, such as whether the rows in the cursor can be updated.  
  
2.  Execute the [!INCLUDE[tsql](../a9notintoc/includes/tsql-md.md)] statement to populate the cursor.  
...
## See Also  
 ...
 [Cursor Stored Procedures &#40;Transact-SQL&#41;](../relational-databases/reference/system-stored-procedures/cursor-stored-procedures-transact-sql.md)  
