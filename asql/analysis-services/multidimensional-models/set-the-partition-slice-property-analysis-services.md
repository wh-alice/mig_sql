...
> [!NOTE]  
>  Note that dynamic MDX functions (such as [Generate &#40;MDX&#41;](../../mdx/generate-mdx.md) or [Except &#40;MDX&#41;](../Topic/Except%20\(MDX\).md)) are not supported in the Slice property for partitions. You must define the slice by using explicit tuples or member references.  
>   
