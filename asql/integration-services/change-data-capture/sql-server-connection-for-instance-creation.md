...
-   **SQL Server Authentication**: If you select this option, you must type the **Login** and **Password** for the user in the [!INCLUDE[ssNoVersion](../../a9notintoc/includes/ssnoversion-md.md)] you are connecting to.  
