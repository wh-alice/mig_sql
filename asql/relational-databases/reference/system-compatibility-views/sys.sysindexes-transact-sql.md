...
[!INCLUDE[tsql-appliesto-ss2012-xxxx-xxxx-xxx_md](../../../integration-services/system/stored-procedures/includes/tsql-appliesto-ss2012-xxxx-xxxx-xxx-md.md)]
  ...
  Contains one row for each index and table in the current database. XML indexes are not supported in this view. Partitioned tables and indexes are not fully supported in this view; use the [sys.indexes](../../../relational-databases/reference/system-catalog-views/sys.indexes-transact-sql.md) catalog view instead.  
...
|**status**|**int**|System-status information.<br /><br /> [!INCLUDE[ssInternalOnly](../../../integration-services/data-flow/transformations/includes/ssinternalonly-md.md)]|  
...
|**rowmodctr**|**int**|Counts the total number of inserted, deleted, or updated rows since the last time statistics were updated for the table.<br /><br /> 0 = Index is partitioned when **indid** > 1.<br /><br /> 0 = Table is partitioned when **indid** is 0 or 1.<br /><br /> In [!INCLUDE[ssVersion2005](../../../analysis-services/data-mining/includes/ssversion2005-md.md)] and later, **rowmodctr** is not fully compatible with earlier versions. For more information, see Remarks.|  
|**reserved3**|**int**|Returns 0.<br /><br /> [!INCLUDE[ssInternalOnly](../../../integration-services/data-flow/transformations/includes/ssinternalonly-md.md)]|  
|**reserved4**|**int**|Returns 0.<br /><br /> [!INCLUDE[ssInternalOnly](../../../integration-services/data-flow/transformations/includes/ssinternalonly-md.md)]|  
|**xmaxlen**|**smallint**|Maximum size of a row|  
|**maxirow**|**smallint**|Maximum size of a nonleaf index row.<br /><br /> In [!INCLUDE[ssVersion2005](../../../analysis-services/data-mining/includes/ssversion2005-md.md)] and later, **maxirow** is not fully compatible with earlier versions.|  
...
|**StatVersion**|**tinyint**|Returns 0.<br /><br /> [!INCLUDE[ssInternalOnly](../../../integration-services/data-flow/transformations/includes/ssinternalonly-md.md)]|  
|**reserved2**|**int**|Returns 0.<br /><br /> [!INCLUDE[ssInternalOnly](../../../integration-services/data-flow/transformations/includes/ssinternalonly-md.md)]|  
|**FirstIAM**|**binary(6)**|NULL = Index is partitioned.<br /><br /> [!INCLUDE[ssInternalOnly](../../../integration-services/data-flow/transformations/includes/ssinternalonly-md.md)]|  
|**impid**|**smallint**|Index implementation flag.<br /><br /> Returns 0.<br /><br /> [!INCLUDE[ssInternalOnly](../../../integration-services/data-flow/transformations/includes/ssinternalonly-md.md)]|  
...
|**pgmodctr**|**int**|Returns 0.<br /><br /> [!INCLUDE[ssInternalOnly](../../../integration-services/data-flow/transformations/includes/ssinternalonly-md.md)]|  
|**keys**|**varbinary(816)**|List of the column IDs of the columns that make up the index key.<br /><br /> Returns NULL.<br /><br /> To display the index key columns, use [sys.sysindexkeys](../../../relational-databases/reference/system-compatibility-views/sys.sysindexkeys-transact-sql.md).|  
...
|**maxlen**|**int**|[!INCLUDE[ssInternalOnly](../../../integration-services/data-flow/transformations/includes/ssinternalonly-md.md)]|  
