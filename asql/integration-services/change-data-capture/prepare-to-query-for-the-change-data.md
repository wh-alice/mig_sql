...
# Prepare to Query for the Change Data
  In the control flow of an [!INCLUDE[ssISnoversion](../../a9notintoc/includes/ssisnoversion-md.md)] package that performs an incremental load of change data, the third and final task is to prepare to query for the change data and add a Data Flow task.  
...
-   In [!INCLUDE[ssBIDevStudioFull](../../a9notintoc/includes/ssbidevstudiofull-md.md)], in the **Variables** window, create a variable with a string data type to hold the query string returned by the Execute SQL Task.  
...
4.  In the Main procedure, enter one of the following code segments:  
    ...
    -   If you are programming in [!INCLUDE[vbprvb](../../a9retired/includes/vbprvb-md.md)], enter the following lines of code:  
