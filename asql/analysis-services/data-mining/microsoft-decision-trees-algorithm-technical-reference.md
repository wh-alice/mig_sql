...
|4|Bayesian Dirichlet Equivalent (BDE) with uniform prior<br /><br /> (default)|  
 ...
 For an explanation of these scoring methods, see [Feature Selection](../Topic/Feature%20Selection.md).  
