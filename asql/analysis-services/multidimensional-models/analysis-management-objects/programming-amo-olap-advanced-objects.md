...
-   Reporting actions, which return a report from [!INCLUDE[ssRSnoversion](../../../advanced-analytics/r-services/includes/ssrsnoversion-md.md)] that is associated with the selected section of the cube where the action occurs.  
...
3.  When you browse KPIs in [!INCLUDE[ssBIDevStudioFull](../../../analysis-services/includes/ssbidevstudiofull-md.md)], values less than -1 are treated as -1, and values larger than 1 are treated as 1.  
...
4.  Define graphic images.  
    ...
    -   Good = 0.50 to 1  
     ...
     In [!INCLUDE[ssBIDevStudioFull](../../../analysis-services/includes/ssbidevstudiofull-md.md)], five states within the range are as follows:  
...
1.  Add the KPI to the cube collection and update the cube, because the KPI is not an updatable object.  
 ...
 Testing the KPI requires a different program application. You can test your KPI in [!INCLUDE[ssBIDevStudioFull](../../../analysis-services/includes/ssbidevstudiofull-md.md)].  
...
3.  Add the perspective to the cube collection and update the cube, because perspective is not an updatable object.  
 ...
 Testing the perspective requires a different program application. You can test your perspective in [!INCLUDE[ssBIDevStudioFull](../../../analysis-services/includes/ssbidevstudiofull-md.md)].  
