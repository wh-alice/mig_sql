...
[!INCLUDE[tsql-appliesto-ss2016-asdb-xxxx-xxx_md](../../../a9notintoc/includes/tsql-appliesto-ss2016-asdb-xxxx-xxx-md.md)]
  ...
  Gets the **stmt_sql_handle** for a [!INCLUDE[tsql](../../../a9notintoc/includes/tsql-md.md)] statement under given parameterization type (simple or forced). This allows you to refer to queries stored in the Query Store by using their **stmt_sql_handle** when you know their text.  
...
|**query_sql_text**|**nvarchar(max)**|The text of the [!INCLUDE[tsql](../../../a9notintoc/includes/tsql-md.md)] statement.|  
