...
> [!NOTE]  
>  The **Parameter Info** option is available only for the [!INCLUDE[ssDE](../../analysis-services/instances/install/windows/includes/ssde-md.md)] Query Editor and the XML Query Editor.  
