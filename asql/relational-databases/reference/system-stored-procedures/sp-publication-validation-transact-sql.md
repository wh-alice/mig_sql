...
|Value|Description|  
|-----------|-----------------|  
|**0**|Perform a [!INCLUDE[ssNoVersion](../../../a9notintoc/includes/ssnoversion-md.md)] 7.0 compatible checksum.<br /><br /> Note: When an article is horizontally filtered, a rowcount operation is performed instead of a checksum operation.|  
|**1** (default)|Perform a rowcount check only.|  
|**2**|Perform a rowcount and binary checksum.<br /><br /> Note: For [!INCLUDE[ssNoVersion](../../../a9notintoc/includes/ssnoversion-md.md)] version 7.0 Subscribers, only a rowcount validation is performed.|  
...
|**1**|Does fast count from **sysindexes.rows**. Counting rows in [sys.sysindexes](../../../relational-databases/reference/system-compatibility-views/sys.sysindexes-transact-sql.md) is much faster than counting rows in the actual table. However, because [sys.sysindexes](../../../relational-databases/reference/system-compatibility-views/sys.sysindexes-transact-sql.md) is lazily updated, the rowcount may not be accurate.|  
...
> [!NOTE]  
>  *publisher* should not be used when requesting validation on a [!INCLUDE[ssNoVersion](../../../a9notintoc/includes/ssnoversion-md.md)] Publisher.  
...
## See Also  
 ...
 [sp_article_validation &#40;Transact-SQL&#41;](../../../relational-databases/reference/system-stored-procedures/sp-article-validation-transact-sql.md)   
