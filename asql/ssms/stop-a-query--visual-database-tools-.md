...
-   Right-click anywhere in the [Results pane](../ssms/results-pane--visual-database-tools-.md), on the shortcut menu point to **Pane**, and then click **Clear Results**.  
  
## See Also  
[Clear Query Results &#40;Visual Database Tools&#41;](../ssms/clear-query-results--visual-database-tools-.md)  
