...
4.  On the design surface of the **Control Flow** tab, right-click the task or container, and then click **Edit** to open the corresponding task or container editor.  
     ...
     For information about how to configure the For Loop container, see [Configure a For Loop Container](http://msdn.microsoft.com/en-US/library/ms141194(SQL.130).aspx).  
  
     For information about how to configure the Foreach Loop container, see [Configure a Foreach Loop Container](http://msdn.microsoft.com/en-US/library/ms140016(SQL.130).aspx).  
