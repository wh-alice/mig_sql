...
|Backup and Data File Location|[Backup Files Must Be on Separate Devices from the Database Files](../../a9retired/backup-files-must-be-on-separate-devices-from-the-database-files.md)|  
...
|Database Collation|[Set the Collation of User-defined Databases to Match Those of the master and model Databases](../../a9retired/c686446f-dae1-4b05-a3df-837b3422988d.md)|  
