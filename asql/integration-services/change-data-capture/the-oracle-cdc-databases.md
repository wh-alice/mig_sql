...
# The Oracle CDC Databases
  An Oracle CDC Instance is associated with a [!INCLUDE[ssNoVersion](../../a9notintoc/includes/ssnoversion-md.md)] database by the same name on the target [!INCLUDE[ssNoVersion](../../a9notintoc/includes/ssnoversion-md.md)] instance. This database is called the Oracle CDC database (or the CDC database).  
...
## CDC Database User Roles  
 When a CDC Database is created and enabled for CDC, a database user called **cdc_service** is created in the CDC database and is associated with the [!INCLUDE[ssNoVersion](../../a9notintoc/includes/ssnoversion-md.md)] login that the Oracle CDC Service was configured with. This user is made a member of the **db_datareader**, **db_datawriter**, and **db_ddladmin** database roles. If the [!INCLUDE[ssNoVersion](../../a9notintoc/includes/ssnoversion-md.md)] login is also the associated with the `dbo` user then the **cdc_service** is not created.  
...
## Access to Change Data  
 Because of the [!INCLUDE[ssNoVersion](../../a9notintoc/includes/ssnoversion-md.md)] security model used to gain access to the change data that is associated with a capture instance, the user must be granted `select` access to all the captured columns of the associated mirror table (access permissions to the original Oracle tables do not provide access to the change tables in [!INCLUDE[ssNoVersion](../../a9notintoc/includes/ssnoversion-md.md)]). For information on the [!INCLUDE[ssNoVersion](../../a9notintoc/includes/ssnoversion-md.md)] security model, see [Security Model](http://go.microsoft.com/fwlink/?LinkId=231151).  
 ...
 Accessing CDC data through the [!INCLUDE[ssISnoversion](../../a9notintoc/includes/ssisnoversion-md.md)] CDC Source component is subject to the same rules.  
...
|sql_reconnect_interval|2|2|3600|False|The amount of time (in seconds) to wait before reconnecting to [!INCLUDE[ssNoVersion](../../a9notintoc/includes/ssnoversion-md.md)]. This interval is used in addition to [!INCLUDE[ssNoVersion](../../a9notintoc/includes/ssnoversion-md.md)] client’s connect timeout.|  
|sql_reconnect_limit|-1|-1|-1|False|The maximum number of [!INCLUDE[ssNoVersion](../../a9notintoc/includes/ssnoversion-md.md)] reconnections. The default -1 means that the process tries to reconnect until it stops.|  
...
|target_command_timeout|600|1|3600|False|Command timeout working with [!INCLUDE[ssNoVersion](../../a9notintoc/includes/ssnoversion-md.md)].|  
...
|source_connection_timeout|30|1|3600|False|Connection timeout working with [!INCLUDE[ssNoVersion](../../a9notintoc/includes/ssnoversion-md.md)].|  
...
|written_changes|The number of change records written to the [!INCLUDE[ssNoVersion](../../a9notintoc/includes/ssnoversion-md.md)] change tables.|  
