...
-   There is reduced development time. Because functionality is available in [!INCLUDE[ssCurrent](../../a9notintoc/includes/sscurrent-md.md)], you do not have to develop a custom solution.  
...
-   Standard tools are available that you can use to configure and manage. [!INCLUDE[ssCurrent](../../a9notintoc/includes/sscurrent-md.md)] provides standard DDL statements, [!INCLUDE[ssManStudioFull](../../a9notintoc/includes/ssmanstudiofull-md.md)], catalog views, and security permissions.  
...
1.  Ensure that [!INCLUDE[ssNoVersion](../../a9notintoc/includes/ssnoversion-md.md)] Agent is running on the mirror.  
...
#### Restoring or Attaching a Database Enabled for Change Data Capture  
 [!INCLUDE[ssNoVersion](../../a9notintoc/includes/ssnoversion-md.md)] uses the following logic to determine if change data capture remains enabled after a database is restored or attached:  
...
-   If a database is attached or restored with the **KEEP_CDC** option to any edition other than Enterprise, the operation is blocked because change data capture requires [!INCLUDE[ssNoVersion](../../a9notintoc/includes/ssnoversion-md.md)] Enterprise. Error message 932 is displayed:  
...
-   [About Change Tracking &#40;SQL Server&#41;](../../relational-databases/track-changes/about-change-tracking-sql-server.md)  
     ...
     Describes change tracking, provides a high-level overview of how change tracking works, and describes how change tracking interacts with other [!INCLUDE[ssDEnoversion](../../a9notintoc/includes/ssdenoversion-md.md)] features.  
