...
## Arguments  
 *cursor*  
 Is a cursor *handle* value generated by [!INCLUDE[ssNoVersion](../../../advanced-analytics/r-services/includes/ssnoversion-md.md)] and returned by the sp_cursoropen procedure. *cursor* is a required parameter that calls for an **int** input value.  
