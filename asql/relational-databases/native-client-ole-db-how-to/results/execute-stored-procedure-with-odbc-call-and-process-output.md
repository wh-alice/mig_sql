...
## Example  
 ...
 Execute the first ([!INCLUDE[tsql](../../../advanced-analytics/r-services/includes/tsql-md.md)]) code listing to create the stored procedure used by the application.  
 ...
 Execute the third ([!INCLUDE[tsql](../../../advanced-analytics/r-services/includes/tsql-md.md)]) code listing to delete the stored procedure used by the application.  
