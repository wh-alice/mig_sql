...
|[SQL Server Extended Events Targets](http://msdn.microsoft.com/en-US/library/bb630339(SQL.130).aspx)|Describes the event consumers that can receive data during an event session.|  
...
-   Events are separated from event consumers, which are called *targets* in Extended Events. This means that any target can receive any event. In addition, any event that is raised can be automatically consumed by the target, which can log or provide additional event context. For more information, see [SQL Server Extended Events Targets](http://msdn.microsoft.com/en-US/library/bb630339(SQL.130).aspx).  
...
|Describes how to create an Extended Events session.|[Create an Extended Events Session](http://msdn.microsoft.com/en-US/library/hh213147(SQL.130).aspx)|  
...
|Describes how to get information about the fields associated with the events.|[Get the Fields for All Events](http://msdn.microsoft.com/en-US/library/bb677249(SQL.130).aspx)|  
|Describes how to find out what events are available in the registered packages.|[View the Events for Registered Packages](http://msdn.microsoft.com/en-US/library/bb677307(SQL.130).aspx)|  
|Describes how to determine what Extended Events targets are available in the registered packages.|[View the Extended Events Targets for Registered Packages](http://msdn.microsoft.com/en-US/library/bb677247(SQL.130).aspx)|  
...
|Describes how to find the parameters you can set when you use the ADD TARGET argument in CREATE EVENT SESSION or ALTER EVENT SESSION.|[Get the Configurable Parameters for the ADD TARGET Argument](http://msdn.microsoft.com/en-US/library/bb677176(SQL.130).aspx)|  
