...
[!INCLUDE[SNAC_Deprecated](../../a9retired/includes/snac-deprecated.md)]
  ...
  The following table lists issues to consider when you convert from [!INCLUDE[ssNoVersion](../../a9notintoc/includes/ssnoversion-md.md)] date/time types to C types.  
...
|1|Rules prior to [!INCLUDE[ssKatmai](../../a9notintoc/includes/sskatmai-md.md)] apply.|  
