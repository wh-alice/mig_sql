...
## What's new in [!INCLUDE[ssASCurrent](../a9notintoc/includes/ssascurrent-md.md)]
...
In addition to installing a [!INCLUDE[ssASCurrent](../a9notintoc/includes/ssascurrent-md.md)] instance, in order to take full advantage of all the enhancements in this release, be sure to install the latest versions of SSDT and SSMS.    
...
## Developer    
 ...
 Similarly, PowerShell scripts that load and call into AMO must now load Microsoft.AnalysisServices.Core.dll. Be sure to update any scripts prior to pointing them to [!INCLUDE[ssASCurrent_md](../a9notintoc/includes/ssascurrent-md.md)].    
