...
## Analyze XML validation output with a Transact-SQL query  
 If the output of XML validation contains a large number of errors, you can use a [!INCLUDE[tsql](../../a9notintoc/includes/tsql-md.md)] query to load the output in [!INCLUDE[ssManStudioFull](../../a9notintoc/includes/ssmanstudiofull-md.md)]. Then you can analyze the error list with all the capabilities of the T-SQL language including WHERE, GROUP BY, ORDER BY, JOIN, and so forth.  
...
```  
 ...
 Here is the result in [!INCLUDE[ssManStudio](../../a9notintoc/includes/ssmanstudio-md.md)] of the second sample query shown in the preceding text.  
