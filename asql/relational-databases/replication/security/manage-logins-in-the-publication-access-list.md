...
-   You must associate the [!INCLUDE[ssNoVersion](../../../a9notintoc/includes/ssnoversion-md.md)] login with a database user in the publication database before you add the login to the PAL.  
