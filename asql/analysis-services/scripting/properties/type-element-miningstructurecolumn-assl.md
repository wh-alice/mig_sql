...
|Value|Description|  
|-----------|-----------------|  
|*Long*|A 64-bit signed integer. This data type maps to the **Int64** data type in the [!INCLUDE[msCoName](../../../a9notintoc/includes/msconame-md.md)] .NET Framework and the DBTYPE_I8 data type in OLE DB.|  
