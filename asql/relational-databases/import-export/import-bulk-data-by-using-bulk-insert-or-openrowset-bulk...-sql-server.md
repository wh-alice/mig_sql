...
[!INCLUDE[tsql-appliesto-ss2008-asdb-xxxx-xxx_md](../../relational-databases/import-export/includes/tsql-appliesto-ss2008-asdb-xxxx-xxx-md.md)]
  ...
  This topic provides an overview of how to use the [!INCLUDE[tsql](../../a9notintoc/includes/tsql-md.md)] BULK INSERT statement and the INSERT...SELECT * FROM OPENROWSET(BULK...) statement to bulk import data from a data file into a [!INCLUDE[ssNoVersion](../../a9notintoc/includes/ssnoversion-md.md)] table. This topic also describes security considerations for using BULK INSERT and OPENROWSET(BULK…), and using these methods to bulk import from a remote data source.  
  
> **NOTE** When you use BULK INSERT or OPENROWSET(BULK…), it is important to understand how [!INCLUDE[ssNoVersion](../../a9notintoc/includes/ssnoversion-md.md)] version handles impersonation. For more information, see "Security Considerations," later in this topic.  
...
**Applies to:** `OPENROWSET` is not available in [!INCLUDE[ssSDS_md](../../a9retired/includes/sssds-md.md)].
...
> **NOTE** This restriction does not apply to the **bcp** utility because the client reads the file independently of [!INCLUDE[ssNoVersion](../../a9notintoc/includes/ssnoversion-md.md)].  
