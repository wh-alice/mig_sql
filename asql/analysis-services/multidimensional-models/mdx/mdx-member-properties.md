...
> [!NOTE]  
>  In [!INCLUDE[msCoName](../../../advanced-analytics/r-services/tutorials/includes/msconame-md.md)][!INCLUDE[ssNoVersion](../../../advanced-analytics/r-services/includes/ssnoversion-md.md)], member properties are know as attribute relationships. For more information, see [Attribute Relationships](../../../analysis-services/multidimensional-models-olap-logical-dimension-objects/attribute-relationships.md).  
 ...
 For more information, see [Intrinsic Member Properties &#40;MDX&#41;](../Topic/Intrinsic%20Member%20Properties%20\(MDX\).md).  
 ...
 For more information, see [User-Defined Member Properties &#40;MDX&#41;](../Topic/User-Defined%20Member%20Properties%20\(MDX\).md).  
...
> [!NOTE]  
>  For more information about the `<set>` and `<axis_name>` values, see [Specifying the Contents of a Query Axis &#40;MDX&#41;](../Topic/Specifying%20the%20Contents%20of%20a%20Query%20Axis%20\(MDX\).md).  
...
-   User-defined member properties should be preceded by the name of the level in which they reside. For more information about how to use the **PROPERTIES** keyword with user-defined member properties, see [User-Defined Member Properties &#40;MDX&#41;](../Topic/User-Defined%20Member%20Properties%20\(MDX\).md).  
