...
# Microsoft Time Series Algorithm Technical Reference
  The [!INCLUDE[msCoName](../../a9notintoc/includes/msconame-md.md)] Time Series algorithm includes two separate algorithms for analyzing time series:  
  
-   The ARTXP algorithm, which was introduced in [!INCLUDE[ssVersion2005](../../a9notintoc/includes/ssversion2005-md.md)], is optimized for predicting the next likely value in a series.  
  
-   The ARIMA algorithm was added in [!INCLUDE[ssKatmai](../../a9notintoc/includes/sskatmai-md.md)] to improve accuracy for long-term prediction.  
...
## Customizing the Microsoft Time Series Algorithm  
 The [!INCLUDE[msCoName](../../a9notintoc/includes/msconame-md.md)] Time Series algorithm supports the following parameters that affect the behavior, performance, and accuracy of the resulting mining model.  
...
-   Set the *FORECAST_METHOD* to ARIMA if you want to improve long-term prediction.  
 ...
 In Enterprise Edition, you can also customize how [!INCLUDE[ssASnoversion](../../a9notintoc/includes/ssasnoversion-md.md)] mixes the combination of the ARIMA and ARTXP algorithms. You can control both the starting point for the mixture, and the rate of change by setting the *PREDICTION_SMOOTHING* parameter:  
...
### Setting Algorithm Parameters  
 The following table describes the parameters that can be used with the [!INCLUDE[msCoName](../../a9notintoc/includes/msconame-md.md)] Time Series algorithm.  
...
|*HISTORIC_MODEL_COUNT*|Specifies the number of historic models that will be built. The default is 1.<br /><br /> Note: This parameter is only available in some editions of [!INCLUDE[ssNoVersion](../../a9notintoc/includes/ssnoversion-md.md)].|  
...
### Input and Predictable Columns  
 The [!INCLUDE[msCoName](../../a9notintoc/includes/msconame-md.md)] Time Series algorithm supports the specific input column content types, predictable column content types, and modeling flags that are listed in the following table.  
