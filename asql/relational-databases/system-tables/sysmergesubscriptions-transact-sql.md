...
|datasource_type|**int**|The type of data source:<br /><br /> **0** = [!INCLUDE[msCoName](../../advanced-analytics/r-services/tutorials/includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../advanced-analytics/r-services/includes/ssnoversion-md.md)].<br /><br /> **2** = Jet OLE DB.|  
