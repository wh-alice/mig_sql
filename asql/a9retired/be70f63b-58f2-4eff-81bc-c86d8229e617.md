...
ms.topic: "reference"
f1_keywords: 
  - "sql13.asvs.cubeeditor.cubebuilder.measurespane.f1"
 ...
 **Properties**  
 Select to display the **Properties** window of [!INCLUDE[ssBIDevStudioFull](../a9notintoc/includes/ssbidevstudiofull-md.md)] for the selected measure group or measure.  
