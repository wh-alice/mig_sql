...
+ You must install the database engine on each instance where you will use R Services (In-Database) in [!INCLUDE[ssCurrent](../../a9notintoc/includes/sscurrent-md.md)].  
...
## Perform an Unattended Install of R Services (In-Database)  
 The following example shows the **minimum** required features to specify in the command line when performing a silent, unattended install of R Services in [!INCLUDE[ssCurrent](../../a9notintoc/includes/sscurrent-md.md)].  
...
2.  After installation is complete, in [!INCLUDE[ssManStudioFull](../../a9notintoc/includes/ssmanstudiofull-md.md)], run the following command to enable the feature.  
...
3.  Restart the [!INCLUDE[ssNoVersion](../../a9notintoc/includes/ssnoversion-md.md)] instance. This will automatically restart the related [!INCLUDE[rsql_launchpad](../../a9notintoc/includes/rsql-launchpad-md.md)] service as well.  
