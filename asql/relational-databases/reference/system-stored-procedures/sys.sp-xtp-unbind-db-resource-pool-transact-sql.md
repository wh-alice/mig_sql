...
## Example  
 The following code unbinds the database Hekaton_DB from the [!INCLUDE[hek_2](../../../a9retired/includes/hek-2-md.md)] resource pool it is bound to.  If Hekaton_DB is not currently bound to a [!INCLUDE[hek_2](../../../a9retired/includes/hek-2-md.md)] resource pool, a message is given. The database must be restarted for the unbinding to take effect.  
...
-   The database specified by `database_name` must have a binding to an [!INCLUDE[hek_2](../../../a9retired/includes/hek-2-md.md)] resource pool.  
