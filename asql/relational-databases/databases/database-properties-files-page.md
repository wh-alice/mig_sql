 ...
 **Use full-text indexing**  
 This check box is checked and disabled because full-text indexing is always enabled in [!INCLUDE[ssCurrent](../../a9notintoc/includes/sscurrent-md.md)]. For more information, see [Full-Text Search](../../relational-databases/search/full-text-search.md).  
 ...
 **Path**  
 ...
 For FILESTREAM files, the path is a folder. The [!INCLUDE[ssDEnoversion](../../a9notintoc/includes/ssdenoversion-md.md)] will create the underlying files in this folder.  
