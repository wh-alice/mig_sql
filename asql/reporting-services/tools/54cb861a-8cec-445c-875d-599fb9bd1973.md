...
# URL Examples for Published Report Items on a Report Server in SharePoint Mode (SSRS)
  To publish reports and related items to a SharePoint library, you can either publish the content using the [!INCLUDE[ssRSnoversion](../../a9notintoc/includes/ssrsnoversion-md.md)] authoring tools such as Report Designer or you can upload the content by using SharePoint site actions.  
...
### URL for a SharePoint Server  
 You must use a URL to the SharePoint server when you deploy a Report Server or Report Model project from [!INCLUDE[ssBIDevStudioFull](../../a9notintoc/includes/ssbidevstudiofull-md.md)] to the report server.  
 ...
 Using the [!INCLUDE[ssRSnoversion](../../a9notintoc/includes/ssrsnoversion-md.md)] URL proxy endpoint is not supported. A proxy endpoint includes a port number, for example, http:*//servername:8080/reportserver*.  
...
### URL for a SharePoint Library  
 ...
 On [!INCLUDE[msCoName](../../a9notintoc/includes/msconame-md.md)] [!INCLUDE[winSPServ](../../relational-databases/tables/includes/winspserv-md.md)] 3.0 or [!INCLUDE[SPF2010](../../a9retired/includes/spf2010-md.md)], the library appears after the server name, for example, http://*servername/*Shared Documents.  
  
 On [!INCLUDE[offSPServ](../../a9retired/includes/offspserv-md.md)] 2007 or [!INCLUDE[SPS2010](../../a9retired/includes/sps2010-md.md)], the library appears after the site and subsite. For example, http://*servername/site/*Documents.  
...
|The Company Sales sample report in **Shared Documents** on a [!INCLUDE[winSPServ](../../relational-databases/tables/includes/winspserv-md.md)] or [!INCLUDE[SPF2010](../../a9retired/includes/spf2010-md.md)] deployment.|http://TestServer/TestSite/Shared%20Documents/Company%20Sales.rdl|  
|The Company Sales sample report in **Documents/Doc** folder on a [!INCLUDE[offSPServ](../../a9retired/includes/offspserv-md.md)] or [!INCLUDE[SPS2010](../../a9retired/includes/sps2010-md.md)] instance.|http://TestServer/TestSite/Documents/Doc/Company%20Sales.rdl|  
|The Company Sales sample report in **Report Center** on an [!INCLUDE[offSPServ](../../a9retired/includes/offspserv-md.md)] or [!INCLUDE[SPS2010](../../a9retired/includes/sps2010-md.md)] instance.|http://TestServer/TestSite/Reports/Doc/Company%20Sales.rdl|  
...
> [!NOTE]  
>  In order to publish reports to a SharePoint site from [!INCLUDE[ssBIDevStudioFull](../../a9notintoc/includes/ssbidevstudiofull-md.md)], you might need to add the SharePoint site to your list of trusted locations in the Internet Explorer browser.  
  
### Shared Data Sources  
 When you publish a shared data source from a report authoring tool, you set the project property **TargetDataSourceFolder**. The target data source folder must be a URL to a SharePoint library. Unlike in [!INCLUDE[ssRSnoversion](../../a9notintoc/includes/ssrsnoversion-md.md)] native mode, you cannot specify a relative folder; relative paths are not valid. If a folder in the Document Library path does not exist, one will be created.  
...
#### Shared Data Sources from Report Designer  
 If you are publishing shared data sources from a Report Designer project, you can either use a URL that specifies the target library or you can leave the property blank. Unlike in [!INCLUDE[ssRSnoversion](../../a9notintoc/includes/ssrsnoversion-md.md)] native mode, you cannot specify a relative folder; relative paths are not valid. If a folder in the Document Library path does not exist, one will be created. If you leave the target data source folder blank, the data source will be published in the target report folder.  
