...
# Executing XPath Queries with Namespaces (SQLXML Managed Classes)
 ...
 Because the wildcard character (*) is not supported in [!INCLUDE[msCoName](../../../a9notintoc/includes/msconame-md.md)] SQLXML 4.0, you must specify the XPath query by using a namespace prefix. To resolve the prefix, use the namespaces property to specify the namespace binding.  
