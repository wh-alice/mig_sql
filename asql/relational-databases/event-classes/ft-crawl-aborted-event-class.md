...
# FT:Crawl Aborted Event Class
  The **FT:Crawl Aborted** event class indicates that an exception has been encountered during a full-text crawl. The error usually causes the full-text crawl to stop. Check the [!INCLUDE[msCoName](../../a9notintoc/includes/msconame-md.md)] Windows event log or the crawl log for more detailed error information.  
