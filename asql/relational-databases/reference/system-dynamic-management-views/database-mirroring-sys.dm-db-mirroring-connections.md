...
|**transport_stream_id**|**uniqueidentifier**|Identifier of the [!INCLUDE[ssNoVersion](../../../advanced-analytics/r-services/includes/ssnoversion-md.md)] Network Interface (SNI) connection used by this connection for TCP/IP communications.|  
...
## Physical Joins  
 ![join for sys.join_dm_db_mirroring_connections](../../../relational-databases/reference/system-dynamic-management-views/media/join-dm-db-mirroring-connections.gif "join for sys.join_dm_db_mirroring_connections")  
