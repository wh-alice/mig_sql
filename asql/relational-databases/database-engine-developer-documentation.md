...
# Database Engine Developer Documentation
  [!INCLUDE[ssNoVersion](../a9notintoc/includes/ssnoversion-md.md)] provides a rich set of tools for developing, administering, and controlling database applications.  
...
## In This Section  
 ...
 Describes the integration of the common language runtime (CLR) component of the .NET Framework for [!INCLUDE[msCoName](../a9notintoc/includes/msconame-md.md)] Windows in [!INCLUDE[ssNoVersion](../a9notintoc/includes/ssnoversion-md.md)]. This means that you can write stored procedures, triggers, user-defined types, user-defined functions, user-defined aggregates, and streaming table-valued functions, using any .NET Framework language, including [!INCLUDE[msCoName](../a9notintoc/includes/msconame-md.md)] Visual Basic .NET and [!INCLUDE[msCoName](../a9notintoc/includes/msconame-md.md)] Visual C#.  
 ...
 Describes the latest version of SQLXML, which delivers the same functionality as SQLXML 3.0 as well as additional updates to accommodate new features introduced in [!INCLUDE[ssVersion2005](../a9notintoc/includes/ssversion2005-md.md)], such as the xml data type.  
 ...
 Describes how to use Windows Management Instrumentation (WMI) to monitor events in an instance of [!INCLUDE[ssNoVersion](../a9notintoc/includes/ssnoversion-md.md)].  
 ...
 Contains information about [!INCLUDE[ssNoVersion](../a9notintoc/includes/ssnoversion-md.md)] Management Objects (SMO), a collection of objects that are designed for programming all aspects of managing [!INCLUDE[ssNoVersion](../a9notintoc/includes/ssnoversion-md.md)].  
 ...
 [Data Collector Programming](../a9retired/data-collector-programming.md)  
