...
|**queued**|Data modifications are stored in a [!INCLUDE[msCoName](../../../a9notintoc/includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../../a9notintoc/includes/ssnoversion-md.md)] queue.|  
  
> [!NOTE]  
>  [!INCLUDE[msCoName](../../../a9notintoc/includes/msconame-md.md)] Message Queuing has been deprecated and is no longer supported.  
