...
[!INCLUDE[tsql-appliesto-ss2008-all_md](../../a9retired/includes/tsql-appliesto-ss2008-all-md.md)]
  ...
  Adds a certificate to a database in [!INCLUDE[ssNoVersion](../../a9notintoc/includes/ssnoversion-md.md)].  
...
## Permissions  
 Requires CREATE CERTIFICATE permission on the database. Only Windows logins, [!INCLUDE[ssNoVersion](../../a9notintoc/includes/ssnoversion-md.md)] logins, and application roles can own certificates. Groups and roles cannot own certificates.  
