...
|SPID|**int**|Server process ID assigned by [!INCLUDE[ssNoVersion](../../a9notintoc/includes/ssnoversion-md.md)] to the process associated with the client.|12|Yes|  
