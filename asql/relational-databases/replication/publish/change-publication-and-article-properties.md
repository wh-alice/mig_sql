...
|Enable or disable [!INCLUDE[msCoName](../../../advanced-analytics/r-services/tutorials/includes/msconame-md.md)] [!INCLUDE[ssVersion2000](../../../analysis-services/multidimensional-models/includes/ssversion2000-md.md)] partition optimization.|**sp_changemergepublication**|**keep_partition_changes**|Reinitialize subscriptions.|  
