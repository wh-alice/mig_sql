...
|**LineNumber**|**int**|Line number of [!INCLUDE[tsql](../../advanced-analytics/r-services/includes/tsql-md.md)] statement.|5|Yes|  
...
|**Offset**|**int**|Starting offset of [!INCLUDE[tsql](../../advanced-analytics/r-services/includes/tsql-md.md)] statement.|61|Yes|  
...
|**TextData**|**ntext**|Text of the [!INCLUDE[tsql](../../advanced-analytics/r-services/includes/tsql-md.md)] statement that caused lock escalation.|1|Yes|  
