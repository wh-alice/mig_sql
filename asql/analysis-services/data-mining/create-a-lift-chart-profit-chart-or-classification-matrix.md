...
# Create a Lift Chart, Profit Chart, or Classification Matrix
  You can create an accuracy chart for an [!INCLUDE[ssASnoversion](../../analysis-services/includes/ssasnoversion-md.md)] data mining model in five basic steps:  
...
1.  On the **Mining Accuracy Chart** tab of Data Mining Designer in [!INCLUDE[ssBIDevStudioFull](../../analysis-services/includes/ssbidevstudiofull-md.md)], click the **Input Selection** tab.  
