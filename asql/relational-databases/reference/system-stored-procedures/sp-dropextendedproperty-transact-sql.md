...
### B. Dropping an extended property on a database  
 The following example removes the property named `MS`_`Description` from the [!INCLUDE[ssSampleDBobject](../../../database-engine/availability-groups/windows/includes/sssampledbobject-md.md)] sample database. Because the property is on the database itself, no object types and names are specified.  
...
## See Also  
 ...
 [sys.fn_listextendedproperty &#40;Transact-SQL&#41;](../../../relational-databases/reference/system-functions/sys.fn-listextendedproperty-transact-sql.md)   
