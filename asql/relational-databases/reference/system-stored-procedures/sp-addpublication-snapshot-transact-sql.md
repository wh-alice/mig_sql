...
|**64**|When [!INCLUDE[ssNoVersion](../../../advanced-analytics/r-services/includes/ssnoversion-md.md)] Agent starts.|  
...
|**8**|*frequency_interval* is one or more of the following (combined with a [&#124; (Bitwise OR)](../Topic/%7C%20\(Bitwise%20OR\)%20\(Transact-SQL\).md) logical operator):<br /><br /> **1** = Sunday &#124;<br /><br /> **2** = Monday &#124;<br /><br /> **4** = Tuesday &#124;<br /><br /> **8** = Wednesday &#124;<br /><br /> **16** = Thursday &#124;<br /><br /> **32** = Friday &#124;<br /><br /> **64** = Saturday|  
...
> [!NOTE]  
>  For non-[!INCLUDE[ssNoVersion](../../../advanced-analytics/r-services/includes/ssnoversion-md.md)] Publishers, this must be the same login specified in [sp_adddistpublisher &#40;Transact-SQL&#41;](../../../relational-databases/reference/system-stored-procedures/sp-adddistpublisher-transact-sql.md).  
...
> [!NOTE]  
>  *publisher* should not be used when creating a Snapshot Agent at a [!INCLUDE[ssNoVersion](../../../advanced-analytics/r-services/includes/ssnoversion-md.md)] Publisher.  
...
## Example  
 [!code-sql[HowTo#sp_AddTranPub](../../../relational-databases/reference/system-stored-procedures/codesnippet/tsql/sp-addpublication-snapsh_1.sql)]  
...
## See Also  
 ...
 [sp_startpublication_snapshot &#40;Transact-SQL&#41;](../../../relational-databases/reference/system-stored-procedures/sp-startpublication-snapshot-transact-sql.md)   
