...
[!INCLUDE[tsql-appliesto-ss2016-asdb-xxxx-xxx_md](../../../relational-databases/data-compression/includes/tsql-appliesto-ss2016-asdb-xxxx-xxx-md.md)]
  ...
  Gets the **stmt_sql_handle** for a [!INCLUDE[tsql](../../../advanced-analytics/r-services/includes/tsql-md.md)] statement under given parameterization type (simple or forced). This allows you to refer to queries stored in the Query Store by using their **stmt_sql_handle** when you know their text.  
...
|**query_sql_text**|**nvarchar(max)**|The text of the [!INCLUDE[tsql](../../../advanced-analytics/r-services/includes/tsql-md.md)] statement.|  
