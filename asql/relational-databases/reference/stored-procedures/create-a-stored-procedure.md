...
# Create a Stored Procedure
  This topic describes how to create a [!INCLUDE[tsql](../../../a9notintoc/includes/tsql-md.md)] stored procedure by using [!INCLUDE[ssManStudioFull](../../../a9notintoc/includes/ssmanstudiofull-md.md)] and by using the [!INCLUDE[tsql](../../../a9notintoc/includes/tsql-md.md)] CREATE PROCEDURE statement.  
...
2.  Expand **Databases**, expand the [!INCLUDE[ssSampleDBobject](../../../a9retired/includes/sssampledbobject-md.md)] database, and then expand **Programmability**.  
