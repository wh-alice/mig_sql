...
[!INCLUDE[tsql-appliesto-ss2008-xxxx-xxxx-xxx_md](../../../database-engine/configure/windows/includes/tsql-appliesto-ss2008-xxxx-xxxx-xxx-md.md)]
  ...
  Returns a row for each [!INCLUDE[ssSB](../../../database-engine/configure/windows/includes/sssb-md.md)] network connection. The following table provides more information:  
  
|Column name|Data type|Description|  
|-----------------|---------------|-----------------|  
|**connection_id**|**uniqueidentifier**|Identifier of the connection. NULLABLE.|  
|**transport_stream_id**|**uniqueidentifier**|Identifier of the [!INCLUDE[ssNoVersion](../../../advanced-analytics/r-services/includes/ssnoversion-md.md)] Network Interface (SNI) connection used by this connection for TCP/IP communications. NULLABLE.|  
...
|**peer_certificate_id**|**int**|The local object ID of the certificate that is used by the remote instance for authentication. The owner of this certificate must have CONNECT permissions to the [!INCLUDE[ssSB](../../../database-engine/configure/windows/includes/sssb-md.md)] endpoint. NULLABLE.|  
...
|**total_fragments_sent**|**bigint**|Total number of [!INCLUDE[ssSB](../../../database-engine/configure/windows/includes/sssb-md.md)] message fragments that were sent by this connection. NULLABLE.|  
|**total_fragments_received**|**bigint**|Total number of [!INCLUDE[ssSB](../../../database-engine/configure/windows/includes/sssb-md.md)] message fragments that were received by this connection. NULLABLE.|  
...
## Physical Joins  
 ![Joins for sys.dm_broker_connections](../../../relational-databases/reference/system-dynamic-management-views/media/join-dm-broker-connections-1.gif "Joins for sys.dm_broker_connections")  
