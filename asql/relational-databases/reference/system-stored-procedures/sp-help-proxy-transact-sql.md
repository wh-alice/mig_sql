...
|PowerShell|PowerShell Script|  
 ...
 [ **@name** = ] '*name*'  
 The name of a [!INCLUDE[ssNoVersion](../../../a9notintoc/includes/ssnoversion-md.md)] login to list proxies for. The name is **nvarchar(256)**, with a default of NULL. When *name* is specified, *subsystem_name* must also be specified.  
