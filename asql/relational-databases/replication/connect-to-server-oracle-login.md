...
-   You must be currently logged in with the same [!INCLUDE[msCoName](../../a9notintoc/includes/msconame-md.md)] Windows account you specified for the replication administrative user schema.  
