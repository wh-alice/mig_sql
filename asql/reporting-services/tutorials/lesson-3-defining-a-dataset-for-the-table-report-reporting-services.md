...
4.  Select the data souce you created in the previous lesson, [!INCLUDE [ssSampleDBAdventureworks2014_md](../../reporting-services/tutorials/includes/sssampledbadventureworks2014-md.md)].   
...
7.  (Optional) Click the **Query Designer** button. The query is displayed in the text-based query designer. You can toggle to the graphical query designer by clicking **Edit As Text**. View the results of the query by clicking the run ![ssrs_querydesigner_run](../../reporting-services/tutorials/media/ssrs-querydesigner-run.png)  button on the query designer toolbar.  
  
    You see the data from six fields from four different tables in the [!INCLUDE [ssSampleDBAdventureworks2014_md](../../reporting-services/tutorials/includes/sssampledbadventureworks2014-md.md)] database. The query makes use of Transact-SQL functionality such as aliases. For example, the SalesOrderHeader table is called *soh*.  
...
9.  Click **OK** to exit the **Dataset Properties** dialog box.  
    ...
    ![ssrs_adventureworksdataset](../../reporting-services/tutorials/media/ssrs-adventureworksdataset.png)  
  
## Next Task  
You have successfully specified a query that retrieves data for your report. Next, you will create the report layout. See [Lesson 4: Adding a Table to the Report &#40;Reporting Services&#41;](../../reporting-services/tutorials/lesson-4-adding-a-table-to-the-report-reporting-services.md).  
