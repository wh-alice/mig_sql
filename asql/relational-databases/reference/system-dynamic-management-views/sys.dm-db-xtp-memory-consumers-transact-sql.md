...
[!INCLUDE[tsql-appliesto-ss2014-asdb-xxxx-xxx_md](../../../a9retired/includes/tsql-appliesto-ss2014-asdb-xxxx-xxx-md.md)]
  ...
  Reports the database-level memory consumers in the [!INCLUDE[hek_2](../../../a9retired/includes/hek-2-md.md)] database engine. The view returns a row for each memory consumer that the database engine uses. Use this DMV to see how the memory is distributed across different internal objects.  
