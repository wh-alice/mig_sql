...
# XML Data Type and Columns (SQL Server)
  This topic discusses the advantages and the limitations of the **xml** data type in [!INCLUDE[ssNoVersion](../../advanced-analytics/r-services/includes/ssnoversion-md.md)], and helps you to choose how to store XML data.  
...
## Reasons for Storing XML Data in SQL Server  
 Following are some of the reasons to use native XML features in [!INCLUDE[ssNoVersion](../../advanced-analytics/r-services/includes/ssnoversion-md.md)] instead of managing your XML data in the file system:  
...
## XML Storage Options  
 The storage options for XML in [!INCLUDE[ssNoVersion](../../advanced-analytics/r-services/includes/ssnoversion-md.md)] include the following:  
...
## Granularity of XML Data  
 ...
 A balance between data modeling requirements and locking and update characteristics is important for good design. However, in [!INCLUDE[ssNoVersion](../../advanced-analytics/r-services/includes/ssnoversion-md.md)], the size of actual stored XML instances is not as critical.  
