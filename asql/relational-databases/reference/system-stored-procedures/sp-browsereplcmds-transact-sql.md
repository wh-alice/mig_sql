...
## Arguments  
 ...
 [ **@compatibility_level =**] *compatibility_level*  
 Is the version of [!INCLUDE[msCoName](../../../a9notintoc/includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../../a9notintoc/includes/ssnoversion-md.md)] on which the *compatibility_level* is **int**, with a default value of 9000000.  
...
|**command**|**nvarchar(1024)**|[!INCLUDE[tsql](../../../a9notintoc/includes/tsql-md.md)] command.|  
