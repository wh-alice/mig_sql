...
---
# SQL:FullTextQuery Event Class
  The SQL:FullTextQuery event class occurs when [!INCLUDE[ssNoVersion](../../a9notintoc/includes/ssnoversion-md.md)] executes a full text query. Include this event class in traces that are monitoring problems associated with full text catalogs.  
...
|TextData|**nvarchar**|The full text portion of the query submitted to [!INCLUDE[ssNoVersion](../../a9notintoc/includes/ssnoversion-md.md)].|1|No|  
