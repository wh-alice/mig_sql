...
ms.topic: "reference"
f1_keywords: 
  - "sql13.dm.miningmodeleditor.naivebayse.discrimination.f1"
 ...
 **Viewer**  
 Choose a viewer to use to explore the selected mining model. For each model, you can choose either the custom viewer, or the [!INCLUDE[msCoName](../a9notintoc/includes/msconame-md.md)] Mining Content Viewer. You can also use plug-in viewers if available.  
