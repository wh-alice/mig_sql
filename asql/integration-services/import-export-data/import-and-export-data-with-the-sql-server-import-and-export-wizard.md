...
##  <a name="wizardSources"></a> What data sources and destinations can I use?  
 The [!INCLUDE[ssNoVersion](../../advanced-analytics/r-services/includes/ssnoversion-md.md)] Import and Export Wizard can copy data to and from the data sources listed in the following table. To connect to some of these data sources, you may have to download and install additional files.
...
## What permissions do I need to run the wizard?  
 To run the [!INCLUDE[ssNoVersion](../../advanced-analytics/r-services/includes/ssnoversion-md.md)] Import and Export Wizard successfully, you have to have at least the following permissions. If you already work with your data source and destination, you probably already have the permissions that you need.
...
|Save the SSIS package created by the wizard, if applicable.|If you want to save the package to [!INCLUDE[ssNoVersion](../../advanced-analytics/r-services/includes/ssnoversion-md.md)], permissions sufficient to save the package to the **msdb** database.|  
...
At the end of the wizard, if you have [!INCLUDE[ssNoVersion](../../advanced-analytics/r-services/includes/ssnoversion-md.md)] Standard Edition or higher installed, you can optionally save the SSIS package. Later you can reuse the package and extend it by using [!INCLUDE[ssIS](../../analysis-services/instances/includes/ssis-md.md)] Designer to add tasks, transformations, and event-driven logic. The [!INCLUDE[ssNoVersion](../../advanced-analytics/r-services/includes/ssnoversion-md.md)] Import and Export Wizard is the simplest way to create a basic [!INCLUDE[ssISnoversion](../../advanced-analytics/r-services/includes/ssisnoversion-md.md)] package that copies data from a source to a destination.
