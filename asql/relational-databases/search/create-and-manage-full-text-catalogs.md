...
4.  In the **New Full-Text Catalog** dialog box, specify the information for the catalog that you are re-creating. For more information, see [New Full-Text Catalog &#40;General Page&#41;](http://msdn.microsoft.com/en-US/library/ms183531(SQL.130).aspx).  
