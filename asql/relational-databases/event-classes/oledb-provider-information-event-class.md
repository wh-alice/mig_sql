...
-   DBPROPSET_SQLSERVERDATASOURCEINFO ([!INCLUDE[ssNoVersion](../../a9notintoc/includes/ssnoversion-md.md)] only)  
  
-   DBPROPSET_SQLSERVERDBINIT ([!INCLUDE[ssNoVersion](../../a9notintoc/includes/ssnoversion-md.md)] only)  
