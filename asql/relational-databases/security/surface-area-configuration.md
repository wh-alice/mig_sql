...
## Protocols, Connection, and Startup Options  
 Use [!INCLUDE[ssNoVersion](../../a9notintoc/includes/ssnoversion-md.md)] Configuration Manager to start and stop services, configure the startup options, and enable protocols and other connection options.  
...
## Enabling and Disabling Features  
 Enabling and disabling [!INCLUDE[ssNoVersion](../../a9notintoc/includes/ssnoversion-md.md)] features can be configured using facets in [!INCLUDE[ssManStudioFull](../../a9notintoc/includes/ssmanstudiofull-md.md)].  
  
#### To configure surface area using facets  
  
1.  In [!INCLUDE[ssManStudio](../../a9notintoc/includes/ssmanstudio-md.md)] connect to a component of [!INCLUDE[ssNoVersion](../../a9notintoc/includes/ssnoversion-md.md)].  
...
5.  [!INCLUDE[clickOK](../../a9notintoc/includes/clickok-md.md)]  
 ...
 You can also set [!INCLUDE[ssDE](../../a9notintoc/includes/ssde-md.md)] options using the **sp_configure** stored procedure. For more information, see [Server Configuration Options &#40;SQL Server&#41;](../../database-engine/configure/windows/server-configuration-options-sql-server.md).  
  
 To change the **EnableIntegrated Security** property of [!INCLUDE[ssRS](../../database-engine/configure/windows/includes/ssrs-md.md)], use the property settings in [!INCLUDE[ssManStudioFull](../../a9notintoc/includes/ssmanstudiofull-md.md)]. To change the **Schedule events and report delivery** property and the **Web service and HTTP access** property, edit the **RSReportServer.config** configuration file.  
  
## Command-prompt Options  
 Use the **Invoke-PolicyEvaluation**[!INCLUDE[ssNoVersion](../../a9notintoc/includes/ssnoversion-md.md)] PowerShell cmdlet to invoke Surface Area Configuration Policies. For more information, see [Use the Database Engine cmdlets](../../relational-databases/scripting/use-the-database-engine-cmdlets.md).  
