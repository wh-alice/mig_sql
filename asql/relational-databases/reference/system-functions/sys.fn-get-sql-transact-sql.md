...
## Remarks  
 You can obtain a valid SQL handle from the sql_handle column of the [sys.dm_exec_requests &#40;Transact-SQL&#41;](../../../relational-databases/reference/system-dynamic-management-views/sys.dm-exec-requests-transact-sql.md) dynamic management view.  
 ...
 The [!INCLUDE[ssDEnoversion](../../../a9notintoc/includes/ssdenoversion-md.md)] cannot cache some [!INCLUDE[tsql](../../../a9notintoc/includes/tsql-md.md)] statements, such as bulk copy statements and statements with string literals that are larger than 8 KB. Handles to those statements cannot be retrieved by using fn_get_sql.  
