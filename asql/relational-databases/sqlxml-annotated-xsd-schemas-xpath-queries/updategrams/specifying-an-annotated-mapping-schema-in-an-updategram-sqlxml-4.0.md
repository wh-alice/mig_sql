...
## Dealing with Data Types  
 ...
 If the schema specifies the **dateTime**, **date**, or **time** XSD data type, you must also specify the corresponding [!INCLUDE[ssNoVersion](../../../a9notintoc/includes/ssnoversion-md.md)] data type by using **sql:datatype="dateTime"**.  
  
 When handling parameters of [!INCLUDE[ssNoVersion](../../../a9notintoc/includes/ssnoversion-md.md)] **money** type, you must explicitly specify **sql:datatype="money"** on the appropriate node in the mapping schema.  
