...
5.  Enter the URL of a site that contains a [!INCLUDE[ssGemini](../../a9notintoc/includes/ssgemini-md.md)] Gallery library.  
  
6.  In Location Type, select **Microsoft SharePoint Foundation**.  
  
    > [!IMPORTANT]  
    >  UNC and HTTP location types are not supported for [!INCLUDE[ssGemini](../../a9notintoc/includes/ssgemini-md.md)] data access.  
...
9. In External Data, verify that Allow External Data is set to **Trusted data connection libraries and embedded**. This setting is required for [!INCLUDE[ssGemini](../../a9notintoc/includes/ssgemini-md.md)] data access in a workbook.  
  
10. Also in External Data, for Warn on Refresh, clear the checkbox for **Refresh warning enabled**. Clearing the checkbox allows [!INCLUDE[ssGemini](../../a9notintoc/includes/ssgemini-md.md)] Gallery to bypass routine warning messages and show preview images of a workbook instead.  
