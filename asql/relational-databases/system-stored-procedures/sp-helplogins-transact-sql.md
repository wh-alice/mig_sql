...
|**DefDBName**|**sysname**|Default database that **LoginName** uses when connecting to an instance of [!INCLUDE[ssNoVersion](../../advanced-analytics/r-services/includes/ssnoversion-md.md)].|  
...
|-----------------|---------------|-----------------|  
|**LoginName**|**sysname**|Login name.|  
|**DBName**|**sysname**|Default database that **LoginName** uses when connecting to an instance of [!INCLUDE[ssNoVersion](../../advanced-analytics/r-services/includes/ssnoversion-md.md)].|  
