...
[!INCLUDE[tsql-appliesto-ss2008-asdb-xxxx-xxx_md](../../../relational-databases/import-export/includes/tsql-appliesto-ss2008-asdb-xxxx-xxx-md.md)]
 ...
 CONTAINSTABLE is useful for the same kinds of matches as the [CONTAINS predicate](../Topic/CONTAINS%20\(Transact-SQL\).md) and uses the same search conditions as CONTAINS.  
 ...
 *top_n_by_rank*  
 ...
 <contains_search_condition>  
 Specifies the text to search for in *column_name* and the conditions for a match. For information about search conditions, see [CONTAINS &#40;Transact-SQL&#41;](../Topic/CONTAINS%20\(Transact-SQL\).md).  
