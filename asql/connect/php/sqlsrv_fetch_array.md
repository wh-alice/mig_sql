...
For more information about these values, see [Specifying a Cursor Type and Selecting Rows](../../connect/php/specifying-a-cursor-type-and-selecting-rows.md). Scrollable cursor support was added in version 1.1 of the Microsoft Drivers for PHP for SQL Server.  
...
If a field with no name is retrieved, the associative key for the array element will be an empty string (""). For more information, see [sqlsrv_fetch_array](../../connect/php/sqlsrv_fetch_array.md).  
