...
# Measures in the Cross-Validation Report
 ...
 [!INCLUDE[ssASnoversion](../../a9notintoc/includes/ssasnoversion-md.md)] also displays a set of detailed measures for mining models. These measures depend on the model type and on the type of attribute that is being analyzed: for example, whether it is discrete or continuous.  
