...
> [!NOTE]  
>  *publisher* should not be used for [!INCLUDE[ssNoVersion](../../../advanced-analytics/r-services/includes/ssnoversion-md.md)] Publishers.  
...
## Example  
 [!code-sql[HowTo#sp_reinittranpushsub](../../../relational-databases/reference/system-stored-procedures/codesnippet/tsql/sp-reinitsubscription-tr_1.sql)]  
