...
1.  In [!INCLUDE[ssBIDevStudioFull](../../analysis-services/includes/ssbidevstudiofull-md.md)], in Solution Explorer, click the mining structure that contains the mining model.  
...
4.  Type a name for the new mining model, and select an algorithm. [!INCLUDE[clickOK](../../analysis-services/data-mining/includes/clickok-md.md)]  
