...
|Value|Description|  
|-----------|-----------------|  
|**1**|Join filter only. Required to support [!INCLUDE[ssEW](../../../a9retired/includes/ssew-md.md)] Subscribers.|  
...
## Example  
 [!code-sql[HowTo#sp_addmergefilter](../../../a9retired/codesnippet/tsql/sp-addmergefilter-transa_1.sql)]  
