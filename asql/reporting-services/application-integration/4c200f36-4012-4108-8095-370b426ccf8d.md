...
1.  Create a new [!INCLUDE[msCoName](../../a9notintoc/includes/msconame-md.md)] ASP.NET Web Site using either [!INCLUDE[msCoName](../../a9notintoc/includes/msconame-md.md)] [!INCLUDE[csprcs](../../a9retired/includes/csprcs-md.md)] or [!INCLUDE[msCoName](../../a9notintoc/includes/msconame-md.md)] [!INCLUDE[vbprvb](../../a9retired/includes/vbprvb-md.md)].  
...
## Viewing Reports in Remote Processing Mode  
 The following example demonstrates how to render a report that has been deployed to a report server. This example uses the Sales Order Detail report that is included with the [!INCLUDE[ssSampleDBobject](../../a9retired/includes/sssampledbobject-md.md)] sample reports project.  
