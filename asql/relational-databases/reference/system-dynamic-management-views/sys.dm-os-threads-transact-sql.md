...
[!INCLUDE[tsql-appliesto-ss2008-xxxx-asdw-pdw_md](../../../relational-databases/reference/system-catalog-views/includes/tsql-appliesto-ss2008-xxxx-asdw-pdw-md.md)]
  ...
  Returns a list of all [!INCLUDE[ssNoVersion](../../../a9notintoc/includes/ssnoversion-md.md)] Operating System threads that are running under the [!INCLUDE[ssNoVersion](../../../a9notintoc/includes/ssnoversion-md.md)] process.  
  
> [!NOTE]  
>  To call this from [!INCLUDE[ssSDWfull](../../../a9notintoc/includes/sssdwfull-md.md)] or [!INCLUDE[ssPDW](../../../a9notintoc/includes/sspdw-md.md)], use the name **sys.dm_pdw_nodes_os_threads**.  
  
|Column name|Data type|Description|  
|-----------------|---------------|-----------------|  
|thread_address|**varbinary(8)**|Memory address (Primary Key) of the thread.|  
|started_by_sqlservr|**bit**|Indicates the thread initiator.<br /><br /> 1 = [!INCLUDE[ssNoVersion](../../../a9notintoc/includes/ssnoversion-md.md)] started the thread.<br /><br /> 0 = Another component started the thread, such as an extended stored procedure from within [!INCLUDE[ssNoVersion](../../../a9notintoc/includes/ssnoversion-md.md)].|  
...
|fiber_data|**varbinary(8)**|Current Win32 fiber that is running on the thread. This is only applicable when [!INCLUDE[ssNoVersion](../../../a9notintoc/includes/ssnoversion-md.md)] is configured for lightweight pooling.|  
...
|fiber_context_address|**varbinary(8)**|Internal fiber context address. This is only applicable when [!INCLUDE[ssNoVersion](../../../a9notintoc/includes/ssnoversion-md.md)] is configured for lightweight pooling.|  
|self_address|**varbinary(8)**|Internal consistency pointer.|  
|processor_group|**smallint**|**Applies to**: [!INCLUDE[ssKilimanjaro](../../../a9notintoc/includes/sskilimanjaro-md.md)] through [!INCLUDE[ssCurrent](../../../a9notintoc/includes/sscurrent-md.md)].<br /><br /> Processor group ID.|  
