...
1.  In Cube Designer for the [!INCLUDE[ssASnoversion](../../analysis-services/includes/ssasnoversion-md.md)] Tutorial cube, click the **Actions** tab.  
    ...
    ![Actions tab of Cube Designer](../../analysis-services/tutorials/media/l8-action1.gif "Actions tab of Cube Designer")  
...
2.  On the toolbar of the **Actions** tab, click the **New Drillthrough Action** button.  
    ...
    ![Blank Action template in the display pane](../../analysis-services/tutorials/media/l8-action2.gif "Blank Action template in the display pane")  
...
6.  In the **Return Columns** list, select the **Item Description** and the **Order Number** check boxes, and then click **OK**. The following image shows the Action template as it should appear at this point in this procedure.  
    ...
    ![Drillthrough Columns box](../../analysis-services/tutorials/media/l8-action3.gif "Drillthrough Columns box")  
  
7.  Expand the **Additional Properties** box, as shown in the following image.  
  
    ![Additional Properties box](../../analysis-services/tutorials/media/l8-action4.gif "Additional Properties box")  
...
9. In the **Caption** box, type **Drillthrough to Order Details…**.  
    ...
    ![Additional Properties box](../../analysis-services/tutorials/media/l8-action5.gif "Additional Properties box")  
...
6.  On the PivotTable, in **Customer Geography**, add a filter that selects a single customer. Expand **All Customers**, expand **Australia**, expand **Queensland**, expand **Brisbane**, expand **4000**, select the check box for **Adam Powell**, and then click **OK**.  
    ...
    The total sales of products by [!INCLUDE[ssSampleDBCoFull](../../analysis-services/data-mining/includes/sssampledbcofull-md.md)] to Adam Powell are displayed in the data area.  
...
7.  Right-click on the sales amount, point to **Additional Actions**, and then click **Drillthrough to Order Details**.  
    ...
    ![Orders shipped to Adam Powell](../../analysis-services/tutorials/media/l8-action6.gif "Orders shipped to Adam Powell")  
...
6.  Change the **Name** property for the **Order Date Key** attribute to **Order Date** Then, click the browse button for the **Name Column** property, and in the **Name Column** dialog box, select **Date** as the source table and select SimpleDate as the source column. [!INCLUDE[clickOK](../../analysis-services/data-mining/includes/clickok-md.md)]  
...
9. Switch to the **Actions** tab of Cube Designer for the [!INCLUDE[ssASnoversion](../../analysis-services/includes/ssasnoversion-md.md)] Tutorial cube.  
...
10. In the **Drillthrough Columns** box, select the check boxes to add the following columns to the **Return Columns** list, and then click **OK**:  
    ...
    ![Drillthrough Columns box](../../analysis-services/tutorials/media/l8-action7.gif "Drillthrough Columns box")  
  
## Reviewing the Modified Drillthrough Action  
  
1.  On the **Build** menu, click **Deploy Analysis Services Tutorial**.  
  
2.  When deployment has successfully completed, switch to the **Browser** tab in Cube Designer for the [!INCLUDE[ssASnoversion](../../analysis-services/includes/ssasnoversion-md.md)] Tutorial cube, and then click the **Reconnect** button.  
...
5.  Click the **Internet Sales-Sales Amount** data cell, point to **Additional Actions**, and then click **Drillthrough to Order Details**.  
    ...
    ![Orders shipped to Adam Powell](../../analysis-services/tutorials/media/l8-action8.gif "Orders shipped to Adam Powell")  
