...
## Example  
 [!code-sql[HowTo#sp_reinitmergepullsub](../../../relational-databases/reference/system-stored-procedures/codesnippet/tsql/sp-reinitmergepullsubscr_1.sql)]  
  
## Example  
 [!code-sql[HowTo#sp_reinitmergepullsubwithupload](../../../relational-databases/reference/system-stored-procedures/codesnippet/tsql/sp-reinitmergepullsubscr_2.sql)]  
