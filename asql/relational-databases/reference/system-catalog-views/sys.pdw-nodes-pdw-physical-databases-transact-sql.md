...
|-----------------|---------------|-----------------|  
|database_id|**int**|The object ID for the database. Note that this value is not same as a database_id in the [sys.databases &#40;Transact-SQL&#41;](../../../relational-databases/reference/system-catalog-views/sys.databases-transact-sql.md) view.|  
|physical_name|**sysname**|The physical name for the database on the Shell/Compute nodes. This value is same as a value in the physical_name column in the [sys.pdw_database_mappings &#40;Transact-SQL&#41;](../../../relational-databases/reference/system-catalog-views/sys.pdw-database-mappings-transact-sql.md) view.|  
