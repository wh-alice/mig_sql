...
# Deploying CLR Database Objects
 ...
 The CLR integration feature is turned off by default in [!INCLUDE[ssNoVersion](../../advanced-analytics/r-services/includes/ssnoversion-md.md)] and must be enabled in order to use CLR assemblies. For more information, see [Enabling CLR Integration](../Topic/Enabling%20CLR%20Integration.md).  
