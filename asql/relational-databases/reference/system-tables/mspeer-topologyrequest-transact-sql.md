...
|-----------------|---------------|-----------------|  
|id|**int**|Identifies a topology status request. The request_id column in [MSpeer_topologyresponse](../../../relational-databases/reference/system-tables/mspeer-topologyresponse-transact-sql.md) uses this value.|  
