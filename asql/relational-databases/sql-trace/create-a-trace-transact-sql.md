...
## Example  
 To examine the trace file, open the SampleTrace.trc file using [!INCLUDE[ssSqlProfiler](../../a9retired/includes/sssqlprofiler-md.md)].  
