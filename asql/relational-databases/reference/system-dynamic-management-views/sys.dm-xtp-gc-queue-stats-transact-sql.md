...
## User Scenario  
 This output shows that [!INCLUDE[ssNoVersion](../../../a9notintoc/includes/ssnoversion-md.md)] is either running on 4 cores or [!INCLUDE[ssNoVersion](../../../a9notintoc/includes/ssnoversion-md.md)] instance has been affinitized to 4 cores:  
