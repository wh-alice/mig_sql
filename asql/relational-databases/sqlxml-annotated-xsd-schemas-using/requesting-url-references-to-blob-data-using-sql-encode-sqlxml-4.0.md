...
# Requesting URL References to BLOB Data Using sql:encode (SQLXML 4.0)
  In an annotated XSD schema, when an attribute (or element) is mapped to a BLOB column in Microsoft [!INCLUDE[ssNoVersion](../../advanced-analytics/r-services/includes/ssnoversion-md.md)], the data is returned in Base 64-encoded format within XML.  
