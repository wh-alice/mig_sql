...
3.  Connect **Cleanse Supplier Data** and **Pick Correct and Corrected Records** using the blue connector.  
    ...
    ![Cleanse Supplier Data -> Pick Correct & Corrected](../a9notintoc/media/et-addingcsttosplitcleansingoutput-01.jpg "Cleanse Supplier Data -> Pick Correct & Corrected")  
...
6.  Expand **Columns** in the **top-left pane**.  
    ...
    ![Conditional Split Transformation Editor](../a9notintoc/media/et-addingcsttosplitcleansingoutput-02.jpg "Conditional Split Transformation Editor")  
...
## Next Step  
[Task 9: Adding Union All Transform to Combine Correct and Corrected Records](../a9notintoc/task-9-adding-union-all-transform-to-combine-correct-and-corrected-records.md)  
