...
-   A graph of links between Web pages  
 ...
 Use [hierarchyid](../t-sql/data-types/hierarchyid-data-type-method-reference.md) as a data type to create tables with a hierarchical structure, or to describe the hierarchical structure of data that is stored in another location. Use the [hierarchyid functions](../Topic/hierarchyid%20Data%20Type%20Method%20Reference.md) in [!INCLUDE[tsql](../advanced-analytics/r-services/includes/tsql-md.md)] to query and manage hierarchical data.  
