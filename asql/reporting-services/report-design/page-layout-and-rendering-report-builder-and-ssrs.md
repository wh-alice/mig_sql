...
Read about [!INCLUDE[ssRSnoversion](../../a9notintoc/includes/ssrsnoversion-md.md)] rendering extensions for paginated reports so you’re sure your report looks the way you want, including page layout, page breaks, and paper size. 
