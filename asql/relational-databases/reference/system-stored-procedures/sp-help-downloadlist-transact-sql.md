...
|**source_server**|**nvarchar(30)**|Computer name of the server the instruction came from. In [!INCLUDE[msCoName](../../../a9notintoc/includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../../a9notintoc/includes/ssnoversion-md.md)] version 7.0, this is always the computer name of the master (MSX) server.|  
