...
|**global**|Subscriber known to all servers.|  
 ...
 In [!INCLUDE[ssVersion2005](../../../a9notintoc/includes/ssversion2005-md.md)] and later versions, local subscriptions are referred to as client subscriptions, and global subscriptions are referred to as server subscriptions  
...
## Example  
 [!code-sql[HowTo#sp_addmergepushsubscriptionagent](../../../a9retired/codesnippet/tsql/sp-addmergesubscription-_1.sql)]  
