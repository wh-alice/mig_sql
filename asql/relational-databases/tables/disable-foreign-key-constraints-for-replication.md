...
1.  To perform this task in [!INCLUDE[tsql](../../a9notintoc/includes/tsql-md.md)], drop the foreign key constraint. Then add a new foreign key constraint and specify the NOT FOR REPLICATION option.  
