...
## Arguments  
 *handle*  
 Is the [!INCLUDE[ssNoVersion](../../../a9notintoc/includes/ssnoversion-md.md)]-generated prepared handle identifier. *handle* is a required parameter with an **int** return value.  
