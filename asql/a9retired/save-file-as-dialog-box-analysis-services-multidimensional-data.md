...
ms.topic: "reference"
f1_keywords: 
  - "sql13.asvs.savefileasdialog.f1"
...
# Save File As Dialog Box (Analysis Services - Multidimensional Data)
  The **Save File As** dialog box displays a list of available files in log and data folders defined for an [!INCLUDE[ssASnoversion](../a9notintoc/includes/ssasnoversion-md.md)] instance. You can either select a listed file, or you can specify a different folder and file if needed. The **Save File As** dialog box is displayed by:  
