...
## Arguments  
 ...
 [ **@command_id =**] *command_id*  
 Is the location of the command in [MSrepl_commands &#40;Transact-SQL&#41;](../../../relational-databases/reference/system-tables/msrepl-commands-transact-sql.md) to be decoded. *command_id* is **int**, with a default of NULL. If specified, all other parameters must be specified also, and *xact_seqno_start*must be identical to *xact_seqno_end*.  
  
 [ **@agent_id =**] *agent_id*  
 Specifies that only commands for a specific replication agent are returned. *agent_id* is **int**, with a default value of NULL.  
  
 [ **@compatibility_level =**] *compatibility_level*  
 Is the version of [!INCLUDE[msCoName](../../../advanced-analytics/r-services/tutorials/includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../../advanced-analytics/r-services/includes/ssnoversion-md.md)] on which the *compatibility_level* is **int**, with a default value of 9000000.  
...
|**command**|**nvarchar(1024)**|[!INCLUDE[tsql](../../../advanced-analytics/r-services/includes/tsql-md.md)] command.|  
|**command_id**|**int**|ID of the command in [MSrepl_commands](../../../relational-databases/reference/system-tables/msrepl-commands-transact-sql.md).|  
...
## See Also  
 ...
 [sp_replshowcmds &#40;Transact-SQL&#41;](../../../relational-databases/reference/system-stored-procedures/sp-replshowcmds-transact-sql.md)   
