...
-   You must have ReadPolicy and UpdatePolicy permissions on the shared dataset.  
 ...
 Cache refresh plans apply to both shared datasets and reports. For more information, see [Cache Refresh Options &#40;Report Manager&#41;](http://msdn.microsoft.com/en-US/library/ee636367(SQL.130).aspx).  
