...
|CPU|**int**|Amount of CPU time used by the event. In microseconds beginning with [!INCLUDE[ssSQL11](../../a9notintoc/includes/sssql11-md.md)]. In milliseconds in earlier versions.|18|Yes|  
...
|Duration|**bigint**|Amount of time taken by the event. In microseconds beginning with [!INCLUDE[ssKilimanjaro](../../a9notintoc/includes/sskilimanjaro-md.md)]. In milliseconds in earlier versions.|13|Yes|  
...
|ServerName|**nvarchar**|Name of the instance of [!INCLUDE[ssNoVersion](../../a9notintoc/includes/ssnoversion-md.md)] being traced.|26||  
