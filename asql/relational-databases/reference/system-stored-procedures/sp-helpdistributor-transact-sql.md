...
## Arguments  
 ...
 [ **@account=**] **'***account***' OUTPUT**  
 Is the [!INCLUDE[msCoName](../../../a9notintoc/includes/msconame-md.md)] Windows user account. *account*is **nvarchar(255)**, with a default of **%**, which is the only value that returns a result set.  
 ...
 [ **@local=**] **'***local***'**  
 Is whether [!INCLUDE[ssNoVersion](../../../a9notintoc/includes/ssnoversion-md.md)] should get local server values. *local* is **nvarchar(5)**, with a default of NULL.  
