...
# SQL Server Agent Properties (Service Tab)
  This service is the [!INCLUDE[msCoName](../../a9notintoc/includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../a9notintoc/includes/ssnoversion-md.md)] Agent service. The property values in light gray cannot be changed using this application.  
 ...
 **Host Name**  
 Displays the name of the computer or cluster running [!INCLUDE[ssNoVersion](../../a9notintoc/includes/ssnoversion-md.md)] Agent.  
