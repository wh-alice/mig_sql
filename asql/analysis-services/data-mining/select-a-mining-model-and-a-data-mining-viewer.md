...
-   Custom viewers are provided for each type of model. For an overview of all the custom viewers, see [Mining Model Viewers &#40;Data Mining Model Designer&#41;](http://msdn.microsoft.com/en-US/library/ms181176(SQL.130).aspx). For a walkthrough of how to use the custom viewers to understand a model, see [Lesson 4: Exploring the Targeted Mailing Models &#40;Basic Data Mining Tutorial&#41;](http://msdn.microsoft.com/en-US/library/ms166930(SQL.130).aspx).  
