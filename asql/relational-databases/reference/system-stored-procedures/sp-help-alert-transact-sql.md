...
|**event_source**|**nvarchar(100)**|Source of the event. It will always be **MSSQLServer** for [!INCLUDE[msCoName](../../../a9notintoc/includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../../a9notintoc/includes/ssnoversion-md.md)] version 7.0|  
...
|**event_description_keyword**|**nvarchar(100)**|Description of the [!INCLUDE[ssNoVersion](../../../a9notintoc/includes/ssnoversion-md.md)] error in the Windows application log that must be like the supplied sequence of characters.|  
...
|**category_name**|**sysname**|[!INCLUDE[ssInternalOnly](../../../integration-services/data-flow/transformations/includes/ssinternalonly-md.md)] Will always be '[Uncategorized]' for [!INCLUDE[ssNoVersion](../../../a9notintoc/includes/ssnoversion-md.md)] 7.0.|  
...
|**type**|**int**|Type of the event:<br /><br /> **1** = [!INCLUDE[ssNoVersion](../../../a9notintoc/includes/ssnoversion-md.md)] event alert<br /><br /> **2** = [!INCLUDE[ssNoVersion](../../../a9notintoc/includes/ssnoversion-md.md)] performance alert<br /><br /> **3** = WMI event alert|  
...
|**id**|**int**|System-assigned unique integer identifier.|  
|**name**|**sysname**|Alert name (for example, Demo: Full **msdb** log).|  
|**event_source**|**nvarchar(100)**|Source of the event. It will always be **MSSQLServer** for [!INCLUDE[ssNoVersion](../../../a9notintoc/includes/ssnoversion-md.md)] version 7.0|  
|**event_category_id**|**int**|[!INCLUDE[ssInternalOnly](../../../integration-services/data-flow/transformations/includes/ssinternalonly-md.md)]|  
|**event_id**|**int**|[!INCLUDE[ssInternalOnly](../../../integration-services/data-flow/transformations/includes/ssinternalonly-md.md)]|  
|**message_id**|**int**|Message error number that defines the alert. (Usually corresponds to an error number in the **sysmessages** table). If severity is used to define the alert, **message_id** is **0** or NULL.|  
...
|**last_response_time**|**int**|Time the alert was last responded to by the **SQLServerAgent** service.|  
|**notification_message**|**nvarchar(512)**|Optional additional message sent to the operator as part of the e-mail or pager notification.|  
|**include_event_description**|**tinyint**|Is whether the description of the [!INCLUDE[ssNoVersion](../../../a9notintoc/includes/ssnoversion-md.md)] error from the Windows application log should be included as part of the notification message.|  
|**database_name**|**sysname**|Database in which the error must occur for the alert to fire. If the database name is NULL, the alert fires regardless of where the error occurred.|  
|**event_description_keyword**|**nvarchar(100)**|Description of the [!INCLUDE[ssNoVersion](../../../a9notintoc/includes/ssnoversion-md.md)] error in the Windows application log that must be like the supplied sequence of characters.|  
|**occurrence_count**|**int**|Number of times the alert occurred.|  
|**count_reset_date**|**int**|Date the **occurrence_count** was last reset.|  
...
|**category_name**|**sysname**|[!INCLUDE[ssInternalOnly](../../../integration-services/data-flow/transformations/includes/ssinternalonly-md.md)] Will always be '**[Uncategorized]**' for [!INCLUDE[ssNoVersion](../../../a9notintoc/includes/ssnoversion-md.md)] 7.0.|  
|**type**|**int**|Type of alert:<br /><br /> **1** = [!INCLUDE[ssNoVersion](../../../a9notintoc/includes/ssnoversion-md.md)] event alert<br /><br /> **2** = [!INCLUDE[ssNoVersion](../../../a9notintoc/includes/ssnoversion-md.md)] performance alert<br /><br /> **3** = WMI event alert|  
