...
-   Extended procedures  
 ...
 The [!INCLUDE[ssNoVersion](../../advanced-analytics/r-services/includes/ssnoversion-md.md)] Performance Monitor uses DBCC PROCCACHE to obtain information about the procedure cache.  
