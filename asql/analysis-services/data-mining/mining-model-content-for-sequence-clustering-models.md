...
## Walkthrough of Structure  
 An example might help clarify how the information is stored, and how you can interpret it. For example, you can find the largest order, meaning the longest observed chain in the underlying [!INCLUDE[ssSampleDBDWobject](../../analysis-services/data-mining/includes/sssampledbdwobject-md.md)] data, by using the following query:  
