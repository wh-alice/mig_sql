...
6.  Perform the server upgrade to [!INCLUDE[ssCurrent](../../../a9notintoc/includes/sscurrent-md.md)].  
  
7.  Restart [!INCLUDE[ssNoVersion](../../../a9notintoc/includes/ssnoversion-md.md)] Agent and the Log Reader Agent if they do not start automatically after the upgrade.  
...
## Run Agents for Merge Replication After Upgrade  
 ...
 Run the agents from [!INCLUDE[ssManStudioFull](../../../a9notintoc/includes/ssmanstudiofull-md.md)], Replication Monitor, or from the command line. For more information about running the Snapshot Agent, see the following topics:  
