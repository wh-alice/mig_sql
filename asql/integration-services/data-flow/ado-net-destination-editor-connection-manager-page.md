...
# ADO NET Destination Editor (Connection Manager Page)
  Use the **Connection Manager** page of the **ADO NET Destination Editor** dialog box to select the [!INCLUDE[vstecado](../../a9retired/includes/vstecado-md.md)] connection for the destination. This page also lets you select a table or view from the database.  
...
1.  In [!INCLUDE[ssBIDevStudioFull](../../a9notintoc/includes/ssbidevstudiofull-md.md)], open the [!INCLUDE[ssISnoversion](../../a9notintoc/includes/ssisnoversion-md.md)] package that has the ADO NET destination.  
 ...
 **Use bulk insert when available**  
 ...
 You can use the .NET Data Provider for SQL Server (SqlClient) to connect to [!INCLUDE[msCoName](../../a9notintoc/includes/msconame-md.md)][!INCLUDE[ssSDSFull](../../a9retired/includes/sssdsfull-md.md)].  
...
> [!NOTE]  
>  If a [!INCLUDE[ssNoVersion](../../a9notintoc/includes/ssnoversion-md.md)] or Sybase source table includes an identity column, you must use Execute SQL tasks to run a SET IDENTITY_INSERT statement before and after the ADO NET destination. The identity column property specifies an incremental value for the column. The SET IDENTITY_INSERT statement enables explicit values to be inserted into the identity column. To run the CREATE TABLE and SET IDENTITY statements on the same database connection, set the **RetainSameConnection** property of the [!INCLUDE[vstecado](../../a9retired/includes/vstecado-md.md)] connection manager to **True**. Also, use the same [!INCLUDE[vstecado](../../a9retired/includes/vstecado-md.md)] connection manager for the Execute SQL tasks and the ADO NET destination.  
>   
