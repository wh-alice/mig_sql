...
[!INCLUDE[tsql-appliesto-ss2014-asdb-xxxx-xxx_md](../../../relational-databases/extended-events/includes/tsql-appliesto-ss2014-asdb-xxxx-xxx-md.md)]
  ...
  Reports the database-level memory consumers in the [!INCLUDE[hek_2](../../../relational-databases/in-memory-oltp/includes/hek-2-md.md)] database engine. The view returns a row for each memory consumer that the database engine uses. Use this DMV to see how the memory is distributed across different internal objects.  
