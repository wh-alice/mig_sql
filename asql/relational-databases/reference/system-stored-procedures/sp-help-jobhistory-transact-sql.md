...
|**sql_message_id**|**int**|For a [!INCLUDE[tsql](../../../a9notintoc/includes/tsql-md.md)] step, the most recent [!INCLUDE[tsql](../../../a9notintoc/includes/tsql-md.md)] error number encountered while running the command.|  
|**sql_severity**|**int**|For a [!INCLUDE[tsql](../../../a9notintoc/includes/tsql-md.md)] step, the highest [!INCLUDE[tsql](../../../a9notintoc/includes/tsql-md.md)] error severity encountered while running the command.|  
