...
1.  Create a new Windows application using either [!INCLUDE[msCoName](../../a9notintoc/includes/msconame-md.md)] [!INCLUDE[csprcs](../../a9retired/includes/csprcs-md.md)] or [!INCLUDE[msCoName](../../a9notintoc/includes/msconame-md.md)] [!INCLUDE[vbprvb](../../a9retired/includes/vbprvb-md.md)].  
...
3.  Browse to the location where you installed the [!INCLUDE[ssSampleDBobject](../../a9retired/includes/sssampledbobject-md.md)] Report Samples project.  
...
5.  Right-click the Sales Order Detail.rdl file in Solution Explorer and select **Rename**. Rename the report to **Sales Order Detail.rdlc** and press ENTER.  
    ...
    > [!NOTE]  
    >  Renaming the file extension from rdl to rdlc will allow you to edit the report using report designer for [!INCLUDE[msCoName](../../a9notintoc/includes/msconame-md.md)][!INCLUDE[vsprvslong](../../relational-databases/server-management-objects-smo/includes/vsprvslong-md.md)].  
