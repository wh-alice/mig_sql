...
1.  Ensure that [!INCLUDE[ssNoVersion](../../a9notintoc/includes/ssnoversion-md.md)] Agent is running on the new principal server instance.  
...
-   If a database is attached or restored with the **KEEP_CDC** option to any edition other than Enterprise, the operation is blocked because change data capture requires [!INCLUDE[ssNoVersion](../../a9notintoc/includes/ssnoversion-md.md)] Enterprise. Error message 934 is displayed:  
