...
|**truncation_lsn**|**numeric(25,0)**|The [!INCLUDE[ssHADR](../../../a9notintoc/includes/sshadr-md.md)] log truncation value, which may be higher than the local truncation LSN if local log truncation is blocked (such as by a backup operation).|  
