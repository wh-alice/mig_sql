...
16. Copy [!INCLUDE[tsql](../a9notintoc/includes/tsql-md.md)] test command script into a file and save it as `test.sql` in the sample directory.  
  
17. Execute the test script with the following command  
  
    -   `sqlcmd -E -I -i test.sql`  
  
18. Copy the [!INCLUDE[tsql](../a9notintoc/includes/tsql-md.md)] cleanup script into a file and save it as `cleanup.sql` in the sample directory.  
...
```  
 ...
 This is the [!INCLUDE[tsql](../a9notintoc/includes/tsql-md.md)] installation script (`Install.sql`), which deploys the assemblies and creates the stored procedure within the database.  
...
```  
 ...
 The following [!INCLUDE[tsql](../a9notintoc/includes/tsql-md.md)] removes the assemblies and stored procedure from the database.  
