...
## Remarks  
 Call **bcp_init** before calling any other bulk-copy function. **bcp_init** performs the necessary initializations for a bulk copy of data between the workstation and [!INCLUDE[ssNoVersion](../../a9notintoc/includes/ssnoversion-md.md)].  
...
-   Run the following [!INCLUDE[tsql](../../a9notintoc/includes/tsql-md.md)] on the database:  
