...
|**IsSystemVerified**|The determinism and precision properties of the column can be verified by the [!INCLUDE[ssDE](../../a9notintoc/includes/ssde-md.md)]. This property applies only to computed columns and columns of views.|1 = TRUE<br /><br /> 0 = FALSE<br /><br /> NULL = Input is not valid.|  
...
|**IsHidden**|Is column value generated by the system. Corresponds to **sys.columns.is_hidden**|**Applies to**: [!INCLUDE[ssCurrentLong](../../relational-databases/reference/system-catalog-views/includes/sscurrentlong-md.md)] through [!INCLUDE[ssCurrent](../../a9notintoc/includes/sscurrent-md.md)].<br /><br /> 0 = Not hidden<br /><br /> 1 = Hidden|  
