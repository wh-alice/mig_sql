...
## Configuring MySQL Console Settings  
...
Server connection parameters can be defined in the script file or in the server connection file. Please refer to the [Creating the Server Connection Files &#40;MySQLToSQL&#41;](../../ssma/mysql/creating-the-server-connection-files--mysqltosql-.md) section for more details.  
