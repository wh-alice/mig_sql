...
## Example  
 ...
 Execute the second ([!INCLUDE[tsql](../../a9notintoc/includes/tsql-md.md)]) code listing to add the assembly to the master database.  
 ...
 Execute the fourth ([!INCLUDE[tsql](../../a9notintoc/includes/tsql-md.md)]) code listing to delete the assembly to the master database.  
